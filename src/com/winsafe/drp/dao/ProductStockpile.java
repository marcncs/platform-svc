...
public class ProductStockpile implements Serializable {
	...
	/** full constructor */
    public ProductStockpile(Long id, String productid, Integer countunit, String batch, String producedate, String validate, Double cost, String warehouseid, String warehousebit, Double stockpile, Double prepareout, Integer islock, Date makedate) {
        this.id = id;
    ...
    /** default constructor */
    public ProductStockpile() {
    }

    /** minimal constructor */
    public ProductStockpile(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ProductStockpile) ) return false;
        ProductStockpile castOther = (ProductStockpile) other;
