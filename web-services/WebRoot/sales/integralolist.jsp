...
var checkbillno="";
var checkioid="";
	function CheckedObj(obj,objid,objosort,objbillno,objiioid){
	...
	function Detail(){
		if(checkid!=""){
			document.all.submsg.src="../sales/listIntegralDetailAction.do?OSort="+checkosort+"&BillNo="+checkbillno+"&IID="+checkioid;
		}else{
			alert("请选择你要操作的记录");
		}
	}
...
function excput(){
		search.target="";
		search.action="../sales/excPutIntegralOAction.do";
		search.submit();
		search.action="listIntegralOAction.do";
	}
	function print(){
		search.target="_blank";
		search.action="../sales/printIntegralOAction.do";
		search.submit();
		search.target="";
		search.action="listIntegralOAction.do";
	}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">会员管理>>积分支出</td>
        </tr>
      </table>
       <form name="search" method="post" action="listIntegralOAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            ...
            <td><input name="EquipOrganID" type="hidden" id="EquipOrganID" value="${EquipOrganID}">
              <input name="ename" type="text" id="ename" size="30" value="${ename}" readonly><a href="javascript:SelectEOrgan();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a></td>
            <td align="right">&nbsp;</td>
          </tr>
          <tr class="table-back"> 
  ...
  <input name="EndDate" type="text" id="EndDate" value="${EndDate}" size="10" onFocus="javascript:selectDate(this)" readonly></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<td width="50">
          ...
          <td class="SeparatePage"><pages:pager action="../sales/listIntegralOAction.do"/></td>
        </tr>
      </table>
      </div>
					</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
          ...
          <tr class="table-back-colorbar" onClick="CheckedObj(this,'${s.oid}','${s.osort}','${s.billno}','${s.id}');"> 
            <td>${s.id}</td>
...
<div style="width:100%">
      	<div id="tabs1">
            <ul>
              <li><a href="javascript:Detail();"><span>支出明细</span></a></li>
            </ul>
          </div>
