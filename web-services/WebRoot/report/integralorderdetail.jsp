...
function excput(){
	searchform.action="../report/excPutIntegralOrderDetailAction.do";
	searchform.submit();
	searchform.action="../report/integralOrderDetailAction.do";
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">会员已兑换礼品明细表</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="integralOrderDetailAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table-back">
            ...
            <td width="25%"><select name="MakeID" id="MakeID">
            ...
            <td width="31%"><input name="BeginDate" type="text" id="BeginDate" value="${BeginDate}" onFocus="selectDate(this);"size="10">
-
  <input name="EndDate" type="text" id="EndDate" value="${EndDate}" onFocus="selectDate(this);"  size="10"></td>
          ...
          <tr class="table-back">
            ...
            <a href="javascript:SelectSingleProduct();"><img src="../images/CN/find.gif" width="18" height="18" border="0"></a><a href="javascript:SelectProvide();">
	...
	<c:forEach items="${alsod}" var="d">
        <tr class="table-back">           
          ...
          <td >${d.specmode}</td>
          <td >${d.unitidname}</td>
          <td align="right">${d.integralprice}</td>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/report/integralOrderDetailAction.do"/>	
            </td>
          </tr>
