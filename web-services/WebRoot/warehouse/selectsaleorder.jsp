	...
	function Affirm(){
		...
		for(var i=0;i<document.listform.pid.length;i++){
			if(document.listform.pid[i].checked){
				...
				arrwarehouseid[k]=document.listform.warehouseid[i].value;
				arrwarehouseidname[k]=document.listform.warehouseidname[i].value;
				...
				arrwarehouseid[0]=document.listform.warehouseid.value;
				arrwarehouseidname[0]=document.listform.warehouseidname.value;
				arrbatch[k]=document.listform.batch.value;
		...
		if(flag){
			...
			setCookie("warehouseid",arrwarehouseid);
			setCookie("warehouseidname",arrwarehouseidname);
			...
			var p={productid:arrid.slice(0),productname:arrpordocutname.slice(0),specmode:arrspecmode.slice(0),warehouseid:arrwarehouseid.slice(0),warehouseidname:arrwarehouseidname.slice(0),batch:arrbatch.slice(0),unitid:unitid.slice(0),countunit:arrcountunit.slice(0),unitprice:arrunitprice.slice(0),quantity:arrquantity.slice(0),discount:discount.slice(0),taxrate:taxrate.slice(0),subsum:arrsubsum.slice(0)};	
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="../warehouse/selectSaleOrderAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <td width="6%"  align="right">
            品牌：</td>
            <td width="16%">${brandselect}</td>
            <td width="13%"  align="right">名称关键字：</td>
            <td width="57%" ><input type="text" name="KeyWord" value="${KeyWord}">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
		  ...
		  <tr class="table-back" > 
            ...
            <td><input type="hidden" name="specmode" value="${p.specmode}">${p.specmode}</td>	
			 <td><input type="hidden" name="warehouseid" value="${p.warehouseid}"><input type="hidden" name="warehouseidname" value="${p.warehouseidname}">${p.warehouseidname}</td>	
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%"> <presentation:pagination target="/warehouse/selectSaleOrderAction.do"/> 
          </td>
        </tr>
      </table>
