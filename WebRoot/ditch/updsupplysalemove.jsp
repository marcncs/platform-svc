...
function TotalSum(){
	...
	<body style="overflow: auto;">
		<form name="referForm" method="post"
			action="updSupplySaleMoveAction.do"
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1">
											...
											<td width="11%" align="right">
												...
												<input type="hidden" id="id" name="id" value="${ama.id }"/>
													<input name="supplyorganid" type="hidden" id="supplyorganid" value="${ama.supplyorganid }">
													<input name="oname" type="text" id="oname" size="30" dataType="Require" msg="必须录入调出机构!"
														readonly value="<windrp:getname key='organ' p='d' value='${ama.supplyorganid }'/>"><a href="#"><img
												...
												<td width="25%"><windrp:warehouse name="outwarehouseid" value="${ama.outwarehouseid }" p="y"/><span class="STYLE1">*</span>
												</td>
												<td width="11%" align="right">
													需求日期：
											  </td>
												...
												<td width="21%">
													<input name="movedate" type="text" id="movedate" size="10"
														onFocus="javascript:selectDate(this)" readonly="readonly"  value="<windrp:dateformat value="${ama.movedate }" p="yyyy-MM-dd"/>"
														dataType="Require" msg="必须录入需求日期!">
													<span class="STYLE1">*</span>
												</td>
											</tr>
											<tr>
											<td width="9%" align="right">调入机构：</td>
											<td><input name="inorganid" type="hidden" id="inorganid" value="${ama.inorganid }">
													<input name="onamein" type="text" id="onamein" size="30" dataType="Require" msg="必须录入调入机构!"
														readonly value="<windrp:getname key='organ' p='d' value='${ama.inorganid }'/>"><a href="#"><img
															src="../images/CN/find.gif" width="18" height="18"
															border="0" align="absmiddle"></a><span class="STYLE1">*</span></td>
											<td width="9%" align="right">
													调入仓库：
												</td>
												<td width="25%">
												
												<input type="hidden" name="inwarehouseid" id="inwarehouseid" value="${ama.inwarehouseid }">
												<input type="text" name="wname" id="wname" onClick="selectDUW(this,'inwarehouseid',$F('inorganid'),'w','transportaddr')"
												  value="<windrp:getname key='warehouse' p='d' value='${ama.inwarehouseid }'/>" readonly>
													<span class="STYLE1">*</span>
												</td>
												...
												<td><windrp:paymentmode name="paymentmode" value="${ama.paymentmode}"/>
												</td>
											...
											<td>
												<input type="text" id="olinkman" name="olinkman" value="${ama.olinkman }"
											...
											<td>
												<input type="text" id="otel" name="otel" value="${ama.otel }" dataType="PhoneOrMobile" msg="必须录入正确联系电话!" require="false">
												<span class="STYLE1">*</span>
											</td>
											<td align="right">
													开票信息：
												...
												<td>
												<windrp:select key="InvoiceType" name="invmsg" p="n|f" value="${ama.invmsg}"/>
												</td>
											</tr>
											<tr>
												...
												<td colspan="3"><input name="tickettitle" type="text" id="tickettitle"
													size="35" maxlength="100" value="${ama.tickettitle }"></td>
											</tr>
											<tr>
											<td align="right">
												收货地址：
											...
											<td colspan="5">
												<input type="text" name="transportaddr" id="transportaddr" value="${ama.transportaddr}" maxlength="100" size="100" dataType="Require" msg="必须录入收货地址!">
													<span class="STYLE1">*</span>
											</td>
											...
											<tr>
												...
												id="movecause" dataType="Limit" max="256" msg="调拨原因必须在256个字之内"
													require="false">${ama.movecause }</textarea><br>
								...
								<fieldset align="center">
									...
									<table width="100%" id="dbtable" border="0" cellpadding="0"
										...
										<c:set var="count" value="2"/>
											...
											<td>
												...
												<input name="unit" type="text" value="<windrp:getname key="CountUnit" p="d" value="${p.unitid}"/>"
											...
											<td>
												<input name="punitprice" type="text"
													...
													id="punitprice" size="10" maxlength="10" readonly>
											</td>
											<td>
												<input name="sunitprice" type="text"
													value="<fmt:formatNumber value='${p.sunitprice}' pattern='0.00' />"
													id="sunitprice" size="10" maxlength="10" readonly>
											</td>
											<td>
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr align="center" class="table-back">
											...
											<td width="15%">
												<input name="totalsum" type="text" id="totalsum" size="15"
													 value="${ama.totalsum}" readonly>
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
							<tr>
								...
								<td>
									<textarea name="remark" cols="100" style="width: 100%" rows="4"
										...
										require="false" >${ama.remark }</textarea><br>
