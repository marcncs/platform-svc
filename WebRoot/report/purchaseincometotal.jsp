...
function excput(){
	searchform.action="../report/excPutPurchaseIncomeTotalAction.do";
	searchform.submit();
	searchform.action="../report/purchaseIncomeTotalAction.do";
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>入库>>采购入库汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="purchaseIncomeTotalAction.do">
...
<c:forEach items="${str}" var="d">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/report/purchaseIncomeTotalAction.do"/>	
            </td>
          </tr>
