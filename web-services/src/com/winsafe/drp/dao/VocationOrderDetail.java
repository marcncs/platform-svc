...
public class VocationOrderDetail extends ActionForm implements Serializable {
    ...
    /** full constructor */
    public VocationOrderDetail(Long id, String soid, String productid, String productname, String specmode, Long warehouseid, Long unitid, String batch, Double unitprice, Double quantity, Double takequantity, Double discount, Double taxrate, Double cost, Double subsum) {
        this.id = id;
        this.soid = soid;
    ...
    /** default constructor */
    public VocationOrderDetail() {
    }

    /** minimal constructor */
    public VocationOrderDetail(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof VocationOrderDetail) ) return false;
        VocationOrderDetail castOther = (VocationOrderDetail) other;
