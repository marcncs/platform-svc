  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 选择赠品</td>
	    
        </tr>
      </table>
      <form name="search" method="post" action="selectSaleOrderPresentAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back"> 
            ...
            <td width="21%" ><input type="text" name="KeyWord"></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr class="title-func-back">
          <td class="SeparatePage"><pages:pager action="../sales/selectSaleOrderPresentAction.do"/></td>
        </tr>
      </table>
      </div>
					</td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
		  ...
		  <tr class="table-back-colorbar" > 
            ...
            <td><input type="hidden" name="specmode" value="${p.psspecmode}">
              ${p.psspecmode}
              <input name="salesort" type="hidden" id="salesort" value="2"></td>			
