...
function SelectLinkman(){
	...
	var l=showModalDialog("toSelectLinkmanAction.do?cid="+cid,null,"dialogWidth:16cm;dialogHeight:8.5cm;center:yes;status:no;scrolling:no;");
	//document.validateProvide.cid.value=getCookie("lid");
	document.validateProvide.linkman.value=l.lname;
	document.validateProvide.tel.value=l.ltel;
}
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增销售出库单</td>
        </tr>
      </table>
      <form name="validateProvide" method="post" action="addSaleShipmentBillAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
	  <tr>
	  	<td width="13%"  align="right"><input name="cid" type="hidden" id="cid" >
收货单位名称：</td>
          <td width="26%"><input name="cname" type="text" id="cname"  size="35">
          ...
          <td width="21%"><input name="linkman" type="text" id="linkman">
	  ...
	  <tr>
	    ...
	    <td><input name="soid" type="text" id="soid"></td>
	  ...
	  <tr>
	    ...
	    <td><input name="transportnum" type="text" id="transportnum"></td>
	    <td align="right">需求日期：</td>
	    <td><input name="requiredate" type="text" id="requiredate" onFocus="javascript:selectDate(this)" value="<%=com.winsafe.hbm.util.DateUtil.getCurrentDateString()%>" readonly>
          <span class="STYLE1">*</span></td>
	    </tr>
	  <tr>
	    <td  align="right">收货地址：</td>
	    <td colspan="5"><input name="receiveaddr" type="text" id="receiveaddr" size="50"></td>
	    </tr>
	  </table>
	</fieldset>
            ...
            <td  align="center"><table width="100%"   border="0" cellpadding="0" cellspacing="0">
              <tr align="center" class="table-back">
                ...
                <td width="64%" align="right"><input type="button" name="button" value="金额小计" onClick="TotalSum();">
                  ：</td>
                <td width="15%"><input name="totalsum" type="text" id="totalsum" value="0" size="10" maxlength="10"></td>
              </tr>
            </table>
            <table width="100%"  border="0" cellpadding="0" cellspacing="1">
              <tr>
