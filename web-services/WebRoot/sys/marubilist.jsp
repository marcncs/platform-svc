...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function addFwm(){
				popWin("../sys/toAddMarubiBarcodeLogging.do",850,400);
			}
			...
			<tr>
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post" action="../sys/toMarubiBarcodeLogging.do">
						  <table width="100%" border="0" cellpadding="0" cellspacing="0">
					          <tr class="table-back">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
				          <tr class="title-func-back">
				        	<td width="80" id="addfwm"><a href="#" onClick="javascript:addFwm();"><img src="../images/CN/addnew.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;申请物流码</a> </td>
				       		<td class="SeparatePage">
								<pages:pager action="../sys/toMarubiBarcodeLogging.do"/>
							</td>
				          </tr>
				        </table>
					</div>
