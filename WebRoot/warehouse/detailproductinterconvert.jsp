...
function Audit(smid){
			popWin2("../warehouse/auditProductInterconvertAction.do?SMID="+smid);
	}
	
	function CancelAudit(smid){
			popWin2("../warehouse/cancelAuditProductInterconvertAction.do?SMID="+smid);
	}
	
	function Shipment(smid){
			popWin2("../warehouse/completeProductInterconvertShipmentAction.do?SMID="+smid);
	}
	
	function CancelShipment(smid){
			popWin2("../warehouse/cancelCompleteProductInterconvertShipmentAction.do?SMID="+smid);
	}
	function Receive(smid){
			popWin2("../warehouse/completeProductInterconvertReceiveAction.do?SMID="+smid);
	}
	
	function CancelReceive(smid){
			popWin2("../warehouse/cancelCompleteProductInterconvertReceiveAction.do?SMID="+smid);
	}
	function print(id){
  ...
  <tr>
    <td width="10"><img src="../images/CN/spc.gif" width="10" height="8"></td>
          ...
          <table  border="0" cellpadding="0" cellspacing="0">
            <tr>
             <td width="60" align="center"><a href="javascript:print('${smf.id}');">打印</a></td>
            ...
            <!--  <td width="60" align="center"><c:choose>
              ...
              -->
			  <td width="60" align="center"><c:choose>
                  <c:when test="${smf.iscomplete==0}">签收</c:when>
