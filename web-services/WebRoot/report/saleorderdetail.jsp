...
function excput(){
	...
	searchform.action="../report/excPutSaleOrderDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/saleOrderDetailAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printSaleOrderDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/saleOrderDetailAction.do";
}
  ...
  <tr>
    <td>
        ...
        <tr> 
          ...
          <td width="772">报表分析>>零售>>零售明细</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="saleOrderDetailAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="title-func-back"> 
			...
			<pages:pager action="../report/saleOrderDetailAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutSaleOrderDetailAction.do">
