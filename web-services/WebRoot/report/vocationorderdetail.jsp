...
function excput(){
	searchform.action="excPutVocationOrderDetailAction.do";
	searchform.submit();
	searchform.action="vocationOrderDetailAction.do";
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">行业零售单明细表</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="vocationOrderDetailAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
        
          <tr class="table-back">
            <td width="8%"  align="right">制单机构：</td>
            <td width="25%"><select name="MakeOrganID" id="MakeOrganID">
            ...
            <td width="22%"><input name="BeginDate" type="text" id="BeginDate" onFocus="selectDate(this);" value="${begindate}" size="10">
-
	...
	<c:forEach items="${alsod}" var="d">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/report/vocationOrderDetailAction.do"/>	
            </td>
          </tr>
