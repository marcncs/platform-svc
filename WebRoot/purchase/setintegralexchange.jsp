...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  ...
  <tr> 
    ...
    <td width="772"> 产品积分兑换</td>
  </tr>
</table>

    <form action="../purchase/setIntegralExchangeAction.do" method="post" name="validateProduct" onSubmit="return formChk()">
        ...
        <tr>
          ...
          <table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
            ...
            <tr align="center" class="table-back">
              ...
              <td align="left"><input name="unitintegral" type="text" id="unitintegral" value="<windrp:format value='${p.unitintegral}'/>" size="10" maxlength="8" onKeyPress="KeyPress(this)" dataType="Double" msg="积分只能是数字!"></td>
            </tr>
			</logic:iterate> 
        </table>
