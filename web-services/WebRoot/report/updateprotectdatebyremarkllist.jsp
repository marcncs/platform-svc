...
<body>
<form name="validateProvide" method="post" action="../report/updateProtectDateByRemarkAction.do" onSubmit="return ChkValue();">
  ...
  <tr>
    <td>
      ...
      <table width="100%" height="102" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="30%">备注:<input id="id" name="id" type="hidden" value="${id}"></td> 
          <td>
