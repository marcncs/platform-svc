      ...
      <tr>
        <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
            <tr>
              ...
              <td width="772">文件导入</td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td>
		<form name="refer" method="post" enctype="multipart/form-data" action="../warehouse/productStockPileImportAction.do" onSubmit="return formcheck()">
