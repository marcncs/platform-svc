...
function OutPut() {
	excputform.action = "../report/excputProductExpirationAlertReportAction.do";
	excputform.submit();
}
this.onload =function onLoadDivHeight(){
	...
	<body>
				...
				<td>
					<div id="div1">
						...
						<form name="searchform" method="post" onSubmit="showloading();"
							action="productExpirationAlertReportAction.do">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr class="table-back">
									...
									<td>
										<input type="text" name="Batch" id="Batch" value="${Batch }" />
									</td>
									<td></td>
								</tr>
								<tr class="table-back">
									...
									<td>
										<input name="validate" type="text" id="validate" value="${validate}"
											maxlength="60">
									</td>
									<td align="right">
										单位：
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								...
								<ws:hasAuth operationName="/report/excputProductExpirationAlertReportAction.do">
									<td width="50">
								...
								<td class="SeparatePage">
									<c:if test="${prompt=='view'}">
									<pages:pager
										action="../report/productExpirationAlertReportAction.do" onsubmit="showloading()" />
									</c:if>
								</td>
							</tr>
						</table>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<c:forEach items="${alp}" var="d">
								<tr class="table-back-colorbar" onClick="CheckedObj(this,'${d.organid}');">
									...
									<td>
									<windrp:dateformat  p='yyyy-MM-dd' value='${d.productdate}'  /> 
									</td>
									<td>
									<windrp:dateformat  p='yyyy-MM-dd' value='${d.expirydate}'  /> 
									</td>
									<td>
										${d.validate }
									</td>
		...
		<form name="excputform" method="post"
			action="excputProductExpirationAlertReportAction.do">
