...
function excput(){
searchform.target="";
	searchform.action="../report/excPutHarmShipmentBillDetailAction.do";
	searchform.submit();
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printHarmShipmentBillDetailAction.do";
	searchform.submit();
...
function oncheck(){
	searchform.target="";
	searchform.action="../report/harmShipmentBillDetailAction.do";
	searchform.submit();
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>出库>>报损明细</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="harmShipmentBillDetailAction.do" onSubmit="return oncheck();">
          ...
          <tr class="table-back">
            ...
            <td><input name="ProductID" type="hidden" id="ProductID" value="${ProductID}">
              <input id="ProductName" name="ProductName"
               ...
               ><img src="../images/CN/find.gif" align="absmiddle" width="18" height="18" border="0"></a>            </td>
            <td align="right">&nbsp;</td>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/harmShipmentBillDetailAction.do"/></td>
          </tr>
      </table>
      </div>
