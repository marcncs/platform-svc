...
<script language=javascript>
  function addRow(p){
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
        ...
        b.innerHTML="<input name=\"scdid\" type=\"hidden\" value=''><input name=\"productid\" type=\"text\" id=\"productid\" value='"+p.productid+"' size=\"12\" readonly>";
        ...
        j.innerHTML="<input name=\"checkquantity\" type=\"text\" id=\"checkquantity\" value=\"0\" size=\"10\" maxlength=\"8\" onKeyPress=\"KeyPress(this)\" dataType=\"Double\" msg=\"盘点数量只能是数字!\" require=\"false\" readonly>";
...
function SupperSelect(rowx){
	...
	for(var i=0;i<p.length;i++){	
		if ( isready('productid', p[i].productid)&&isready2('dwarehousebit', p[i].warehousebit,'batch',p[i].batch) ){
			continue;
		}
		addRow(p[i]);				
	}
...
<form name="validateProvide" method="post" action="updStockCheckBarAction.do" onSubmit="return ChkValue();">
      ...
      <table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
        ...
        <logic:iterate id="p" name="als" >
          <tr class="table-back">
            ...
            <td><input name="scdid" type="hidden" value="${p.id}" ><input name="productid" type="text" value="${p.productid}" id="productid" size="12" readonly></td>
            ...
            <td><input name="checkquantity" type="text" value="${p.checkquantity}" id="checkquantity" size="10" maxlength="10" onKeyPress="KeyPress(this)" dataType="Double" msg="盘点数量只能是数字!" require="false" readonly></td>
          </tr>
