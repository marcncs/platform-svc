...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  ...
  <tr> 
    ...
    <td width="772"> 积分查询 </td>
  </tr>
</table>
<form name="search" method="post" action="listCIntegralDealOutlineAction.do">
      <table width="100%"   border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr class="table-back"> 
            <td width="10%"  align="right">积分段：</td>
            <td width="24%"><input type="text" name="BeginPrice" size="10" >
-
  <input type="text" name="EndPrice" size="10" ></td>
            <td width="10%" align="right">制单日期：</td>
            <td width="23%"><input type="text" name="BeginDate" size="10" onFocus="javascript:selectDate(this)">
-
  <input type="text" name="EndDate" size="10" onFocus="javascript:selectDate(this)">
 ...
 <FORM METHOD="POST" name="listform" ACTION="">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="title-top"> 
            ...
            <td width="19%"  align="center">会员</td>
		...
		<c:set var="count" value="0"/>
          ...
          <tr class="table-back" onClick="CheckedObj(this,'${d.billno}');"> 
            <td >${d.billno}</td>
            <td>${d.organidname}</td>
            <td><a href="../sales/listCIntegralDealAllAction.do?CID=${d.cid}">${d.cidname}</a></td>
    ...
    <td width="52%"> 
      <table  border="0" cellpadding="0" cellspacing="0" >
          ...
          <tr> 
			...
			<presentation:pagination target="/sales/listCIntegralDealOutlineAction.do"/>	
            </td>
          </tr>
