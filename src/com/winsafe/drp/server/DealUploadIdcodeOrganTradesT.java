 ...
 * www.winsafe.cn 
 */
public class DealUploadIdcodeOrganTradesT extends DealUploadIdcode{
	private AppOrganTrades apppi = new AppOrganTrades();
	private AppOrganTradesDetail apppd = new AppOrganTradesDetail();
	private AppOrganTradesTIdcode app = new AppOrganTradesTIdcode();
	
	
	public DealUploadIdcodeOrganTradesT(String filepath, String fileaddress, int iuid) {
	...
	public String addIdcode(String uploadidcode) {		
		...
		try{
			...
			if ( app.getOrganTradesTIdcodeByidcode(productid, billno, idcode) != null ){
