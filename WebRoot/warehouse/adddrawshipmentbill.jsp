  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增领用出库单</td>
        </tr>
      </table>
       <form name="validateProvide" method="post" action="addDrawShipmentBillAction.do">
	  ...
	  <tr>
	      ...
	      <td width="25%">
			<input name="organid" type="hidden" id="organid">
		  	<input name="orgname" type="text" id="orgname" size="30" dataType="Require" msg="必须录入调出机构!" readonly><a href="javascript:SelectOrgan2();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a>
			<span class="style1">*</span>
		  </td>
	  	  <td width="9%"  align="right">出货仓库：</td>
          <td width="25%">
				<input type="hidden" name="warehouseid" id="warehouseid">
			<input type="text" name="owname" id="owname" onClick="selectDUW(this,'warehouseid',$F('organid'),'w','')" value="" readonly/>	
			<span class="STYLE1">*</span>
			</td>
          ...
          <tr>
			...
			<table width="100%"   border="0" cellpadding="0" cellspacing="0">
              <tr align="center" class="table-back">
                <td width="3%" align="left"><a href="javascript:javascript:deleteR('che','dbtable')"><img src="../images/CN/del.gif"   border="0"></a></td>
                <td width="11%">&nbsp;</td>
                <td width="7%">&nbsp;</td>
