...
var checkid=0;
	...
	function addNew(){
	window.open("../machin/toAddOtherShipmentBillAction.do","","height=650,width=1000,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
	}
	...
	function OtherShipmentDetail(){
		if(checkid!=""){
			document.all.submsg.src="../machin/otherShipmentBillDetailAction.do?ID="+checkid;
		}else{
			alert("请选择你要操作的记录!");
		}
	}
...
function Import() {
	window.open("../machin/toImportOtherOutcomeProductAction.do?incomeSort=0","","height=300,width=500,top=190,left=190,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
	...
	<body>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post"
							action="../machin/listOtherShipmentBillAction.do">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								<ws:hasAuth operationName="/machin/toAddOtherShipmentBillAction.do">
									<td width="50">
								...
								<ws:hasAuth operationName="/machin/toUpdOtherShipmentBillAction.do">
									<td width="50">
								...
								<ws:hasAuth operationName="/machin/delOtherShipmentBillAction.do">
									<td width="50">
								...
								<ws:hasAuth operationName="/machin/toImportOtherOutcomeProductAction.do">
									<td width="50">
			...
			<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>	
			-->
								<ws:hasAuth operationName="/machin/excPutOtherShipmentBillAction.do">
									<td width="50">
					...
					<div id="listdiv" style="overflow-y: auto; height: 600px;">
						...
						<div style="width: 100%">
							<div id="tabs1">
								<ul>
									<li>
										<a href="javascript:OtherShipmentDetail();"><span>其他出库详情</span> </a>
									</li>
								</ul>
							</div>
							<div>
