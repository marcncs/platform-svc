 ...
 var chebox=null;
  function addRow(p){
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
        ...
        f.innerHTML="<input name=\"unitprice\" type=\"text\" id=\"unitprice\"  value='"+p.cost+"' size=\"10\" maxlength=\"10\" onKeyPress=\"KeyPress(this)\" dataType=\"Double\" msg=\"单价只能是数字!\" require=\"false\" onchange=\"SubTotal("+dbtable.rows.length+");TotalSum();\" onFocus=\"SubTotal("+dbtable.rows.length+");TotalSum();\">";
        g.innerHTML="<input name=\"quantity\" type=\"text\" id=\"quantity\" value=\"1\" size=\"8\" maxlength=\"8\" onKeyPress=\"KeyPress(this)\" dataType=\"Double\" msg=\"数量只能是数字!\" require=\"false\" onchange=\"SubTotal("+dbtable.rows.length+");TotalSum();\" onFocus=\"SubTotal("+dbtable.rows.length+");TotalSum();\">";		
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增组装关系设置</td>
        </tr>
      </table>
       <form name="validateProvide" method="post" action="../machin/addAssembleRelationAction.do" onSubmit="return Chk();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
	    ...
	    <td width="23%"><input name="arproductid" type="text" id="arproductid" readonly><a href="javascript:SelectSingleProduct();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a></td>
	    <td width="13%" align="right">组装产品名称：</td>
	    <td width="20%"><input name="arproductname" type="text" id="arproductname" readonly></td>
	    <td width="15%" align="right">规格：</td>
	    <td width="20%"><input name="arspecmode" type="text" id="arspecmode" readonly></td>
	  </tr>
	  <tr>
	    <td height="19" align="right">计量单位：</td>
	    <td><input name="arunitid" type="hidden" id="arunitid">
	      <input name="arunitidname" type="text" id="arunitidname" size="6" readonly></td>
	    <td align="right">数量：</td>
	    <td><input name="arquantity" type="text" id="arquantity" value="1" size="4" readonly></td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
	  </tr>
	  </table>
          ...
          <tr>
			...
			<table width="100%"   border="0" cellpadding="0" cellspacing="0">
              <tr align="center" class="table-back">
                <td width="20" ><a href="javascript:deleteR('che','dbtable');"><img src="../images/CN/del.gif"   border="0"></a></td>
