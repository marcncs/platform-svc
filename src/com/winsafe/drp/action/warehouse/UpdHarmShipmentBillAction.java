...
public class UpdHarmShipmentBillAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			HarmShipmentBill oldW = (HarmShipmentBill)BeanUtils.cloneBean(osb);
			...
			aspb.delHarmShipmentBillDetailBySbID(id);
			...
			aosb.updHarmShipmentBill(osb);
			
			request.setAttribute("result", "databases.upd.success");

            DBUserLog.addUserLog(userid,7,"报损>>修改报损出库,编号："+id,oldW,osb); 
