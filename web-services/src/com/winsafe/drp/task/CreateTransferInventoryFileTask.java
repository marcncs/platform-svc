 ...
 * 
 */
public class CreateTransferInventoryFileTask {

	private static Logger logger = Logger
			.getLogger(CreateTransferInventoryFileTask.class);
	// 同步锁
...
//		transferLogs = appTl.getAllUnTransferedLogs();
	...
	private void startCreateTransferFile() throws Exception {
		try {
			FileTransferService fts = FileTransferService.getTransferService(FileType.INVENTORY_DETAIL);
