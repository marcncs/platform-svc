...
function excput(){
	searchform.target="";
	searchform.action="../report/excPutPurchaseIncomeProductTotalAction.do";
	searchform.submit();
}
function oncheck(){
	searchform.target="";
	searchform.action="../report/purchaseIncomeProductTotalAction.do";
	searchform.submit();
}

function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseIncomeProductTotalAction.do";
	searchform.submit();
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>入库>>采购入库按产品汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="purchaseIncomeProductTotalAction.do" onSubmit="return oncheck();">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseIncomeProductTotalAction.do"/></td>
          </tr>
      </table>
      </div>
