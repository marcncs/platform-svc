...
function excput(){
	searchform.action="../assistant/excPutCIntegralDetailAction.do";
	searchform.submit();
	searchform.action="../assistant/cIntegralDetailAction.do";
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">会员获得积分明细</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="../assistant/cIntegralDetailAction.do">
     ...
     <!--   <tr class="back-gray-light">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/assistant/cIntegralDetailAction.do"/>	
            </td>
          </tr>
