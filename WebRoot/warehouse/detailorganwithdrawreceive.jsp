...
<title>WINDRP-分销系统</title>
	...
	function Receive(id){
			showloading();
			popWin("../warehouse/completeOrganWithdrawReceiveAction.do?ID="+id,500,250);
	}
	
	function CancelReceive(id){
		showloading();
		popWin("../warehouse/cancelCompleteOrganWithdrawReceiveAction.do?ID="+id,500,250);
	}
	function toaddidcode(billid,bdid,wid,isaudit){
			popWin4("../warehouse/toAddOrganWithdrawIdcodeiiAction.do?billid="+billid+"&bdid="+bdid+"&wid="+wid+"&isaudit="+isaudit,1000,650,"idcode");
	}
	...
	function toQuantityCheck(id){
		$.post("../warehouse/ajaxQuantityCompleteOrganWithdrawAction.do?id="+id, function(result){
						...
						<tr>
							...
							<td align="right">
								<table border="0" cellpadding="0" cellspacing="0">
									<tr>
										<ws:hasAuth operationName="/ditch/printOrganWithdrawReceiveAction.do">
										...
										<ws:hasAuth
											operationName="/warehouse/completeOrganWithdrawReceiveAction.do">
