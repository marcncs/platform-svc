...
function excput(){
	...
	searchform.action="../report/excPutPurchaseProviderTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseProviderTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseProviderTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseProviderTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>采购>>采购订单按供应商汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="purchaseProviderTotalAction.do">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseProviderTotalAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutPurchaseProviderTotalAction.do" >
