...
public class StockWasteBook extends ActionForm implements Serializable {
    ...
    /** full constructor */
    public StockWasteBook(Long id, String productid, String batch, String warehouseid, String billcode, Double cyclefirstquantity, Double cycleinquantity,Double cycleoutquantity, Double cyclebalancequantity, Date recorddate) {
        this.id = id;
    ...
    /** default constructor */
    public StockWasteBook() {
    }

    /** minimal constructor */
    public StockWasteBook(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof StockWasteBook) ) return false;
        StockWasteBook castOther = (StockWasteBook) other;
