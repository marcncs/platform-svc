...
<script language="javascript">
	...
	var mobile="";
	var lk={lid:"",lname:"",ltel:"",addr:"",transit:"",mobile:"",organid:""};
	function CheckedObj(obj,objid,objname,objtel,objtransportaddr,objmobile,organids){
	...
	function addNew(){	
		window.open("../users/toAddOlinkmanAction.do?OID=${olcid}","dddddds","height=400,width=900,top=250,left=100,toolbar=no,menubar=no,scrollbars=auto,resizable=no,location=no,status=no");
	}
  ...
  <tr>
	...
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 选择机构联系人</td>
        </tr>
      </table>
       <form name="search" method="post" action="../common/selectOrganLinkmanAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
	   ...
	   <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr class="title-func-back"> 
          ...
          <td class="SeparatePage"> <pages:pager action="../common/selectOrganLinkmanAction.do"/></td>
        </tr>
      </table>
	   </div>
	</td>
	...
	<tr>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table-back-colorbar" onClick="CheckedObj(this,${p.id},'${p.name}','${p.officetel}','${p.addr}','${p.mobile}','${p.cid}');" onDblClick="Affirm();"> 
            <td >${p.name}</td>
