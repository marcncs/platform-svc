...
dTree.prototype.add = function(id, pid, name, url, title, target, icon, iconOpen, open) {
	//this.document.write("style='CURSOR: hand'");
	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url, title, target, icon, iconOpen, open);
	//this.document.write("style='CURSOR: default'");
};
...
dTree.prototype.s = function(id) {
		if(checkedNodeId != "") {
			document.getElementById(checkedNodeId).className = "NODE";
		}
		checkedNodeId = "sd"+id;
		document.getElementById(checkedNodeId).className = "NODECLICKED";
