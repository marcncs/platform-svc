...
function excput(){
	...
	searchform.action="../report/excPutSaleTradesDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/saleTradesDetailAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printSaleTradesDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/saleTradesDetailAction.do";
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>零售>>零售换货明细</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="saleTradesDetailAction.do">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr class="title-func-back"> 
			...
			<pages:pager action="../report/saleTradesDetailAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutSaleTradesDetailAction.do">
