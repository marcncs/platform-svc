...
function excput(){
	searchform.target="";
	searchform.action="../report/excPutPurchaseIncomeBillTotalAction.do";
	searchform.submit();
}
function oncheck(){
	searchform.target="";
	searchform.action="../report/purchaseIncomeBillTotalAction.do";
	searchform.submit();
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseIncomeBillTotalAction.do";
	searchform.submit();
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>入库>>采购入库按单据汇总</td>
        </tr>
      </table>
              <form name="searchform" method="post" action="purchaseIncomeBillTotalAction.do" onSubmit="return oncheck();">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseIncomeBillTotalAction.do"/></td>
          </tr>
      </table>
      </div>
