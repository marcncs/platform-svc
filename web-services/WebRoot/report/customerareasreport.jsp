...
var e=$F("EndDate");
var u="";
document.all.submsg.src="customerAreasReportAction.do?rp="+p+"&b="+b+"&e="+e+"&u="+u;
}
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #B6D6FF;">
          <tr class="table-back" >
            ...
            value="${EndDate}" onFocus="javascript:selectDate(this)" readonly="readonly"></td>
          <td width="114" align="right">会员数量：</td>
          <td colspan="2" align="left">${count}</td>
          <td class="SeparatePage"><input name="Submit" type="image" id="Submit" onClick="ShowReport('province');" src="../images/CN/search.gif" border="0" title="查询"></td>
        </tr>
      </table>
    </div>
      <br>
     ...
     <div id="tabs1">
            <ul>
              <li><a href="javascript:ShowReport('province');"><span>省份</span></a></li>
              <li><a href="javascript:ShowReport('city');"><span>城市</span></a></li>
              <li><a href="javascript:ShowReport('areas');"><span>地区</span></a></li>
            </ul>
          </div>
          <IFRAME id="submsg" 
