...
public class DrawShipmentBillIdcode extends ActionForm implements Serializable  {
	...
	/** default constructor */
	public DrawShipmentBillIdcode() {
	}

	/** minimal constructor */
	public DrawShipmentBillIdcode(long id, String dsid, String productId) {
		this.id = id;
		this.dsid = dsid;
