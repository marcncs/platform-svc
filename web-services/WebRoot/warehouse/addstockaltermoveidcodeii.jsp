...
function addIdcode(){
   ...
   var url = "../warehouse/addStockAlterMoveIdcodeiiAction.do?idcode="+idcode+"&billid="+billid+"&prid="+prid+"&warehousebit="+warehousebit;
...
<%--	      <td width="15%" ><input type="button" value="新增" onClick="formcheck()" ${isaudit==1?"disabled":""} disabled>&nbsp;<input type="button" name="cancel" value="取消" onClick="window.close();"></td>          --%>
      ...
      name="submsg" src="../warehouse/listStockAlterMoveIdcode.do?billid=${billid}&prid=${bbd.productid}&isaudit=${isaudit}" frameBorder="0" scrolling="no" onload="setIframeHeight(this)"></IFRAME>  
