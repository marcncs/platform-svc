 ...
 var chebox=null;
  function addRow(){
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
		...
		//i.innerHTML="<input name=\"incomequantity\" type=\"text\" id=\"incomequantity\" size=\"8\">";
...
function SupperSelect(rowx){
	...
	if((dbtable.rows.length-1) <1){
		for(var i=0;i<arrid.length;i++){
				...
				if(i==0){//第一次加时还不是数组
					...
					document.referForm.item("unitprice").value =arrunitprice[0];
						...
						//document.referForm.item("incomequantity")[i].value=0;
		...
		for(var i=0;i<arrid.length;i++){
			...
			//document.referForm.item("incomequantity")[rowx-1+i].value=0;
...
function SelectProvide(){
	var p=showModalDialog("toSelectProviderAction.do",null,"dialogWidth:16cm;dialogHeight:8cm;center:yes;status:no;scrolling:no;");
...
function SelectLinkman(){
	...
	document.referForm.tel.value=getCookie("ltel");
}
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="referForm" method="post" action="addPurchaseOrderAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="22%"><input name="plinkman" type="text" id="plinkman">
	      ...
	      <td width="20%"><input name="tel" type="text" id="tel" ></td>
	  </tr>
	  <tr>
	    <td  align="right">收货地址：</td>
	    <td><input name="receiveaddr" type="text" id="receiveaddr" size="35"></td>
	    <td align="right">预计到货日期：</td>
	    <td><input name="receivedate" type="text" id="receivedate" onFocus="selectDate(this);" value="<%=com.winsafe.hbm.util.DateUtil.getCurrentDateString()%>" readonly="readonly"></td>
	  ...
	  <tr>
	    ...
	    <td><input name="batch" type="text" id="batch" value="${batch}"></td>
	    </tr>
	  </table>
	</fieldset>
