    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <td width="11%" align="right">产品类别：</td>
            <td width="18%"><input type="hidden" name="KeyWordLeft" id="KeyWordLeft" value="${KeyWordLeft}">			
...
名称关键字：</td>
            <td width="9%" ><input type="text" name="KeyWord" value="${KeyWord}"></td>
            <td width="14%"  align="right">&nbsp;</td>
            <td width="17%" align="right"><span class="SeparatePage">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr class="title-func-back">
          ...
          <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
          <td class="SeparatePage"><pages:pager action="../common/selectWarehouseProductAction.do"/></td>
        </tr>
      </table>
      </div>
	</td>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1" id="ptable">
          ...
          <logic:iterate id="p" name="sls" >
            <tr align="center" class="table-back-colorbar" >
              ...
              <td>${p.specmode}</td>
              <td><input type="text" name="unitidname" size="6" value="${p.unitname}" onFocus="selectUnit(this,'${p.productid}','','','2')"></td>
              <td><span id="spanstockpile${count}">${p.squantity}</span></td>
              <input type="hidden" name="stockpile" id="stockpile${count}" value="${p.stockpile}">
            <input type="hidden" name="pobj" id="pobj${count}" value="{productid:'${p.productid}',productname:'${p.psproductname}',specmode:'${p.specmode}',unitid:'${p.countunit}',unitidname:'${p.unitname}'}">
            </tr>
