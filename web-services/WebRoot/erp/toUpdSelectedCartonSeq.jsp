...
<html>
	...
	function downCovertCode(){
		popWin2("../erp/downloadSelectedCartonSeqAction.do?type=download&ID=${ID}");
	}	
							...
							<td>
								<div id="bodydiv">
									<form name="search" method="post"
										action="../erp/toSelectCartonSeqAction.do?close=1">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr class="title-func-back">
											...
											<c:if test="${plan.closeFlag != 1}">
												<ws:hasAuth operationName="/erp/updSelectedCartonSeqAction.do">
												<td width="1">
													<img src="../images/CN/hline.gif" width="2" height="14">
												</td>
												<td width="70" align="center">
						...
						<tr>
							<td>
								<div id="listdiv" style="overflow-y: auto; height: 480px;">
									<FORM METHOD="POST" name="updform" ACTION="../erp/updSelectedCartonSeqAction.do">
										<table class="sortable" width="100%" border="0"
											...
											<logic:iterate id="p" name="codelist">
												<tr align="center" class="table-back-colorbar">
													...
													<td align="left">
														<input type="text" name="newCode" value="${p.seq}"
