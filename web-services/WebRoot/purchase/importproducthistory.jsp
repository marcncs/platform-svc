...
<html>
	...
	<body>
		<form name="refer" method="post" enctype="multipart/form-data"
			action="../purchase/importSimpleProductHistoryAction.do" 
					...
					<tr>
						...
						<td width="21%">
						    ...
						    <td title="点击下载" width="20%" >
								<a href="../common/downloadfile.jsp?filename=templates/产品历史价格维护模板.xls"><img src="../images/CN/beizheng.gif" border="0">模板下载</a>
							</td>
