...
<script language="javascript">
	function SelectCustomer(){
		...
		document.searchform.CIp.value=c.cid;
...
function SelectOrgan(){
		...
		if ( p==undefined){return;}
			document.searchform.MakeOrganIp.value=p.id;
			document.searchform.oname.value=p.organname;
	}
function SelectOrgan2(){
		var p=showModalDialog("../common/selectOrganAction.do",null,"dialogWidth:21cm;dialogHeight:12cm;center:yes;status:no;scrolling:no;");
		if ( p==undefined){return;}
			document.searchform.EquipOrganIp.value=p.id;
...
function print(){
	...
	excputform.action="../report/printWithdrawBillTotalAction.do";
	excputform.submit();
	excputform.target="";
	excputform.action="../report/excPutWithdrawBillTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>零售>>零售换货按单据汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="withdrawBillTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            ...
            <td width="20%"><input name="ID" type="text" id="ID" value="${ID}" /> </td>
            <td align="right">&nbsp;</td>
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/withdrawBillTotalAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutWithdrawBillTotalAction.do" >
