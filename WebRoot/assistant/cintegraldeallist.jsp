...
function excput(){
	search.action="../assistant/excPutCIntegralDealAllAction.do";
	search.submit();
	search.action="../assistant/listCIntegralDealAllAction.do";
}
</script>
 ...
 <form name="search" method="post" action="listCIntegralDealAllAction.do">
      ...
      <table width="100%" height="44"  border="0" cellpadding="0" cellspacing="0">
         <tr class="table-back"> 
            ...
            <td width="24%"><select name="OrganID" id="OrganID">
            ...
            <td width="10%" align="right">积分类别：</td>
            <td width="23%">${isortselect}</td>
...
-
  <input name="EndDate" type="text" id="EndDate" onFocus="selectDate(this);" value="${enddate}" size="10"></td>
          ...
          <tr class="table-back">
            ...
            <td><input name="BeginPrice" type="text" id="BeginPrice" value="${beginprice}" size="10">
-
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="48%"><table width="60" border="0">
                <tr>
    ...
    <td width="52%"> 
      <table  border="0" cellpadding="0" cellspacing="0" >
          ...
          <tr> 
			...
			<presentation:pagination target="/assistant/listCIntegralDealAllAction.do"/>	
            </td>
          </tr>
