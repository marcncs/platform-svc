...
<html>
	...
	<body>
		<form name="refer" method="post" enctype="multipart/form-data"
			action="../sys/importCustomerMatchOrderAction.do"
				...
				<table class="table-detail">
					<tr>
						...
						<td title="点击下载" width="30%" >
								<a href="../common/downloadfile.jsp?filename=templates/配货顺序导入模板.xls"><img src="../images/CN/beizheng.gif" border="0">模板下载</a>
						</td>
