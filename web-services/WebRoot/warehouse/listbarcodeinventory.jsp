...
<html>
	...
	var warehouseid="";
	var isapproves="";
	function CheckedObj(obj,objid,objwid,isapprove){	
	 ...
	 checkid=objid;
	 warehouseid=objwid;
	 isapproves=isapprove;
	 OtherShipmentDetail();
	}

	function addNew(){
	window.open("../warehouse/toAddBarcodeInventoryAction.do","","height=650,width=1000,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
	}
	...
	function OtherShipmentDetail(){
		if(checkid!=""){
			document.all.submsg.src="../warehouse/barcodeInventoryDetailAction.do?Warehouseid="+warehouseid+"&ID="+checkid;
		}else{
			alert("请选择你要操作的记录!");
		}
	}
...
function approve(){
	if(checkid!=""){
		...
		if(confirm("确认要审核该记录吗?")){
			...
			popWin("../warehouse/toApproveBarcodeInventoryAction.do?ID="+checkid, 800, 250);
		}
	}else{
		alert("请选择你要操作的记录!");
	}
	...
	<body>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post"
							action="../warehouse/listBarcodeInventoryAction.do">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr class="table-back">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<ws:hasAuth operationName="/warehouse/toAddBarcodeInventoryAction.do">
								<td width="50">
									<a href="javascript:addNew();"><img src="../images/CN/addnew.gif"
											width="16" height="16" border="0" align="absmiddle">&nbsp;新增</a>
								</td>
								</ws:hasAuth>
								<ws:hasAuth operationName="/warehouse/toApproveBarcodeInventoryAction.do">
									<td width="50">
			...
			-->
								...
								-->
								<td class="SeparatePage">
									<pages:pager action="../warehouse/listBarcodeInventoryAction.do" />
								</td>
							</tr>
						</table>
					</div>
					...
					<div id="listdiv" style="overflow-y: auto; height: 600px;">
						...
						<div style="width: 100%">
							<div id="tabs1">
								<ul>
									<li>
										<a href="javascript:OtherShipmentDetail();"><span>条码盘点详情</span> </a>
									</li>
								</ul>
							</div>
							<div>
