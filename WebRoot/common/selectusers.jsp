...
<script language="javascript">
	...
	var checkname="";
	var loginname="";
	function CheckedObj(obj,objid,objname,objloginname){
	 ...
	 checkid=objid;
	 checkname = objname;
	 loginname=objloginname;
	}

	function Affirm(){
	if(checkid>0){
		var user={uid:checkid, uname:checkname,loginname:loginname};
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="search" method="post" action="selectUsersAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr class="title-func-back">
          ...
          <td class="SeparatePage"><pages:pager action="../common/selectUsersAction.do"/>
          </td>
        </tr>
      </table>
      </div>
	...
	<tr>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="table-back-colorbar" onClick="CheckedObj(this,${p.userid},'${p.realname}','${p.loginname }');" onDblClick="Affirm();"> 
            <td >${p.userid}</td>
            <td>${p.loginname}</td>
            <td>${p.realname}</td>
            <td>${p.sexname}</td>
