...
function SupperSelect(rowx){
	...
	var oid=document.referForm.porganid.value;
	if(wid==null||wid=="")
	{
		alert("请选择出货仓库！");
		return;
...
function clearProductList() {
	...
	<body style="overflow: auto;">
		<form name="referForm" id="referForm" method="post" action="updOrganWithdrawAction.do"
									...
									<fieldset align="center">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1">
											<tr>
												...
												<td width="25%">
													<input name="porganid" type="hidden" id="porganid"
														value="${ama.porganid }">
													<input name="porganname" type="text" id="porganname"
														value="${ama.porganname }" size="30" dataType="Require"
														msg="必须录入退货机构!" readonly>
												...
												<td width="20%">
													<input type="hidden" name="outwarehouseid" id="outwarehouseid"
														value="${ama.warehouseid }">
													<input type="text" name="owname" id="owname" value="${owname }"
											...
											<tr>
												...
												<td>
													<input name="receiveorganid" type="hidden" id="receiveorganid"
														value="${ama.receiveorganid }">
													<input name="oname" type="text" id="oname" value="${oname }"
														size="30" dataType="Require" msg="必须录入调入机构!" readonly>
												...
												<td>
													<input type="hidden" name="inwarehouseid" id="inwarehouseid"
														value="${ama.inwarehouseid }">
													<input type="text" name="wname" id="wname" value="${wname}"
												...
												<tr>
													...
													<td>
														<input type="text" id="plinkman" name="plinkman" size="30"
															value="${ama.plinkman }" dataType="Require" msg="必须录入联系人!">
													...
													<td>
														<input type="text" id="tel" name="tel" value="${ama.tel }"
										...
										<table width="100%" id="dbtable" border="0" cellpadding="0"
											...
											<logic:iterate id="p" name="list">
												<tr class="table-back">
														...
														<td>
															<input name="nccode" type="text" value="${p.nccode}" id="nccode"
																readonly>
														</td>
														<td>
															<input name="productname" type="text" id="productname" size="40"
																readonly value="${p.productname}">
														</td>
														<td>
														...
														<td>
															<input name="quantity" type="text"
																value="<windrp:format value="${p.quantity}" p="#####0" />"
																dataType='Integer' msg='必须录入整数' onkeyup="checknum(this);changeUnit(this.value,${p.unitid},'${p.countUnitName }','${p.unitList }',this,true);"
											...
											<tr>
												...
												<td>
													<textarea name="remark" cols="100"
														...
														id="remark" dataType="Limit" max="256" msg="退货原因必须在500个字之内"
														require="false">${ama.withdrawcause }</textarea>
													<br>
