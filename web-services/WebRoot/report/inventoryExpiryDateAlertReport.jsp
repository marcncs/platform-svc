...
<html>
	<head>
		...
		function OutPut() {
			excputform.action = "../report/exportInventoryExpiryDateAlertReportAction.do";
			excputform.submit();
		}
				...
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post"
							action="inventoryExpiryDateAlertReportAction.do" onsubmit="return formChk();">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr class="table-back">
									...
									<td>
										<input name="startDate" size=6 type="text" id="startDate"" value="${startDate}" onkeyup="checknum(this)"> - <input size=6 name="endDate" type="text" id="endDate"" value="${endDate}"  onkeyup="checknum(this)">
									</td>
									<td  align="right">
										发货有效期(天)：
									</td>
									<td>
										<input name="dStartDate" size=6 type="text" id="dStartDate"" value="${dStartDate}" onkeyup="checknum(this)"> - <input size=6 name="dEndDate" type="text" id="dEndDate"" value="${dEndDate}" onkeyup="checknum(this)">
									</td>
									<td align="right">
										单位：
									</td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								...
								<ws:hasAuth operationName="/report/inventoryExpiryDateAlertReportAction.do">
									<td width="50">
									...
									<td class="SeparatePage">
										<pages:pager action="../report/inventoryExpiryDateAlertReportAction.do" onsubmit="formChk()"/>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<FORM METHOD="POST" name="listform" ACTION="">
							<table class="sortable" width="200%" border="0" cellpadding="0"
								...
								<tr align="center" class="title-top">
										...
										<td>
											当前有效期(天)<br>Shelf Life Days
										</td>
										<td>
											当前有效期(月)<br>Shelf Life Month
										</td>
										<td>
											发货单号<br>SAP Delivery No
										</td>
										<td>
											发货日期<br>Delivery Date
										</td>
										<td>
											发货有效期(天)<br>Shelf Life days on Delivery Date
										</td>
										<td>
											发货有效期(月)<br>Shelf Life Month on Delivery Date
										</td>
									</tr>
								<logic:iterate id="rs" name="rls">
									<tr align="left" class="table-back-colorbar">
										...
										<TD align="center">
											${rs.shelfLifeDaysOnDeliveryDate}
										</TD>
										<TD align="center">
											${rs.shelfLifeMonthOnDeliveryDate}
										</TD>
									</tr>
								</logic:iterate>
							</table>
...
<form  name="excputform" method="post" action="exportInventoryExpiryDateAlertReportAction.do">
