...
public class AuditAmountInventoryAction extends BaseAction {
	private Logger logger = Logger.getLogger(AuditAmountInventoryAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			AmountInventory ai = aai.getAmountInventoryByID(aiid);
			
			if (ai.getIsaudit() == 1)
			{
				request.setAttribute("result", "复核失败,单据已复核");
			...
			ai.setAuditid(userid);
			aai.updAmountInventory(ai);
