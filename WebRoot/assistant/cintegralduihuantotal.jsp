...
function excput(){
	searchform.action="../assistant/excPutCIntegralDuihuanTotalAction.do";
	searchform.submit();
	searchform.action="../assistant/cIntegralDuihuanTotalAction.do";
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">会员已兑换积分汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="../assistant/cIntegralDuihuanTotalAction.do">
  ...
  <input name="EndPrice" type="text" id="EndPrice" value="${endprice}" size="10"></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr class="title-top">
          ...
          <td width="19%" align="center" >机构</td>
     ...
     <!--   <tr class="back-gray-light">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/assistant/cIntegralDuihuanTotalAction.do"/>	
            </td>
          </tr>
