...
public class OtherIncome implements Serializable {
    ...
    /** full constructor */
    public OtherIncome(String id, Integer incomesort, String billno, String warehouseid, String remark, Integer isaudit, Integer auditid, Date auditdate, String makeorganid, Integer makedeptid, Integer makeid, Date makedate, Integer printtimes, String keyscontent,String nccode) {
        this.id = id;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof OtherIncome) ) return false;
        OtherIncome castOther = (OtherIncome) other;
