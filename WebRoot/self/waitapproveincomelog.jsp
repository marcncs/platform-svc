...
var checkid=0;
	...
	function Approve(){
		if(checkid>0){
			location.href("../self/toApproveIncomeLogAction.do?ID="+checkid);
		}else{
			alert("请选择你要操作的记录!");
		}
	}
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="search" method="post" action="waitApproveIncomeLogAction.do">
...
-
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="title-top"> 
            <td width="41" >编号</td>
            <td width="100">销售单编号</td>
            <td width="279"> 客户名</td>
            <td width="116">总金额</td>
            <td width="97">本次收款</td>
            <td width="140">收款日期 </td>
          ...
          <tr align="center" class="table-back" onClick="CheckedObj(this,${pl.id});"> 
            <td ><a href="../sales/incomeLogDetailAction.do?ID=${pl.id}">${pl.id}</a></td>
            <td>${pl.slid}</td>
            <td>${pl.customername}</td>
            <td width="116">${pl.billtotalsum}</td>
            <td width="97">${pl.incomesum}</td>
            <td width="140">${pl.incomedate}</td>
            <td width="109">${pl.approvename}</td>
            <td width="114">${pl.incomestatusname}</td>
          </tr>
          </logic:iterate> 
...
<table  border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="58%"> <presentation:pagination target="/self/waitApproveIncomeLogAction.do"/> 
          </td>
        </tr>
      </table></td>
  </tr>
