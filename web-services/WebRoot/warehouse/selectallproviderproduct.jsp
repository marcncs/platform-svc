	...
	function Affirm(){
		...
		for(var i=0;i<document.listform.pid.length;i++){
			if(document.listform.pid[i].checked){
				...
				arrporductname[k]=document.listform.productname[i].value;
				...
				arrporductname[0]=document.listform.productname.value;
		...
		if(flag){
			...
			var p={productid:arrid.slice(0),productname:arrporductname.slice(0),specmode:arrspecmode.slice(0),unitid:unitid.slice(0),countunit:arrcountunit.slice(0),unitprice:arrunitprice.slice(0)};
			//alert(p);
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            <td width="16%"  align="right"><input name="pid" type="hidden" id="pid" value="${pid}">
            产品类别：</td>
            <td width="42%"><select name="KeyWordLeft" id="KeyWordLeft">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
		  ...
		  <tr align="center" class="table-back" > 
            ...
            <td><input type="hidden" name="unitid" id="unitid${count}" value="${p.countunit}">
              <input type="text" name="countunit" size="6" value="${p.unitname}" onFocus="selectUnit(this,'${p.productid}','')"></td>
            <td><input type="hidden" name="price" value="${p.price}"><fmt:formatNumber value="${p.price}" pattern="0.00"/>
              </td>
		  </tr>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%"> <presentation:pagination target="/warehouse/selectAllProviderProductAction.do"/> 
          </td>
        </tr>
      </table>
