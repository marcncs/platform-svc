...
<script language="javascript">
	function SelectCustomer(){
		...
		document.search.POID.value=s.oid;
		...
		document.search.POID.value=s.cid;
		...
		document.search.POID.value=s.pid;
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="payoutWasteAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		 ...
		 <tr class="table-back">
            ...
            <td width="9%" align="right">领款方：</td>
            <td width="29%"><input name="POID" type="hidden" id="POID" value="${POID}">
                <input name="payername" type="text" size="35" value="${payername}"><a href="javascript:SelectCustomer();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a></td>
          ...
          <tr class="table-back">
            ...
            <td width="29%"><input name="BeginDate" type="text" id="BeginDate" size="10" onFocus="javascript:selectDate(this)">
-
