...
<script language="JavaScript">
	...
	function addParntAddr(){//增加地区
		...
		var url = '../assistant/ajaxAddRepositoryTypeAction.do';
	...
	function updParntAddr(){//修改地区
		...
		var url = '../assistant/ajaxUpdRepositoryTypeAction.do';
	...
	function delParntAddr(){//删除
		...
		var url = '../assistant/ajaxDelRepositoryTypeAction.do';
    ...
    function getResult(thisid)//获得地区　
    {
		...
		str="";
        id1 = thisid;
        var url = '../assistant/ajaxListRepositoryTypeAction.do';
	...
	function product(productstructid){
		document.all.product.src="../assistant/listRepositoryAction.do?OtherKey="+productstructid;
	}
  ...
  <tr>
    <td width="20%" valign="top">
		  ...
		  <tr>
			...
			<div id="treecon">
				<fieldset>
				<legend class="orglegend" onClick="selectdo(this)">增加知识库类别</legend>
					<div style="text-align:center; display:none">
						<p><label>选择父类别</label><input type="text" readonly="true" value="" class="inputtree1" id="parentadd"/></p>
						<p><label>父类别编号</label><input type="text" readonly="true" value="" class="inputtree1" id="parentadd0"/></p>
						<p><label>输入新类别</label><input type="text" value="" class="inputtree1" id="newarea"/></p>
						<p style="text-align:center"><input type="button" onClick="addParntAddr()" value="确定"> <input type="button" value="重置"></p>
					</div>
				</fieldset>
				<fieldset>
				<legend class="orglegend" onClick="selectdo(this)">修改知识库类别</legend>
					<div style="text-align:center; display:none">
						<p><label>修改类别名</label><input type="text" value="请选择类别" class="inputtree1" id="parentadd2"/></p>
						<p>
						<label>类别编号</label><input type="text"  readonly="true" value="请选择类别" class="inputtree1" id="parentadd1"/>
						</p>
						<p style="text-align:center"><input type="button" value="修改"  onclick="updParntAddr()"> <input type="button" value="删除" onClick="delParntAddr()"></p>
					</div>
				</fieldset>
			</div>
			</td>
    ...
    <td width="80%"><IFRAME id="product" 
      ...
      name="product" src="../assistant/listRepositoryAction.do" frameBorder=0 
