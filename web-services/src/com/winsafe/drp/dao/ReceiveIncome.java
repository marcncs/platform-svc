...
public class ReceiveIncome extends ActionForm implements Serializable {
    ...
    /** full constructor */
    public ReceiveIncome(String id, String handwordcode, String warehouseid, String producebatch, Integer incomedept, Date incomedate, Integer incomesort, String remark, Integer isrefer, Integer approvestatus, Date approvedate, Integer isaudit, Integer auditid, Date auditdate, Integer makeid, Date makedate,String nccode) {
        this.id = id;
    ...
    /** minimal constructor */
    public ReceiveIncome(String id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ReceiveIncome) ) return false;
        ReceiveIncome castOther = (ReceiveIncome) other;
