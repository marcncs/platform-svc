...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="validateProvide" method="post" action="../finance/destoryPaymentLogAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
      <table width="60" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <tr class="table-back" onClick="CheckedObj(this,'${s.id}',${s.paysum-s.alreadyspend});"> 
			<td >${s.id}</td>
            <td>${s.payee}</td>
            <td>${s.fundsrcname}</td>
            <td>${s.paysum}</td>
          ...
          <tr>
            ...
            <tr class="table-back">
                ...
                <td ><input name="paymode" type="hidden" value="${p.paymode}" id="paymode">
                <input name="paymodename" type="text" value="${p.paymodename}" id="paymodename" size="8" readonly></td>
				<td><input name="billno" type="text" value="${p.billno}" id="billno" size="40" readonly></td>
                <td><input name="receivablesum" type="text" value="${p.payablesum}" readonly></td>		
