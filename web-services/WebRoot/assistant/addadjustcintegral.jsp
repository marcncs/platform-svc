  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增会员积分调整单</td>
        </tr>
      </table>
       <form name="validateProvide" method="post" action="../assistant/addAdjustCIntegralAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
		<tr>
		  ...
		  <td ><textarea name="remark" cols="120" id="remark"></textarea></td>
		  </tr>
      </table>
	</fieldset>
