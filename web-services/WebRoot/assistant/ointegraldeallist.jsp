...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  ...
  <tr> 
    ...
    <td width="772"> 机构积分明细查询 </td>
  </tr>
</table>
 <form name="search" method="post" action="../assistant/listOIntegralDealAllAction.do">
...
<FORM METHOD="POST" name="listform" ACTION="">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="title-top"> 
            ...
            <td width="19%"  align="center">积分类别</td>
    ...
    <td width="52%"> 
      <table  border="0" cellpadding="0" cellspacing="0" >
          ...
          <tr> 
			...
			<presentation:pagination target="/assistant/listOIntegralDealAllAction.do"/>	
            </td>
          </tr>
