...
<html>
	...
	function addNew(){
		popWin("../ditch/addProductReturn.do",1000,650);
	}

	function Update(){
		if(checkid!=""){
			popWin("../ditch/updProductReturn.do?ID="+checkid,1000,650);
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	...
	function oncheck(){
			search.action="productReturn.do";
			search.submit();
	}
				...
				<td>
					<div id="div1">
						...
						<form name="search" method="post"
								action="productReturn.do" onSubmit="return oncheck();">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr class="table-back">
								...
								<td>
									<windrp:select key="YesOrNo" name="IsAffirm" p="y|f" value="${IsAffirm}" />
								</td >
								<td align="right">
									是否签收：
								</td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								...
								<td class="SeparatePage">
						           <pages:pager action="../ditch/productReturn.do" />
								</td>
							</tr>
						</table>
					</div>
					<div id="abc" style="overflow-y: auto; height: 600px;">
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<logic:iterate id="o" name="list">
									...
									<td class="${o.isblankout==1?'td-blankout':''}" align="right">
										<windrp:format value="${o.totalsum }" p="###,##0.00"/>
									</td>
									<td class="${o.isblankout==1?'td-blankout':''}">
						...
						<div style="width:100%">
						     	<div id="tabs1">
						           <ul>
						             <li><a href="javascript:OrganWithdrawDetail();"><span>退货详情</span></a></li>
						           </ul>
						         </div>
