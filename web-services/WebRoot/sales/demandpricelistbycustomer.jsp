...
<form name="search" method="post" action="listDemandPriceByCustomerAction.do">
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        
          <tr class="table-back"> 
            <td width="16%"  align="right"><input name="CID" type="hidden" id="CID" value="${cid}">
            是否复核：              </td>
  ...
  <tr>
    <td width="48%"><table  border="0" cellpadding="0" cellspacing="0">
          ...
          <tr> 
			...
			<presentation:pagination target="/sales/listDemandPriceByCustomerAction.do"/>	
            </td>
          </tr>
