...
function OutPut() {
	searchform.action = "../report/excputConsumeDetailHistoryAction.do";
	searchform.submit();
	searchform.action = "../report/listConsumeDetailHistoryAction.do";
}
function ToUpd(){
	popWin("../report/toUpdConsumeDetailHistoryAction.do",700,250);
}
</script>
	</head>
	<body>
				...
				<td>
					<div id="div1">
						...
						<form name="searchform" method="post"
							action="../report/listConsumeDetailHistoryAction.do" onSubmit="return formChk();">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<ws:hasAuth operationName="/report/excPutConsumeDetailReportAction.do">
								...
								<%--
								<ws:hasAuth operationName="/report/toUpdConsumeDetailHistoryAction.do">
									<td width="50">
								...
								<td class="SeparatePage">
									<pages:pager action="../report/listConsumeDetailHistoryAction.do" onsubmit="formChk()"/>
								</td>
							</tr>
						</table>
					</div>
