...
var strFrame2 = "";
document.writeln('<iframe id=meizzDateLayer2 Author=wayx frameborder=0 style="position: absolute; width: 144px; height: 180px; z-index: 9999; display:none"></iframe>');
strFrame2+='<scr' + 'ipt>';
strFrame2+='var datelayerx,datelayery; /*存放日历控件的鼠标位置*/';
strFrame2+='var bDrag; /*标记是否开始拖动*/';
strFrame2+='document.onmousemove=function() /*在鼠标移动事件中，如果开始拖动日历，则移动日历*/';
...
strFrame2+='</scr' + 'ipt>';
strFrame2+='<div style="z-index:9999;position: absolute; left:0; top:0; background-color:#e9f3ff; border:2px solid #448feb;padding:1px height:200px;height:180px; width:144px;text-align:center;font-size:12px;" onselectstart="return false">';
...
strFrame2+='<span id="nowhour" style="margin-top:10px;display:block;"></span>';
strFrame2+='</div>';
strFrame2+='<scr' + 'ipt>';
...
strFrame2+='timestr+="<div style=\'margin-bottom:6px;\'>小时:<select id=hour name=hour>";';
strFrame2+='var d = new Date();';
...
strFrame2+='		}';
strFrame2+='	 }';
strFrame2+='	timestr+="</select></div><div style=\'margin-bottom:6px;\'>分钟:<select id=minute  name=minute class=smallSel>";';
...
strFrame2+='		}';
strFrame2+='	}';
strFrame2+='	timestr+="</select></div><div style=\'margin-bottom:6px;\'>秒钟:<select id=second name=second class=smallSel>";';
strFrame2+='	 for (var i=0; i<60;  i++){';
strFrame2+=' 		i<10?j=0+i.toString():j=i;';
...
strFrame2+='	timestr+="<div style=\'margin:6px;\'><a href=javascript:void(0) onclick=getTime() style=color:#000>确定</a>&nbsp;&nbsp;&nbsp;&nbsp;";';
