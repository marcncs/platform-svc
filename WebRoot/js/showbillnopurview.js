function ToBillByNoPurview(billcode){
		var bc=billcode.substring(0,2);
	 switch(bc){
		case "TT":popWin("../warehouse/takeTicketDetailAction.do?ID="+billcode+"&type=2",900,600); break;
		...
		case "OM":popWin("../warehouse/stockAlterMoveDetailAction.do?ID="+billcode+"&type=2",900,600); break;	
		...
		case "PW":popWin("../aftersale/purchaseWithdrawDetailAction.do?ID="+billcode,900,600);break;
		...
		case "PE":popWin("../warehouse/productIncomeDetailAction.do?ID="+billcode+"&flag=2"+"&type=2",900,600); break;
		...
		case "SM":popWin("../warehouse/stockMoveDetailAction.do?ID="+billcode+"&type=2",900,600); break;
		...
		case "RI":popWin("../warehouse/receiveIncomeDetailAction.do?ID="+billcode+"&type=2",900,600); break;
