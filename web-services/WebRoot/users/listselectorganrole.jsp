  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      <tr>
        ...
        <td width="772">选择拥有机构</td>
      </tr>
    </table>
    <form name="search" method="post" action="../users/listOrganRoleForSelectAction.do">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
	        ...
	        <td class="SeparatePage"><pages:pager action="../users/listOrganRoleForSelectAction.do"/></td>
												
							</tr>
						</table>
						<FORM METHOD="POST" name="listform" ACTION="../users/setOrganRoleAction.do">
