...
function Affirm(){
		...
		if(flag){
			listform.action="consignMachinTransConsignStuffShipmentAction.do";
			listform.submit();
		}else{
			alert("请选择产品并设定好数量!");
		}
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
	  ...
	  <tr>
	    ...
	    <td><input name="pvid" type="hidden" id="pvid" value="${cmf.pid}">
            <input name="providename" type="text" id="providename" value="${cmf.pidname}" size="35" readonly></td>
	    <td align="right">供应商联系人：</td>
	    <td><input name="plinkman" type="text" id="plinkman" value="${cmf.plinkman}"></td>
	  ...
	  <tr>
	      ...
	      <td width="25%"><input name="requiredate" type="text" id="requiredate" onFocus="javascript:selectDate(this)" readonly value="<%=com.winsafe.hbm.util.DateUtil.getCurrentDateString()%>"></td>
	  </tr>
	  <tr>
	    <td  align="right">相关单据：</td>
	    <td><input name="billno" type="text" id="billno" value="${cmf.id}"></td>
	    <td align="right">送货地址：</td>
	    <td colspan="3"><input name="sendaddr" type="text" id="sendaddr" size="40"></td>
	    </tr>
	  </table>
	</fieldset>
