  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">零售单总表</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="peddleOrderTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
        
          <tr class="table-back">
            <td width="8%"  align="right">客户：</td>
            <td width="29%"><input name="CID" type="hidden" id="CID" value="${CID}">
            ...
            <td width="21%"><input name="BeginDate" type="text" id="BeginDate" value="${BeginDate}" onFocus="selectDate(this);"  size="10">
-
...
<c:forEach items="${r.sodls}" var="d">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/report/peddleOrderTotalAction.do"/>	
            </td>
          </tr>
