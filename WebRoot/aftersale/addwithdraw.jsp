...
<body onLoad="CallCenterCustomer()" style="overflow:auto">
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          <td width="10"><img src="../images/CN/spc.gif" width="10" height="1"></td>
          <td width="772"> 新增零售退货</td>
        </tr>
      </table>
       <form name="validateProvide" method="post" action="addWithdrawAction.do">
	...
	<fieldset align="center"> <legend>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
	    <tr>
	      ...
	      <td><input name="cid" type="text" id="cid" onKeyUp="getCustomerByWhere(this.value,1)">
	      <span class="STYLE1">*</span></td>
	      <td align="right">会员名称：</td>
	      <td><input name="cname" type="text" id="cname" onKeyUp="getCustomerByWhere(this.value,2)" readonly><a href="javascript:SelectCustomer();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a><a href="#" onClick="javascript:addNewMember();"></a>
	  ...
	  <tr>
	    ...
	    <td width="20%"><windrp:warehouse name="warehouseid" value=""/></td>
		<td width="13%"  align="right">退货类型：</td>
	    <td width="23%"><windrp:select key="WithdrawSort" name="withdrawsort" p="n|d"/></td>
	    ...
	    <td  colspan="5"><input name="billno" type="text" id="billno" size="60" maxlength="128">
	    ...
	    <td  colspan="5"><input name="withdrawcause" type="text" id="withdrawcause" size="60" maxlength="128"></td>
		</tr>
	  </table>
</fieldset>
