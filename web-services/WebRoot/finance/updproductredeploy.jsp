...
<form name="validateProvide" method="post" action="updProductRedeployAction.do" onSubmit="return  checkform();">
	  ...
	  <tr>
	    ...
	    <td ><select name="RedeployID" id="RedeployID">
            ...
            <logic:iterate id="u" name="als">
              <option value="${u.userid}" ${u.userid==pr.redeployid?"selected":""}>${u.realname}</option>
            </logic:iterate>
        </select></td>
	  	<td width="9%" align="right">调价部门：</td>
          <td width="25%"><select name="RedeployDept" id="RedeployDept">
            <logic:iterate id="d" name="dls">
              <option value="${d.id}" ${d.id==pr.redeploydept?"selected":""}>${d.deptname}</option>
            </logic:iterate>
        </select></td>
	      <td width="8%" align="right">调价描述：</td>
	      <td width="24%"><input name="RedeployMemo" type="text" id="RedeployMemo" value="${pr.redeploymemo}" size="40"></td>
	  </tr>
	  </table>
	</fieldset>
      ...
      <table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
        ...
        <logic:iterate id="p" name="prls" >
          <tr class="table-back">
            ...
            <td ><input name="productname" type="text" value="${p.productidname}" id="productname" size="18" readonly>              </td>
			<td ><input name="specmode" type="text" value="${p.specmode}" id="specmode" size="18" readonly>              </td>
			<td ><input name="countunitname" type="text" value="${p.countunitname}" id="countunitname" size="4" readonly>              </td>
            <td><input name="sandardpurchase" type="text" value="${p.standardpurchase}" id="sandardpurchase" size="12" ></td>
            <td> 
              <input name="standardsale" type="text" value="${p.standardsale}" id="standardsale" size="12" ></td>
            <td>
              <input name="pricei" type="text" value="${p.pricei}" id="pricei" size="12" >             </td>
            <td><input name="priceii" type="text" value="${p.priceii}" id="priceii" size="12" ></td>
            <td><input name="priceiii" type="text" value="${p.priceiii}" id="priceiii" size="12" ></td>
            <td><input name="pricewholesale" type="text" value="${p.pricewholesale}" id="pricewholesale" size="12" ></td>
			<td><input name="priceivs" type="text" value="${p.priceivs}" id="priceivs" size="12" ></td>
			<td><input name="priceuni" type="text" value="${p.priceuni}" id="priceuni" size="12" ></td>
			<td><input name="leastsale" type="text" value="${p.leastsale}" id="leastsale" size="12" ></td>
			<td><input name="cost" type="text" value="${p.cost}" id="cost" size="12" ></td>
          </tr>
