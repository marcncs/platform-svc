...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="../aftersale/selectProductAction.do">
		  ...
		  <tr class="table-back" > 
            ...
            <td><input type="hidden" name="unitid" value="${p.countunit}">
              ...
              ${p.countunitname}</td>
			              ...
			              ${p.discount}%</td>
						              <td><input type="hidden" name="taxrate" value="${p.taxrate}">${p.taxrate}</td>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%"> <presentation:pagination target="/aftersale/selectProductAction.do"/> 
          </td>
        </tr>
      </table>
