  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">修改采购入库单</td>
        </tr>
      </table>
              <form name="validateProvide" method="post" action="../warehouse/updPurchaseIncomeAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="23%"><windrp:warehouse name="warehouseid" value="${pif.warehouseid}"/></td>
          <td width="9%" align="right">供应商：</td>
          <td width="25%"><input name="pid" type="hidden" id="pid" value="${pif.provideid}">
            <input name="providename" type="text" id="providename" size="30" value="${pif.providename}" readonly><a href="#"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a><span class="style1">*</span></td>
	      <td width="9%" align="right">采购订单号：</td>
	      <td width="24%"><input name="poid" type="text" id="poid" maxlength="32" value="${pif.poid}"></td>
	  </tr>
	  <tr>
	    <td  align="right">供应商联系人：</td>
	    <td><input name="plinkman" type="text" id="plinkman" value="${pif.plinkman}" readonly><a href="javascript:SelectLinkman();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a></td>
	    <td align="right">联系电话：</td>
	    <td><input name="tel" type="text" id="tel" value="${pif.tel}" maxlength="26"></td>
	    <td align="right">帐期：</td>
	    <td><input name="prompt" type="text" id="prompt" value="${pif.prompt}" size="10" maxlength="10" onKeyDown="onlyNumber(event)" dataType="Double" msg="帐期只能是数字!" require="false">/天</td>
	    </tr>
	  <tr>
	    <td  align="right">预计入库日期：</td>
	    <td><input name="incomedate" type="text" id="incomedate" onFocus="javascript:selectDate(this)" value="${pif.incomedate}" readonly></td>
	    <td align="right">结算方式：</td>
	    <td><windrp:paymentmode name="paymode" value="${pif.paymode}"/></td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
	    </tr>
	  </table>
            ...
            <td  align="right"><table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
              ...
              <logic:iterate id="p" name="als" >
                <tr class="table-back">
                  ...
                  <td><input name="unitprice" type="text" value="${p.unitprice}" onChange="SubTotal();TotalSum();" onFocus="SubTotal();TotalSum();" id="unitprice" size="10" maxlength="10" onKeyPress="KeyPress(this)" dataType="Double" msg="单价只能是数字!" ></td>
                  <td><input name="quantity" type="text" value="${p.quantity}" onChange="SubTotal();TotalSum();" onFocus="SubTotal();TotalSum();" id="quantity" size="8" maxlength="8" onKeyPress="KeyPress(this)" dataType="Double" msg="数量只能是数字!" ></td>
          ...
          <tr>
            <td  align="center"><table width="100%"  border="0" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td width="94%"><textarea name="remark" cols="180" rows="4" id="remark" dataType="Limit" max="256"  msg="备注必须在256个字之内" require="false">${pif.remark}</textarea><br><span class="td-blankout">(备注长度不能超过256字符)</span></td>
              </tr>
            </table></td>
          </tr>
          <tr>
