  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增配送单</td>
        </tr>
      </table>
      <form name="validateProvide" method="post" action="../equip/addEquipAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
        <tr>
          ...
          <td width="21%"><windrp:select key="ObjectSort" name="objectsort" p="n|f"/></td>
          <td width="13%" align="right"><input name="cid" type="hidden" id="cid">
对象名称：</td>
          <td width="25%"><input name="cname" type="text" id="cname" readonly><a href="javascript:SelectCustomer();"><img src="../images/CN/find.gif" border="0" align="absmiddle"></a><span class="STYLE1">*</span></td>
          <td width="10%"  align="right">联系人：</td>
          <td width="22%"><input name="clinkman" type="text" id="clinkman" readonly><a href="javascript:SelectLinkman();"><img src="../images/CN/find.gif" align="absmiddle" border="0"></a></td>
        </tr>
        <tr>
          <td  align="right">联系电话：</td>
          <td><input name="tel" type="text" id="tel" maxlength="26" dataType="PhoneOrMobile" msg="联系电话格式不正确!" require="false"></td>
        ...
        <tr>
          ...
          <td><input name="transportaddr" type="text" id="transportaddr" size="30" maxlength="200"></td>
