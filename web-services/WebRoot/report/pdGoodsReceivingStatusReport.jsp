...
<html>
	<head>
		...
		function OutPut() {
			excputform.action = "../report/excputPDGoodsReceivingStatusReportAction.do";
			excputform.submit();
		}
	...
	<body>
				...
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post"
							action="pdGoodsReceivingStatusReportAction.do"
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr class="table-back">
									...
									<td>
										<input type="text" name="sapOrderId" value="${sapOrderId}"
											maxlength="30" />
									</td>
								...
								<tr class="table-back">
									...
									<td>
										<input type="radio" name="countByUnit" value=""
											<c:if test="${countByUnit eq '' or countByUnit eq null}">checked</c:if>>
										件
										</input>
										<input type="radio" name="countByUnit" value="true"
											<c:if test="${countByUnit eq 'true'}">checked</c:if>>
										升,千克
										</input>
									</td>
									<td></td>
								...
								<tr class="table-back">
									...
									<td width="25%">
										<windrp:select key="BSort" name="BSort" value="${BSort}"
											p="y|f" />
								</td>
									<td></td>
									<td></td>
							...
							<tbody>
								<tr class="title-func-back">
									<c:if test="${prompt=='view'}">
										<ws:hasAuth
											operationName="/report/excputPDGoodsReceivingStatusReportAction.do">
											<td width="50">
									...
									<td class="SeparatePage">
										<pages:pager
											action="../report/pdGoodsReceivingStatusReportAction.do"
											onsubmit="formChk()" />
									</td>
								</tr>
							</tbody>
							...
							<table class="sortable" width="100%" border="0" cellpadding="0"
								...
								<logic:iterate id="rs" name="rls">
									<tr align="left" class="table-back-colorbar">
										...
										<TD align="center">
											<windrp:dateformat value='${rs.shipmentDate}' p='yyyy-MM-dd' />
										</TD>
										<TD align="center">
											${rs.takequantity}
										</TD>
										<td align="center">
											<windrp:getname key='YesOrNo' value='${rs.isComplete}' p='f' />
										</td>
										</TD>
										<TD align="center">
											<windrp:dateformat value='${rs.receiveDate}' p='yyyy-MM-dd' />
										</TD>
										<TD align="center">
											${rs.receiveQuantity}
										</TD>
		...
		<form name="excputform" method="post"
			action="../report/excputPDGoodsReceivingStatusReportAction.do">
			<input type="hidden" name="inOrganId" id="inOrganId"
				value="${inOrganId}">
			...
			<input type="hidden" name="countByUnit" id="countByUnit"
				value="${countByUnit}">
			<input type="hidden" name="sapOrderId" id="sapOrderId"
				value="${sapOrderId}">
