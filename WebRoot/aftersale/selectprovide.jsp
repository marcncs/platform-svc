  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="table-back" onClick="CheckedObj(this,'${p.pid}','${p.pname}');" onDblClick="Affirm();"> 
            <td >${p.pid}</td>
            <td>${p.pname}</td>
            <td>${p.tel}</td>
          </tr>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%" align="right"> <presentation:pagination target="/aftersale/selectProvideAction.do"/>          </td>
        </tr>
      </table>
