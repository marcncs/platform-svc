  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增报损出库单</td>
        </tr>
      </table>
      <form name="validateProvide" method="post" action="addHarmShipmentBillAction.do">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="25%"><windrp:warehouse name="warehouseid"/></td>
          <td width="9%" align="right">出库部门：</td>
          <td width="23%"><windrp:dept name="shipmentdept"/></td>
	      <td width="9%" align="right">报损日期：</td>
	      <td width="25%"><input name="harmdate" type="text" id="harmdate" onFocus="javascript:selectDate(this);" value="<%=com.winsafe.hbm.util.DateUtil.getCurrentDateString()%>" readonly></td>
	  </tr>	  
	  </table>
	</fieldset>
