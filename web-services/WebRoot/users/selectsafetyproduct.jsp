...
function changeValue(obj){	
	...
	if ( ptable.rows.length <= 2 ){	
			...
			p.unitidname=unitidname[rowx-1].value;
	}	
	if ( obj.checked ){	
		addObjValue(p);
	}else{
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="search" method="post" action="selectSafetyProductAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
	   ...
	   <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<td style="text-align:right"> <pages:pager action="../users/selectSafetyProductAction.do"/> 
		</td>
		</tr>
	</table>
    </div>
	...
	<tr>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1" id="ptable">
          ...
          <tr align="center" class="title-top"> 
             <td width="2%" height="25" class="sorttable_nosort"><input type="checkbox" name="checkall" onClick="Check();" ></td>
            <td width="27%" >产品编号</td>
            <td width="32%">产品名称</td>
            <td width="24%">规格</td>
            <td width="15%">单位</td>
		  ...
		  <tr class="table-back-colorbar" > 
            ...
            <td>${p.productname}</td>
            <td>${p.specmode}</td>			
            <td><input type="hidden" name="unitidname" size="6" value="<windrp:getname key='CountUnit' value='${p.countunit}' p='d'/>">
            <windrp:getname key='CountUnit' value='${p.countunit}' p='d'/>
              <input type="hidden" name="pobj" id="pobj" value="{productid:'${p.id}',productname:'${p.productname}',specmode:'${p.specmode}',unitid:'${p.countunit}',unitidname:'333',cost:'${p.cost}'}">
              </td>
