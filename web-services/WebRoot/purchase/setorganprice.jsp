...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  ...
  <tr> 
    ...
    <td width="772"> 机构零售价格设置</td>
  </tr>
</table>

    <form action="../purchase/setOrganPriceAction.do" method="post" name="validateProduct" onSubmit="return formChk()">
	<fieldset align="center"> <legend>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
        <tr>
          <td width="16%"  align="right"><p>
            <input name="organid" type="hidden" id="organid" value="${oid}">
            产品编号：</p>
            </td>
