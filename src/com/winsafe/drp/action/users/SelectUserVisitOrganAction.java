...
public class SelectUserVisitOrganAction extends BaseAction {
	private static Logger logger = Logger.getLogger(SelectUserVisitOrganAction.class);
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            String Condition = " o.sysid like '"+users.getOrgansysid()+"%' and not exists (select u.id from UserVisit as u where o.id=u.visitorgan and  u.userid="+userid+") "; 
