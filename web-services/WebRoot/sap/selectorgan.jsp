...
var checkid="";
var organ={id:"",oecode:"",organname:"",plantType:""};
function CheckedObj(obj,objid,objoecode,objorganname,objplanttype){
            ...
            <tr align="center" class="title-top-lock">
              ...
              <logic:iterate id="d" name="dpt" >
                <tr align="center" class="table-back-colorbar" onClick="CheckedObj(this,'${d.id}','${d.oecode}','${d.organname}','${d.organModel}');" onDblClick="Affirm();">
                  ...
                  <td><windrp:getname key="PlantType" p="f" value="${d.organModel}"/></td>
                </tr>
              </logic:iterate>
