...
public class WebIndentDetail implements Serializable {
    ...
    /** full constructor */
    public WebIndentDetail(Long id, String woid, String productid, String productname, String specmode, Integer salesort, Long warehouseid, Long unitid, String batch, Double orgunitprice, Double unitprice, Double taxunitprice, Double quantity, Double takequantity, Double discount, Double taxrate, Double cost, Double subsum) {
        this.id = id;
        this.woid = woid;
    ...
    /** default constructor */
    public WebIndentDetail() {
    }

    /** minimal constructor */
    public WebIndentDetail(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof WebIndentDetail) ) return false;
        WebIndentDetail castOther = (WebIndentDetail) other;
