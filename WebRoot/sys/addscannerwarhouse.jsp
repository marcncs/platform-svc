...
<html>
	...
	function CheckInput(){
		...
		var oid = document.getElementById("organid").value.trim();
		var warehouseid = document.getElementById("outwarehouseid").value.trim();
		if(scannerid == null || scannerid == "" || oid == null || oid == "" || warehouseid == null || warehouseid == "" ){
			alert("机构名称、仓库名、采集器编号都不能为空！！！");
			return false;
		}
		return true;
	}
...
function click() {if (event.button==2) {alert("<bean:message key='sys.nouserightkey'/>");}}document.onmousedown=click
			...
			<tr>
				<td>
					...
					<form name="referform" method="post"
						action="../sys/addScannerWarhouseAction.do"
								...
								<tr>
									...
									<td width="20%">
										...
										<input type="text" name="owname" id="owname"
											onClick="selectW(this,'w');" value="" readonly>
	    ...
	    --%>
									<c:if test="${type=='ADD'}">
										...
										<td width="23%">
											<input type="hidden" name="scannerid" id="scannerid" value='${scannerid}'/>
									...
									<c:if test="${type=='EDIT'}">
										...
										<td width="23%">
											<input name="scannerid" type="text" id="scannerid"
												maxlength="128" value="<windrp:getname key="scanner" value='${sw.scannerid}' p='d' />" readonly>
											<a href="javascript:SelectScanner();"> <img
													src="../images/CN/find.gif" width="17" height="18"
													border="0" align="absmiddle"> </a>
											<span class="text-red3">*</span>
