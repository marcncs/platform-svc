...
this.onload =function onLoadDivHeight(){
	...
	function excput(){
		...
		search.action="../warehouse/excPutStockWasteBookTotalAction.do";
		search.submit();
		search.action="../warehouse/listStockWasteBookTotalAction.do";
	}
	function print(){
		excputform.target="_blank";
  ...
  <input id="EndDate" onFocus="javascript:selectDate(this)" size="12" value="${EndDate}" name="EndDate" readonly></td>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<%--<td width="50"><a href="javascript:print();"><img src="../images/CN/print.gif" width="16" height="16"border="0" align="absmiddle">&nbsp;打印</a></td>
			<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>			
		  --%><td class="SeparatePage"><pages:pager action="../warehouse/listStockWasteBookTotalAction.do"/></td>							
		</tr>
	   </table>
      </div>
	</td>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1">
          <tr align="center" class="title-top-lock">
            ...
            <td >批次</td>
			 ...
			 <td>单位</td>
            <td width="6%" >入库数量</td>
            <%--<td width="6%" >入库数量(EA)</td>--%>
            <td width="6%" >出库数量</td>
			<%--<td width="6%" >出库数量(EA)</td>--%>
		  </tr>
...
<%--			<windrp:getname key="CountUnit" value="${s.countunit}" p="d"/>--%>
            ...
            <td ><windrp:format value='${s.prepareout}'/></td>
              <%--<td ><windrp:format value='${s.scatterNum}'/></td>--%>
            <td ><windrp:format value='${s.stockpile}'/></td>
			 <%--<td ><windrp:format value='${s.squantity}'/></td>--%>
		    </tr>
		    <c:set var="incount" value="${incount+s.prepareout}"/>
		    <%--<c:set var="incountS" value="${incountS+s.scatterNum}"/>--%>
			<c:set var="outcount" value="${outcount+s.stockpile}"/>
			<%--<c:set var="outcountS" value="${outcountS+s.squantity}"/>--%>
			</logic:iterate>           
      </table>
      <table width="100%" cellspacing="1"  class="totalsumTable">
        <tr class="back-gray-light">
          ...
          <%--<td width="6%"><windrp:format value='${incountS}'/></td>--%>
