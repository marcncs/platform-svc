...
function Del(){
	...
	if(flag){
		if(window.confirm("您确认要删除所选的记录吗？如果删除将永远不能恢复!")){
			showloading();			
			popWin4("../warehouse/delSupplySaleMoveIdcodeAction.do?ids="+rids,500,250, "del");
		}
	}else{
		alert("请选择你要操作的记录!");
	}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    <td>
	<div id="bodydiv">
	<form name="search" method="post" action="../warehouse/listSupplySaleMoveIdcode.do">
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr class="title-func-back">
		 <!-- <td width="50" >
		  ...
		  <td class="SeparatePage"><pages:pager action="../warehouse/listSupplySaleMoveIdcode.do"/></td>						
		</tr>
	</table>	
	 </div>
	</td>
