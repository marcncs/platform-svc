...
function print(){
	...
	excputform.action="../report/printStockMoveDetailAction.do";
	excputform.submit();
	excputform.target="";
	excputform.action="../report/excPutStockMoveDetailAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>渠道>>转仓明细</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="stockMoveDetailAction.do">
  ...
  <input name="EndDate" type="text" id="EndDate" value="${EndDate}"  onFocus="selectDate(this);"  size="10"></td>
   <td class="SeparatePage"></td>
          ...
          <tr class="table-back">
            ...
            <td><input name="InOrganID" type="hidden" id="InOrganID" value="${InOrganID}">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr class="title-func-back"> 
			...
			<pages:pager action="../report/stockMoveDetailAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
...
<%--          <td align="right"><windrp:format p="###,##0.00" value="${p.quantity}" /></td>--%>
	...
	<table width="100%" cellspacing="1" class="totalsumTable">
		...
		<tr  align="center" class="back-gray-light">
          ...
          <td width="77%"  align="right"><windrp:format p="###,##0" value='${alltoalboxnum}' />  &nbsp;&nbsp; 箱   &nbsp;&nbsp;&nbsp;&nbsp;<windrp:format p="###,##0" value='${alltotalscatternum}' />  &nbsp;&nbsp; 散&nbsp;&nbsp;  </td>
        </tr>
      </table>
...
<form  name="excputform" method="post" action="excPutStockMoveDetailAction.do">
