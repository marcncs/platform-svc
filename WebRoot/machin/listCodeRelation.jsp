...
<html>
	...
	function Detail(proDate, batchNo, primaryCode, cartonCode, covertCode,
			productionLine, printDate) {
		//if(checkid!=""){
		if (covertCode == "#ERR") {
			covertCode = "";
		}
		document.all.submsg.src = "../machin/detailUploadProduceReportAction.do?ID="
				+ checkid
				+ "&proDate="
				+ proDate
				+ "&batchNo="
				...
				+ covertCode
				+ "&productionLine="
				+ productionLine + "&printDate=" + printDate;
		//}else{
		//	alert("请选择你要操作的记录!");
		//}
	}
				...
				<td>
					<div id="div1">
						...
						<form name="search" method="post"
							action="../machin/listCodeRelationAction.do">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr class="table-back">
									...
									<td width="25%">
										<input name="cartonCode" type="text" id="cartonCode"
											value="${cartonCode}">
									</td>
									<td width="10%" align="right">
										小包装码：
									...
									<td>
										<input name="covertCode" type="text" id="covertCode"
											value="${covertCode}">
									</td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								...
								<c:if test="${list != null}">
									<td class="SeparatePage">
										<pages:pager action="../machin/listCodeRelationAction.do" />
									</td>
								</c:if>
							</tr>
						</table>
