...
<html>
	...
	<body>
		<form name="refer" method="post" enctype="multipart/form-data"
			action="../warehouse/importTtidForIdcodeAction.do"
			...
			<fieldset style="text-align: center;">
					...
					<tr>
						...
						<td>
							...
							<input type="text" name="owname" id="owname" onClick="selectW(this,'rw')"
								value="${wname}" readonly dataType="Require" msg="必须选择导入仓库!">
							<span class="STYLE1">*</span>
						</td>
					</tr>
				</table>
				<table class="table-detail">
					<tr>
						...
						<td width="23%">
							<a href="../common/downloadfile.jsp?filename=/templates/<windrp:encode key='已复核单据条码导入模板.xls' />"
								title="模板下载">模板下载</a>
						</td>
					</tr>
				</table>
