...
function excput(){
	...
	searchform.action="../report/excPutWithdrawBillTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/withdrawBillTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printWithdrawBillTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/withdrawBillTotalAction.do";
}
...
<body>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>零售>>零售退货按单据汇总</td>
        </tr>
      </table>
