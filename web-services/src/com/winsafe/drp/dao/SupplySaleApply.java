...
public class SupplySaleApply implements Serializable {
	...
	/** full constructor */
	public SupplySaleApply(String id, Date movedate, String outorganid,
			Double totalsum, Integer paymentmode, Integer invmsg,
			Integer transportmode, String inorganid, String inwarehouseid,
			String transportaddr, String tickettitle, String movecause,
			String remark, Integer isaudit, Integer auditid, Date auditdate,
			Integer isratify, Integer ratifyid, Date ratifydate,
			String makeorganid, String makeorganidname, Integer makedeptid,
			Integer makeid, Date makedate, Integer isblankout,
			Integer blankoutid, Date blankoutdate, String blankoutreason,
			Integer printtimes, Integer istrans, String keyscontent) {
		this.id = id;
	...
	/** default constructor */
	public SupplySaleApply() {
	}

	/** minimal constructor */
	public SupplySaleApply(String id) {
		this.id = id;
	}
	...
	public boolean equals(Object other) {
		if (!(other instanceof SupplySaleApply))
			return false;
		SupplySaleApply castOther = (SupplySaleApply) other;
