...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  ...
  <tr> 
    ...
    <td width="772"> 经销商产品价格设置</td>
  </tr>
</table>

    <form action="../purchase/setProductPriceiiAction.do" method="post" name="validateProduct" onSubmit="return formChk()">
        ...
        <tr>
          ...
          <table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
            ...
            <tr align="center" class="table-back">
              ...
              <td align="left"><input name="frate" type="text" value="<windrp:format value='${d.frate}' n='2'/>" size="4" maxlength="4" onKeyPress="KeyPress(this)" dataType="Double" msg="返利比例只能是数字!">
                %</td>
            </tr>
			</c:forEach> 
			</logic:iterate> 
