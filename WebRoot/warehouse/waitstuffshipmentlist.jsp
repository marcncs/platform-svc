...
<script language="JavaScript">
	...
	function Complete(){
		if(checkid!=""){
			window.open("../warehouse/completeStuffShipmentBillAction.do?SSID="+checkid,"newwindow","height=8.5cm,width=16cm,top=250,left=250,toolbar=no,menubar=no,scrollbars=auto,resizable=no,location=no,status=no");
		}else{
			alert("请选择你要操作的记录!");
		}
	}
...
<table width="100%" border="1" cellpadding="0" cellspacing="2" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="waitConsignStuffShipmentBillAction.do">
  ...
  <input name="EndDate" type="text" id="EndDate" size="10" onFocus="javascript:selectDate(this)"></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="title-top"> 
            <td width="62" >编号</td>
            <td width="263">发货仓库 </td>
            <td width="188">出库类别</td>
            <td width="136">出库部门</td>
            <td width="254">需求日期</td>
            <td width="108">是否发货 </td>
          </tr>
          <logic:iterate id="s" name="alsb" > 
          <tr align="center" class="table-back" onClick="CheckedObj(this,'${s.id}');"> 
            <td  ><a href="../warehouse/stuffShipmentBillDetailAction.do?ID=${s.id}">${s.id}</a></td>
...
<tr align="center">
  <td width="82"><a href="javascript:Complete();">确认发货</a></td>
          ...
          <td width="52%" align="right"> <presentation:pagination target="/warehouse/waitConsignStuffShipmentBillAction.do"/>          </td>
        </tr>
      </table>      </td>
  </tr>
</table>
