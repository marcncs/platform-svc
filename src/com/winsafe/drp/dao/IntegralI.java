...
public class IntegralI implements Serializable {
    ...
    /** full constructor */
    public IntegralI(Integer id, Integer osort, String oname, String omobile, String billno, Integer isort, Double rincome, Double aincome, Date makedate, String equiporganid, String organid) {
        this.id = id;
        this.osort = osort;
        this.oname = oname;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof IntegralI) ) return false;
        IntegralI castOther = (IntegralI) other;
