...
this.onload =function onLoadDivHeight(){
	...
	function excput(){
		...
		search.action="../warehouse/excPutAgeingTotalReportAction.do";
		search.submit();
		search.action="../warehouse/listStockPileAgeingTotalReportAction.do";
	}
	function print(){
		excputform.target="_blank";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
	...
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="listStockPileAgeingTotalReportAction.do" >
...
-
  <input id="EndDate" onFocus="javascript:selectDate(this)" size="12" value="${EndDate}" name="EndDate" readonly></td>--%>
         ...
         <tr class="table-back">
          <td align="right">选择库龄范围：</td>
  		     <td>
  		     	<select name="ageing">
  		     		<option value="">请选择</option>
					<logic:iterate id="ss" name="spas">
						<option value="${ss.tagColor }" ${color==ss.tagColor?"selected":""}>${ss.tagMinValue }-${ss.tagMaxValue }</option>
					</logic:iterate>   
  		     	</select>
  		     </td>
            <td   align="right">产品类别：</td>
            ...
            <input name="isShowbatch" type="checkbox"  value="1"  <c:if test="${isShowbatch!=null}">checked="checked"</c:if> > 
  		     ...
  		     <td class="SeparatePage" colspan="2"><input name="Submit" type="image" id="Submit" 
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<%--<td width="50"><a href="javascript:print();"><img src="../images/CN/print.gif" width="16" height="16"border="0" align="absmiddle">&nbsp;打印</a></td>
			<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>			
		  --%><td class="SeparatePage"><pages:pager action="../warehouse/listStockPileAgeingTotalReportAction.do"/></td>							
		</tr>
	   </table>
      </div>
	</td>
	...
	<tr>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1">
		  ...
		  <c:set var="incountS" value="0"/>
		  <c:set var="outcount" value="0"/>
		  <c:set var="outcountS" value="0"/>
          <logic:iterate id="s" name="als" > 
          <tr class="table-back-colorbar"  onclick="CheckedObj(this);" style="color: ${s.tagColor }">
