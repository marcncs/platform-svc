...
<script language="javascript">
	...
	if(checkid!=""){
		...
		var p={id:checkid,productname:checkname};
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="table-back" onClick="CheckedObj(this,'${p.id}','${p.productname}');" onDblClick="Affirm();"> 
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%"> <presentation:pagination target="/purchase/selectSingleProductAction.do"/> 
          </td>
        </tr>
      </table>
