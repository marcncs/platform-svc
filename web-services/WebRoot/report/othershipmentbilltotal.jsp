...
function excput(){
	...
	searchform.action="../report/excPutOtherShipmentBillTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/otherShipmentBillTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printOtherShipmentBillTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/otherShipmentBillTotalAction.do";
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="searchform" method="post" action="otherShipmentBillTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            ...
            <td><input name="ProductID" type="hidden" id="ProductID" value="${ProductID}">
              <input id="ProductName" name="ProductName" value="${ProductName}" readonly><a href="javascript:SelectSingleProduct();"><img src="../images/CN/find.gif" align="absmiddle" width="18" height="18" border="0"></a>              </td>
              <td></td>
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/otherShipmentBillTotalAction.do"/></td>
          </tr>
      </table>
      </div>
...
<c:forEach items="${str}" var="d">
        ...
        <tr class="back-gray-light">
          <td  align="right" width="19%">本页合计：</td>
...
<form  name="excputform" method="post" action="excPutOtherShipmentBillTotalAction.do" >
