...
function DlrMediaJsSDK() {
	...
	function ajax(url, type, async, params) {
		...
		jQuery.ajax({url: url, type: type, dataType: "json", async: async, data: params, 
			...
			error: function(XMLHttpRequest, textStatus, errorThrown) {
				...
				if (result) {
					throw {status: XMLHttpRequest.status, number: result.code, message: result.msg};
				}
			}
		});
	...
	this.getImageGroups = function() {
		var url = this.baseUrl + "dlr_admin/media/images/groups";
	...
	this.getImageGroup = function(groupId) {
		var url = this.baseUrl + "dlr_admin/media/images/groups/" + groupId;
		var data = ajax(url, "GET", false);
	...
	this.getImage = function(id) {
		var url = this.baseUrl + "dlr_admin/media/images/" + id;
		var data = ajax(url, "GET", false);
	...
	this.getImagesByPage = function(pageContainerClassName, callback, groupId) {
		var url = this.baseUrl + "dlr_admin/media/images/query";
	...
	this.addImage = function(title, url, fsize, groupId) {
		...
		var url = this.baseUrl + "dlr_admin/media/images";
	...
	this.deleteImages = function(ids) {
		var url = this.baseUrl + "dlr_admin/media/images?ids=" + ids;
		var data = ajax(url, "DELETE", false);
	...
	this.getVideo = function(id) {
		var url = this.baseUrl + "dlr_admin/media/videos/" + id;
		var data = ajax(url, "GET", false);
	...
	this.getVideosByPage = function(pageContainerClassName, callback, pageSize) {
		var url = this.baseUrl + "dlr_admin/media/videos/query";
	...
	this.addVideo = function(title, url, digest, fsize) {
		var reqUrl = this.baseUrl + "dlr_admin/media/videos";
	...
	this.updateVideo = function(id, title, digest) {
		var reqUrl = this.baseUrl + "dlr_admin/media/videos/" + id;
	...
	this.getVideoNumber = function() {
		var url = this.baseUrl + "dlr_admin/media/videos/number";
		var data = ajax(url, "GET", false);
...
var dlrMedia = new DlrMediaJsSDK();
