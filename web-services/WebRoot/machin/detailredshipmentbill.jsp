...
<html>
	...
	function Audit(osid) {
		//showloading();
		popWin2("../machin/auditRedShipmentBillAction.do?ID=" + osid);
	}

	function CancelAudit(osid) {
		showloading();
		popWin2("../machin/cancelAuditRedShipmentBillAction.do?ID=" + osid);
	}
							...
							<td width="266" align="right">
								<table width="120" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<ws:hasAuth operationName="/machin/auditRedShipmentBillAction.do">
											<td width="60" align="center">
												<c:choose>
