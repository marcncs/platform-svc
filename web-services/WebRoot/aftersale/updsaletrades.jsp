...
function showCustomer(originalRequest){
	...
	function setDefaultValue(cid, cname, decideman, mobile, officetel){
		...
		document.validateProvide.clinkman.value=decideman;
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 修改零售换货</td>
        </tr>
      </table>
      <form name="validateProvide" method="post" action="../aftersale/updSaleTradesAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <td width="9%"  align="right">会员编号：</td>
          <td width="21%"><input name="cid" type="text" id="cid" onKeyUp="getCustomerByWhere(this.value,1)" value="${sof.cid }" maxlength="32"><span class="STYLE1">*</span></td>
	  	<td width="9%"  align="right">
	  	  会员名称：</td>
          <td width="21%"><input name="cname" type="text" id="cname" value="${sof.cname}" readonly><a href="javascript:SelectCustomer();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a><span class="STYLE1">*</span></td>
          <td width="13%" align="right">联系人：</td>
          <td width="23%"><input name="clinkman" type="text" id="decideman" value="${sof.clinkman}" readonly><a href="javascript:SelectLinkman();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a></td>
          
	  </tr>
	    <tr>	
	    <td align="right">会员手机：</td>
	    <td><input name="cmobile" type="text" id="cmobile" onKeyUp="getCustomerByWhere(this.value,3)" maxlength="11" value="${sof.cmobile }"></td> 
	    <td width="10%" align="right">联系电话：</td>
	      <td width="24%"><input name="tel" type="text" id="tel" value="${sof.tel}" maxlength="26"></td>   
	    <td align="right">换货类型：</td>
	    <td><windrp:select key="TradesSort" name="tradessort" value="${sof.tradessort}" p="n|f"/></td>
	    </tr>
	  <tr>	    
	    <td align="right">入货仓库：</td>
	    <td><windrp:warehouse name="warehouseinid" value="${sof.warehouseinid}"/></td>
	    <td  align="right">出货仓库：</td>
	    <td><windrp:warehouse name="warehouseid" value="${sof.warehouseid}"/></td>
	    ...
	    <td><input name="tradesdate" type="text" id="tradesdate" readonly onFocus="javascript:selectDate(this)" value="${sof.tradesdate}">
          ...
          <tr>
            ...
            <tr class="table-back">
                ...
                <td><input name="productid" type="text" id="productid" value="${p.productid}" size="16"></td>
                ...
                <td><input name="quantity" type="text" value="${p.quantity}" id="quantity" size="8" maxlength="8" onKeyPress="KeyPress(this)" dataType="Double" msg="数量只能是数字!" require="false"></td>
