...
function SupperSelect(rowx){
	...
	showModalDialog("toSelectProviderProductAction.do",null,"dialogWidth:20cm;dialogHeight:17cm;center:yes;status:no;scrolling:no;");
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增到货通知</td>
        </tr>
      </table>
       <form name="referForm" method="post" action="addAdsumGoodsAction.do"  onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="25%"><input name="plinkman" type="text" id="plinkman">
	      ...
	      <td width="21%"><input name="obtaincode" type="text" id="obtaincode"></td>
	  </tr>
	  <tr>
	    <td  align="right">收货日期 ：</td>
	    <td><input name="receivedate" type="text" id="receivedate" onFocus="selectDate(this);" value="<%=com.winsafe.hbm.util.DateUtil.getCurrentDateString()%>"></td>
