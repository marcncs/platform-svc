...
this.onload =function onLoadDivHeight(){
	...
	function excput(){
		...
		search.action="../warehouse/excPutInventoryReportAction.do";
		search.submit();
		search.action="../warehouse/listInventoryReportAction.do";
	}
	function print(){
		excputform.target="_blank";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
	...
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="listInventoryReportAction.do" >
...
-
  <input id="EndDate" onFocus="javascript:selectDate(this)" size="12" value="${EndDate}" name="EndDate" readonly></td> --%>
  		<td  align="right">日期：</td>
  		 <td ><input id="RecordDate" value="${RecordDate}" onFocus="javascript:selectDate(this)" size="12" name="RecordDate" readonly>
        </tr>
         <tr class="table-back">
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<%--<td width="50"><a href="javascript:print();"><img src="../images/CN/print.gif" width="16" height="16"border="0" align="absmiddle">&nbsp;打印</a></td>
			<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>			
		  --%><td class="SeparatePage"><pages:pager action="../warehouse/listInventoryReportAction.do"/></td>							
		</tr>
	   </table>
      </div>
	</td>
