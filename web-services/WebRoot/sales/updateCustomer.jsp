...
function addtr(tableid){	 	
	 ...
	 TD1.innerHTML = "<fieldset align='center'><table width='100%'  border='0' cellpadding='0' cellspacing='1'><tr><input name='linkid' type='hidden' value=''><td width='10%' align='right'>联系人姓名：</td><td width='21%'><input name='name' type='text' ></td><td width='10%' align='right'>性别：</td><td width='23%'><select name='sex'><option value='1'>女</option><option value='2'>男</option></select></td><td align='right'>身份证号码：</td><td><input name='idcard' type='text' ></td></tr><tr><td align='right'>生日：</td><td><input type='text' name='birthday' onFocus='javascript:selectDate(this)'></td><td align='right'>部门：</td><td><input name='department' type='text'></td><td align='right'>职务：</td><td><input type='text' name='duty' ></td></tr><tr><td align='right'>是否主联系人：</td><td><select name='ismain'><option value='0'>否</option><option value='1'>是</option></select></td><td width='9%' height='20' align='right'>办公电话：</td><td width='27%'><input name='linkofficetel' type='text' ></td><td width='10%' align='right'>手机：</td><td width='21%'><input type='text' name='linkmobile' ></td></tr><tr><td width='10%' align='right'>家庭电话：</td><td width='23%'><input name='hometel' type='text'></td><td height='20' align='right'>Emai：</td><td><input type='text' name='linkemail' ></td><td align='right'>QQ：</td><td><input name='qq' type='text' id='qq' ></td></tr><tr><td align='right'>MSN：</td><td><input type='text' name='msn'></td><td height='20' align='right'>地址：</td><td><input type='text' name='addr' size='40'></td><td align='right'>货运部：</td><td><select name='transit'><option value='0'>EMS</option><option value='1'>UPS</option></select></td></tr></table></fieldset>";
	 	...
	 	TD1.innerHTML = "<fieldset align='center'><table width='100%'  border='0' cellpadding='0' cellspacing='1'><tr><input name='bankid' type='hidden' value=''><td width='10%' align='right'>开户银行：</td><td width='21%'><input name='bankname' type='text' ></td><td width='10%' align='right'>户名：</td><td width='23%'><input name='doorname' type='text' ></td><td align='right'>账号：</td><td><input name='bankaccount' type='text' ></td></tr></table>";
	 }
}
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      <tr>
        ...
        <td width="772"> 修改客户资料</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td>
	<form name="validateCustomer" method="post" action="updCustomerAction.do" enctype="multipart/form-data" onSubmit="return formChk();">
		...
		<fieldset align="center"> 		
			 <table width="100%"  border="0" cellpadding="0" cellspacing="1">
				<tr >
				  ...
				  <td width="27%" ><input name="cid" type="hidden" value="${c.cid}"><input name="cname" type="text" value="${c.cname}"><span class="STYLE1"> *</span></td>
				  <td width="10%" align="right">性质：</td>
				  <td width="20%">${c.kindname}</td>
				  <td width="34%" rowspan="8" align="right"><table width="100%" border="0" cellpadding="0" cellspacing="1">
					  <tr>
						<td height="150" align="center"><div id="preview"><img src="../${c.cphoto}" width="150" style="border:6px double #ccc"></div></td>
					  </tr>
					  <tr>
						<td><table width="100%"  border="0" cellpadding="0" cellspacing="1">
							<tr>
							  <td width="29%" align="right"><input type="hidden" name="cphoto" value="${c.cphoto}">客户照片：</td>
				...
				<tr >
				  ...
				  <td ><input name="prompt" type="text" value="${c.prompt}" ></td>
				  <td  align="right">信用额度：</td>
				  <td ><input name="creditlock" type="text" value="${c.creditlock}"></td>
				  </tr>	
				<tr >
				  ...
				  <td >
				  	<select name="sort">
						<c:forEach var="sort" items="${sortlist}">
				  			<option value="${sort.id}" ${c.sort==sort.id?"selected":""}>${sort.sortname}</option>
						</c:forEach>
				  	</select>				  </td>
				...
				<tr >
				  ...
				  <td ><input name="discount" type="text" value="${c.discount}">
				  %</td>
				  <td  align="right">税率：</td>
				  <td ><input name="taxrate" type="text" value="${c.taxrate}">
				  %</td>
				  </tr>	
				<tr >
				...
				<tr >
				  ...
				  <td ><input name="ditchid" type="hidden" id="ditchid" value="${c.ditchid}">
					<input name="ditchidname" type="text" id="ditchidname" value="${c.ditchidname}">
				...
				<tr >
				  ...
				  <td ><input name="signdate" type="text" id="signdate" onFocus="javascript:selectDate(this)" value="${c.signdate}"></td>
				  <td  align="right">邮编：</td>
				  <td ><input name="postcode" type="text" id="postcode" maxlength="6" value="${c.postcode}"></td>
				</tr>
				<tr >
				  ...
				  <td ><select name="province"  id="province" onChange="getResult('province','city');">
					<option value="">-省份-</option>
					 <logic:iterate id="p" name="cals">
					  <option value="${p.id}" <c:if test="${p.id==c.province}">
				...
				<tr >
				  ...
				  <td ><select name="areas" id="areas" >
					<option value="${c.areas}" >${c.areasname}</option>
				  </select><span class="STYLE1"> *</span></td>
				  <td  align="right">经管部门：</td>
				  <td ><select name="specializedept">
                    <logic:iterate id="w" name="aldept">
                      <option value="${w.id}" ${w.id==c.specializedept?"selected":""}>${w.deptname}</option>
                    </logic:iterate>
                  </select></td>
				</tr>
				<tr >
				  ...
				  <td ><select name="specializeid">
                    <logic:iterate id="w" name="als">
                      <option value="${w.userid}" ${w.userid==c.specializeid?"selected":""}>${w.realname}</option>
                    </logic:iterate>
                  </select></td>
				  <td  align="right">付款方式：</td>
				  <td >${c.paymentmodename}</td>
				</tr>
				<tr >
				  <td  align="right">发运方式：</td>
				  <td >${c.transportmodename}</td>
				  <td  align="right">税号：</td>
				  <td ><input name="taxcode" type="text" id="taxcode" value="${c.taxcode}" ></td>
				</tr>
				<tr >
				  <td  align="right">帐号：</td>
				  <td ><input name="accnumber" type="text" id="accnumber" value="${c.accnumber}"></td>
				  <td  align="right">&nbsp;</td>
				  <td >&nbsp;</td>
				</tr>
				<tr >
				  <td  align="right">详细地址：</td>
				  <td  colspan="3"><input name="detailaddr" type="text" id="detailaddr" size="80" value="${c.detailaddr}"></td>
				  </tr>
			  </table>
			  ...
			  <tr>
				<td width="9%"  align="right">办公电话：</td>
				  <td width="26%"><input name="officetel" type="text" id="officetel" maxlength="26" value="${c.officetel}"></td>
				  <td width="9%" align="right">手机：</td>
				  <td width="22%"><input name="mobile" type="text" id="mobile" maxlength="26" value="${c.mobile}"></td>
				  <td width="9%" align="right">传真：</td>
				  <td width="25%"><input name="fax" type="text" id="fax" maxlength="26" value="${c.fax}"></td>
			  </tr>
			  <tr>
				<td  align="right">网址：</td>
				<td><input name="homepage" type="text" id="homepage" size="40" value="${c.homepage}"></td>
				<td align="right">邮箱：</td>
				<td><input name="email" type="text" id="email" maxlength="64" value="${c.email}"></td>
				<td align="right">备注：</td>
				<td><input name="remark" type="text" size="30" value="${c.remark}"></td>
				</tr>
			  </table>	
		</fieldset>	  
						...
						<fieldset align="center"> 	
						 <table width="100%"  border="0" cellpadding="0" cellspacing="1">
						  <tr>	<input name="linkid" type="hidden" value="${lm.id}">			
							  <td width="10%" align="right">联系人姓名：</td>
							  <td width="21%"><input name="name" type="text" value="${lm.name}"><span class="STYLE1"> *</span></td>
							  <td width="10%" align="right">性别：</td>
							  <td width="23%">${lm.sexname}</td>
							  <td align="right">身份证号码：</td>
							  <td><input name="idcard" type="text" value="${lm.idcard}"></td>
						  </tr>
						  <tr>						
							<td align="right">生日：</td>
							<td><input type="text" name="birthday" onFocus="javascript:selectDate(this)" value="${lm.strbirthday}"></td>
							<td align="right">部门：</td>
							<td><input name="department" type="text" value="${lm.department}"></td>
							<td align="right">职务：</td>
							<td><input type="text" name="duty" value="${lm.duty}"></td>
							</tr>
						  <tr>						
							<td align="right">是否主联系人：</td>
							<td>${lm.ismainname}</td>
							<td width="9%"  align="right">办公电话：</td>
							  <td width="27%"><input name="linkofficetel" type="text" value="${lm.officetel}"><span class="STYLE1"> *</span></td>
							  <td width="10%" align="right">手机：</td>
							  <td width="21%"><input type="text" name="linkmobile" value="${lm.mobile}"><span class="STYLE1"> *</span></td>
							</tr>			 
							  <tr>
								
								  <td width="10%" align="right">家庭电话：</td>
								  <td width="23%"><input name="hometel" type="text" value="${lm.hometel}"></td>
								  <td  align="right">Emai：</td>
								<td><input type="text" name="linkemail" value="${lm.email}"></td>
								<td align="right">QQ：</td>
								<td><input name="qq" type="text" id="qq" value="${lm.qq}"></td>
							  </tr>
							  <tr>								
								<td align="right">MSN：</td>
								<td><input type="text" name="msn" value="${lm.msn}"></td>
								<td  align="right">地址：</td>
								<td><input type="text" name="addr" value="${lm.addr}" size="40"><span class="STYLE1"> *</span></td>
								<td align="right">货运部：</td>
								<td>${lm.transitname}</td>
								</tr>				
							  </table>
						</fieldset> 
					</c:forEach>
		...
		<td colspan="4">
			...
			<table width="100%"  border="0" cellpadding="0" cellspacing="1" id="banktable">
				...
				<c:if test="${banklist==null}">
						<fieldset align="center"> 	
						 <table width="100%"  border="0" cellpadding="0" cellspacing="1">
						  <tr>	<input name="bankid" type="hidden" value="">			
				...
				<c:if test="${banklist!=null}">
					<c:forEach var="bank" items="${banklist}">
						<fieldset align="center"> 	
						 <table width="100%"  border="0" cellpadding="0" cellspacing="1">
						  <tr>		<input name="bankid" type="hidden" value="${bank.id}">		
							  <td width="10%" align="right">开户银行：</td>
							  <td width="21%"><input name="bankname" type="text" value="${bank.bankname}"></td>
							  <td width="10%" align="right">户名：</td>
							  <td width="23%"><input name="doorname" type="text" value="${bank.doorname}"></td>
							  <td align="right">账号：</td>
							  <td><input name="bankaccount" type="text" value="${bank.bankaccount}"></td>
						  </tr>
						 </table>
						</fieldset>
					</c:forEach>
