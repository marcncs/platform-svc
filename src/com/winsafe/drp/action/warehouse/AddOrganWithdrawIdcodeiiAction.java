...
public class AddOrganWithdrawIdcodeiiAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		super.initdata(request);try{
			...
			OrganWithdrawIdcode oldpii=app.getOrganWithdrawIdcodeByidcode(productid, billid, idcode);
			if ( oldpii != null ){
			...
			OrganWithdrawIdcode pi = new OrganWithdrawIdcode();
