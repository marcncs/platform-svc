...
public class RegionTreeTagHandle extends TagSupport {
	private static final long serialVersionUID = 1L;
	protected Logger logger=Logger.getLogger(RegionTreeTagHandle.class);
	private String id;
	private String name;
	...
	protected void outPagination()throws JspException{
		...
		try{
			...
			.append("<script>")
			.append("var regiontree = new WebFXLoadTree(\"\",\"../regionAction.do?id=1\",\"javascript:show('1')\");")
