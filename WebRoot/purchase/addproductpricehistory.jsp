...
function formChk(){
 ...
 //选择产品
	function SelectSingleProduct(){
		...
		document.validateProduct.countunit.value = p.unitid;
	}
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      <tr>
        ...
        <td width="772"> 系统设置>>新增产品价格</td>
      </tr>
    </table>
        <form action="addProductPriceHistoryAction.do" method="post"  name="validateProduct" onSubmit="return formChk();">
         ...
         <fieldset align="center">  <legend> 
           ...
           <input id="ProductName" size="27" name="productName" dataType="Require" msg="产品不能为空!" value="${ProductName}" readonly><a href="javascript:SelectSingleProduct();"><img src="../images/CN/find.gif" align="absmiddle"  border="0"></a>
			<span class="style1">*</span></td>
             <td align="right">最小计量单位：</td>
			   <td><windrp:select key="CountUnit" name="countunit" p="n|d"/></td>
              <td width="12%" align="right">产品价格：</td>
              <td width="23%">
			   <input name="productprice" type="text" id="productprice" size="30" maxlength="128">
              <span class="style1">* </span></td>
            </tr>
			 <tr>
			   <td height="20" align="right">日期：</td>
			   <td width="23%"><input name="starttime" type="text" id="starttime"  size="10" onFocus="javascript:selectDate(this)" readonly> - <input name="endtime" type="text" id="endtime" size="10" onFocus="javascript:selectDate(this)" readonly>
		     	 <span class="style1">* </span></td>
		      </tr>
			  </table>
		  </fieldset>
            ...
            <tr>
             ...
             <td><textarea name="memo" cols="120" rows="10"  id="memo" dataType="Limit" max="512"  msg="备注必须在512个字之内" require="false"></textarea><br><span class="td-blankout">(备注长度不能超过512字符)</span></td>
             </tr>
          </table>
		  </fieldset>
