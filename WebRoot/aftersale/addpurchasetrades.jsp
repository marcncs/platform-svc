...
<html>
	<head>
		...
		function showLman(originalRequest){
			...
			var lk = data.linkman;
			if ( lk != undefined ){			
				document.referForm.clinkman.value=lk.name;
			...
			<tr>
				<td>
					...
					<form name="referForm" method="post"
							action="../aftersale/addPurchaseTradesAction.do"
								...
								<fieldset align="center">
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr>
											...
											<td width="21%">
												<input name="cname" type="text" id="cname"  dataType="Require" msg="必须录入供应商!"
												value="${cname}" readonly="readonly"><a href="javascript:SelectProvide();"><img
											...
											<td width="23%">
												<input name="clinkman" type="text" id="clinkman"
										...
										<tr>
											...
											<td>
												<windrp:warehouse name="warehouseoutid"/>
											</td>
											<td align="right">
												入货仓库：
											</td>
											<td>
												<windrp:warehouse name="warehouseinid"/>
											</td>
											<td align="right">
												预计取货日期：
											</td>
