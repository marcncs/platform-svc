...
function OutPut() {
	excputform.action = "../report/excPutSalesDetailReportAction.do?type=${type}";
	excputform.submit();
}
</script>
	</head>
				...
				<td>
					<div id="div1">
						...
						<form name="searchform" method="post"
							action="../report/salesDetailReportAction.do" onSubmit="return formChk();">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<ws:hasAuth operationName="/report/excPutSalesDetailReportAction.do">
								...
								<td class="SeparatePage">
									<pages:pager action="../report/salesDetailReportAction.do" onsubmit="formChk()"/>
								</td>
							</tr>
						</table>
					</div>
...
<form  name="excputform" method="post" action="excPutSalesDetailReportAction.do">
...
<input type="hidden" name="organType" id ="organType" value="${organType}">
<input type="hidden" name="queryFlag" id ="queryFlag" value="${queryFlag}">
</form>
	</body>
</html>
