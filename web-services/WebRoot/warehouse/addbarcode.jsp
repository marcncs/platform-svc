...
<html>
	...
	function addIdcode() {
		...
		var wid = $F('wid');
		var batch = $F('batch');
		var url = "../warehouse/addTakeTicketIdcodeiiAction.do?idcode="
				+ idcode + "&billid=" + billid + "&prid=" + prid + "&wid="
				+ wid + "&batch=" + batch;
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<form name="addform" method="post" action="">
						<table width="100%" border="0" cellpadding="0" cellspacing="1">
							...
							<tr>
								...
								<td>
									<input type="text" name="idcode" size="35" maxlength="50">
								</td>
								--%><td align="right">
									仓库：
								</td>
								<td>
									<windrp:getname key='warehouse' value='${wid}' p='d' />
								</td>
								<td>
									<%--
	      ...
	      --%>
					...
					<IFRAME id="submsg"
						...
						name="submsg"
						src="../warehouse/listBarcodeDetailAction.do?billid=${billid}&prid=${bbd.productid}&isaudit=${isaudit}&batch=${batch}&specmode=${specmode}"
