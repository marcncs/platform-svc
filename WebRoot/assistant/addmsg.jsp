...
<form method="post" name="msg" enctype="multipart/form-data" action="addMsgAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
	   ...
	   <tr>
        ...
        <td width="87%">
		<div id="handid"><input type="text" name="mobileno" size="60" maxlength="1000">(多个手机号码请用逗号','隔开)</div>
	  ...
	  <tr>
        ...
        <td><textarea name="msgcontent" cols="100" id="msgcontent" dataType="Limit" max="256"  msg="内容在256个字之内" require="false"></textarea><br><span class="td-blankout">(内容长度不能超过256字符)</span></td>
	  </tr>
	  <tr>
