 ...
 *
 */
public class DelUserVisitAction extends BaseAction {
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			appRuleUserWH.delRuleWhByOid(array, uid, true);
			//删除管辖机构
			String whereStr = " where uv.userid=" + uid + " and uv.visitorgan in (" + array + ")  " ;
			app.delUserVisit(whereStr);
