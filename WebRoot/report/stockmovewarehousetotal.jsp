...
function print(){
	...
	excputform.action="../report/printStockMoveWarehouseTotalAction.do";
	excputform.submit();
	excputform.target="";
	excputform.action="../report/excPutStockMoveWarehouseTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>渠道>>转仓按仓库汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="stockMoveWarehouseTotalAction.do">
   ...
   <td class="SeparatePage"></td>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr class="title-func-back"> 
			...
			<pages:pager action="../report/stockMoveWarehouseTotalAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutStockMoveWarehouseTotalAction.do">
