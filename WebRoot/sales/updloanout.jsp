  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 修改借出单</td>
        </tr>
      </table>
      <form name="validateProvide" method="post" action="updLoanOutAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <logic:iterate id="d" name="userlist">
            <option value="${d.userid}" ${d.userid==sof.uid?"selected":""}>${d.realname}</option>
          </logic:iterate>
        </select></td>
          <td width="10%" align="right">收货人：</td>
          <td width="22%"><select name="receiveman" id="receiveman">
          <logic:iterate id="d" name="userlist">
            <option value="${d.realname}" ${d.realname==sof.receiveman?"selected":""}>${d.realname}</option>
          </logic:iterate>
        </select></td>
	    ...
	    <td  colspan="3">&nbsp;</td>
          ...
          <tr>
            ...
            <tr class="table-back">
                ...
                <td><input name="warehouseid" type="hidden" value="${p.warehouseid}" id="warehouseid"><input name="warehousename" type="text" value="${p.warehouseidname}" id="warehousename" size="10" readonly><a href="#" onclick="SelectWarehourse(this);"><img src="../images/CN/find.gif" width="18" height="18" border="0"></a></td>
				<td><input name="batch" type="text" value="${p.batch}" id="batch" size="10" readonly></td>
                <td><input name="quantity" type="text" value="${p.quantity}" onChange="SubTotal(${count});TotalSum();" id="quantity" size="8" maxlength="6"></td>
                ...
                <td><input name="cost" type="text" value="${p.cost}" id="cost" size="4" readonly></td>				
