  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 修改质检合格单</td>
        </tr>
      </table>
       <form name="referForm" method="post" action="updQualityPassAction.do">
...
供应商：</td>
          <td width="25%"><input name="pid" type="hidden" id="pid" value="${pbf.pid}">
            <input name="providename" type="text" id="providename" value="${pbf.pidname}" readonly>
          ...
          <td width="23%"><input name="plinkman" type="text" id="plinkman" value="${pbf.plinkman}">
            <a href="javascript:SelectLinkman();"><img src="../images/CN/find.gif" width="18" height="18" border="0"></a></td>
	      <td width="8%" align="right">采购类型：</td>
	      <td width="25%">${pbf.purchasesortname}</td>
	  </tr>
	  <tr>
	    ...
	    <td><select name="qualitydept" id="qualitydept">
          <logic:iterate id="d" name="aldept">
            <option value="${d.id}" <c:if test="${d.id==pbf.qualitydept}"> selected </c:if>
              >${d.deptname} </option>
          </logic:iterate>
        </select></td>
	    </tr>
          ...
          <tr>
            ...
            <tr class="table-back">
                ...
                <td><input name="specmode" type="text" value="${p.specmode}" size="35" readonly></td>
