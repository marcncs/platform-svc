...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="searchform" method="post" action="stockAlterMoveDetailAction.do">
  ...
  <input name="EndDate" type="text" id="EndDate" value="${EndDate}"  
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr class="title-func-back"> 
			...
			<pages:pager action="../report/stockAlterMoveDetailAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
...
<%--          <td align="right">￥<windrp:format p="###,##0.00" value='${d.subsum}' /></td>--%>
	...
	<table width="100%" cellspacing="1" class="totalsumTable">
        <tr class="back-gray-light">
          ...
          <td width="77%" align="right">${toalboxnum}   &nbsp;&nbsp;箱  &nbsp;&nbsp;&nbsp;&nbsp; <windrp:format p="###,##0" value='${totalscatternum}' />   &nbsp;&nbsp;散&nbsp;&nbsp;</td>
          </tr>
		<tr class="back-gray-light">
          <td width="12%" align="right">总合计：</td>
          <td width="77%"  align="right">${alltoalboxnum}  &nbsp;&nbsp; 箱   &nbsp;&nbsp;&nbsp;&nbsp;<windrp:format p="###,##0" value='${alltotalscatternum}' />  &nbsp;&nbsp; 散&nbsp;&nbsp;  </td>
          </tr>
      </table> 
      </div>
    </td>
...
<form  name="excputform" method="post" action="excPutStockAlterMoveDetailAction.do">
