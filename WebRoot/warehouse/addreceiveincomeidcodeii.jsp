...
function addIdcode(){
   ...
   var url = "../warehouse/addProductIncomeIdcodeiiAction.do?idcode="+idcode+"&billid="+billid+"&prid="+prid+"&warehousebit="+warehousebit;
...
<%--          <td width="12%">${bbd.quantity}</td>--%>
	  ...
	  <tr>
	      ...
	      <td width="9%">&nbsp;</td>
	      <td width="7%" ><!-- <input type="button" value="新增" onClick="formcheck()" ${isaudit==1?"disabled":""}>&nbsp; --><input type="button" name="cancel" value="关闭" onClick="window.close();"></td>          
	  </tr>
      ...
      name="submsg" src="../warehouse/listReceiveIncomeIdcode.do?billid=${billid}&prid=${bbd.productid}&isaudit=${isaudit}" frameBorder="0" scrolling="no" onload="setIframeHeight(this)"></IFRAME>  
