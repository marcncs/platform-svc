...
function ToSet(){
	popWin("../users/listOrganRoleByOrganForSelectAction.do?OrganID=${OrganID}",800,500);
}
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      <tr>
        ...
        <td width="772">拥有角色</td>
      </tr>
    </table>
    <form name="search" method="post" action="../users/listOrganRoleForOrganAction.do">
...
<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
				<td width="50" align="center">
					...
					<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>		
			  <td  class="SeparatePage"><pages:pager action="../users/listOrganRoleForOrganAction.do"/></td>
								
			</tr>
		</table>
		<FORM METHOD="POST" name="listform" ACTION="../users/delOrganRoleForOrganAction.do" target="winform">
            ...
            <tr align="center" class="title-top">
              ...
              <logic:iterate id="d" name="opls" >
                <tr align="center" class="table-back-colorbar" onClick="CheckedObj(this,'${d.id}');">
                  ...
                  <td  align="left">${d.roleid}</td>
                  <td align="left">${d.rname}</td>
                  <td align="left">${d.roledesc}</td>
                </tr>
              </logic:iterate>
