...
function Del(){
	...
	if(flag){
		if(window.confirm("您确认要删除所选的记录吗？如果删除将永远不能恢复!")){
			showloading();			
			popWin4("../warehouse/delStockMoveIdcodeAction.do?ids="+rids,500,250, "del");
		}
	}else{
		alert("请选择你要操作的记录!");
	}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    <td>
	<div id="bodydiv">
	<form name="search" method="post" action="../warehouse/listStockMoveIdcode.do">
...
<!--		  
            ...
            <td width="9%" height="25" align="right">&nbsp;</td>
            	  	 -->
            <td align="left"><input name="Submit" type="image" id="Submit" src="../images/CN/search.gif" border="0" title="查询"></td>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr class="title-func-back">
		 <!-- <td width="50" >
		  ...
		  <td class="SeparatePage"><pages:pager action="../warehouse/listStockMoveIdcode.do"/></td>						
		</tr>
	</table>	
	 </div>
	</td>
	...
	<tr>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1">  
		  ...
		  <td>${p.idcode}</td> 
			...
			<td>${p.batch}</td>     
			<td>
				<windrp:dateformat value="${p.producedate}" p="yyyy-MM-dd" />
			</td>  
