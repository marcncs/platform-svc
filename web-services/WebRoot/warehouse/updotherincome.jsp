...
<script language=javascript>
  function addRow(p){
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
        ...
        g.innerHTML="<input name=\"unitprice\" type=\"text\" id=\"unitprice\" value=\"0\" size=\"10\" maxlength=\"10\" onchange=\"SubTotal();\" onFocus=\"SubTotal();\" dataType=\"Double\" msg=\"单价只能是数字!\" require=\"false\" onKeyPress=\"KeyPress(this)\" maxlength=\"8\">";
        h.innerHTML="<input name=\"quantity\" type=\"text\" id=\"quantity\" value=\"1\" size=\"8\" maxlength=\"8\" onchange=\"SubTotal();\" onFocus=\"SubTotal();\" dataType=\"Double\" msg=\"数量只能是数字!\" require=\"false\" onKeyPress=\"KeyPress(this)\" maxlength=\"8\">";
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">修改盘盈单</td>
        </tr>
      </table>
              <form name="validateProvide" method="post" action="../warehouse/updOtherIncomeAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
         ...
         <td>
		  ...
		  <input name="orgname" type="text" id="orgname" value="${o.organname }" size="30" dataType="Require" msg="必须录入出货机构!" readonly><a href="javascript:SelectOrgan();"><img src="../images/CN/find.gif" width="18" height="18" border="0" align="absmiddle"></a>
		<span class="style1">*</span>
	    </td>
   	      <td width="10%" align="right">仓库：</td>
		<td width="24%">
			<input type="hidden" name="warehouseid" id="warehouseid" value="${oif.warehouseid}">
			<input type="text" name="owname" id="owname" onClick="selectDUW(this,'warehouseid',$F('organid'),'rw','')" value="<windrp:getname key='warehouse' value='${oif.warehouseid}' p='d'/>" readonly>	
			<span class="STYLE1">*</span>
		</td>		  
          <td width="8%" align="right">入库类别：</td>
          <td width="23%"><windrp:select key="IncomeSort" name="incomesort" p="n|f" value="${oif.incomesort}"/></td>

	  </tr>	 
	  <tr>
	      <td width="9%" align="right">相关单据号：</td>
	      <td width="25%"><input name="billno" type="text" id="billno" value="${oif.billno}"></td>
	     <td align="right"><input type="checkbox" name="isaccount" ${oif.isaccount==1?"checked":""} />&nbsp;</td>
	    <td>是否记账</td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
	    </tr> 
            ...
            <td  align="right"><table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
              ...
              <logic:iterate id="p" name="als" >
                <tr class="table-back">
                  ...
                  <td><input name="batch" type="text" id="batch" value="${p.batch}" size="12" maxlength="32"></td>
                  <td><input name="unitprice" type="text" id="unitprice" value="${p.unitprice}" size="10" onChange="SubTotal();" onKeyPress="KeyPress(this)" dataType="Double" msg="单价只能是数字!" require="false" maxlength="8"></td>
                  <td><input name="quantity" type="text" value="${p.quantity}" id="quantity" size="8" onChange="SubTotal();" onKeyPress="KeyPress(this)" dataType="Double" msg="数量只能是数字!" require="false" maxlength="8"></td>
                  <td><input name="subsum" type="text" id="subsum" value="${p.subsum}" size="10"></td>
                  </tr>
          ...
          <tr>
            <td  align="center"><table width="100%"  border="0" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td width="94%"><textarea name="remark" cols="180" rows="4" id="remark" dataType="Limit" max="256"  msg="备注必须在256个字之内" require="false">${oif.remark}</textarea></td>
              </tr>
            </table></td>
          </tr>
          <tr>
