...
function Check(){
	...
	function deleteAll(v_chebox,v_dbtable){
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 修改盘亏单</td>
        </tr>
      </table>
              <form name="validateProvide" method="post" action="updOtherShipmentBillAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
		...
		<td width="24%">
			...
			<input type="text" name="owname" id="owname" onClick="selectDUW(this,'warehouseid',$F('organid'),'rw','')" value="<windrp:getname key='warehouse' value='${osbf.warehouseid}' p='d'/>" readonly>	
			<span class="STYLE1">*</span>
		</td>		  

          <td width="9%" align="right">出库类别：</td>
          <td width="23%"><windrp:select key="ShipmentSort" name="shipmentsort" value="${osbf.shipmentsort}" p="n|f"/></td>
	  </tr>
	  <tr>
	      <td width="9%" align="right">相关单据：</td>
	      <td width="25%"><input type="text" name="billno" value="${osbf.billno}" maxlength="32"></td>
	    <td  align="right">需求日期：</td>
	    <td><input name="requiredate" type="text" id="requiredate" value="<windrp:dateformat value='${osbf.requiredate}' p='yyyy-MM-dd'/>" onFocus="javascript:selectDate(this)" readonly></td>
	    <td align="right"><input type="checkbox" name="isaccount" ${osbf.isaccount==1?"checked":""} />&nbsp;</td>
	    <td>是否记账</td>
	    </tr>
	  </table>
	</fieldset>
          ...
          <tr>
            <td  align="center"><table width="100%"  border="0" cellpadding="0" cellspacing="1">
              <tr>
                ...
                <td width="94%"><textarea name="remark" cols="180" rows="4" id="remark" dataType="Limit" max="256"  msg="备注必须在256个字之内" require="false">${osbf.remark}</textarea></td>
              </tr>
            </table></td>
          </tr>
          <tr>
