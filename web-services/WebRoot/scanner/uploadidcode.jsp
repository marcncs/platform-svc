...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td>
		<form name="refer" method="post" enctype="multipart/form-data" action="../scanner/uploadIdcodeAction.do" onSubmit="return formcheck()">
	   ...
	   <tr>
          ...
          <td width="21%">选择文件类型：
              <select name="billsort" dataType="Require" msg="必须选择文件类型!">
					...
					<option value="21">转仓</option>
					<option value="19">退货</option>
				</select>
            </td>
