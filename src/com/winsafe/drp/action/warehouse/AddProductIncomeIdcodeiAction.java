...
public class AddProductIncomeIdcodeiAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		super.initdata(request);try{
			...
			ProductIncomeIdcode pi = null;
			app.delProductIncomeIdcodeByPid(productid, billid);
			for ( int i=0; i<warehousebit.length; i++ ){
				pi = new ProductIncomeIdcode();
			 ...
			 DBUserLog.addUserLog(users.getUserid(),7, "入库>>产成品入库>>分配仓位,产品编号:"+productid);
