...
public class AddProductInterconvertIdcodeiiAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		super.initdata(request);try{
			...
			ProductInterconvertIdcode oldpii=app.getProductInterconvertIdcodeByidcode(productid, billid, idcode);
			if ( oldpii != null ){
