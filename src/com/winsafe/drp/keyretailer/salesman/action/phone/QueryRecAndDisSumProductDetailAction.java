...
//	Map<String, String> unitMap = null;
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if("1".equals(type)) {
				dateList = appTakeTicket.getReceiveSummaryProductDetail(request, loginUsers.getMakeorganid(), condition);
			} else if("2".equals(type)) {
				dateList = appTakeTicket.getDispatchSummaryProductDetail(request, loginUsers.getMakeorganid(), condition);
			} else if("3".equals(type)) {
				dateList = appTakeTicket.getReceiveSummaryProductDetailForBKR(request, loginUsers.getMakeorganid(), condition);
			}
