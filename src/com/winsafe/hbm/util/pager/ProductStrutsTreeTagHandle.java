...
import com.winsafe.hbm.util.pager.ProductStrutsTreeTagHandle;


public class ProductStrutsTreeTagHandle extends TagSupport {
	private static final long serialVersionUID = 1L;
	protected Logger logger=Logger.getLogger(ProductStrutsTreeTagHandle.class);
	private String id;
	private String name;
	...
	protected void outPagination()throws JspException{
		...
		try{
			...
			.append("<script>")
			.append("var pstree = new WebFXLoadTree(\"All\",\"../productStrutsAction.do?id=1\",\"javascript:show('1')\");")
