	...
	$("input:checkbox").each(function(i){
		...
		if(parray.length > 0){
			if(confirm("你确定要删除机构权限吗？")){
				popWin("../users/delUserVisitAction.do?uid=${uid}&oid="+parray,500,250);
			}
		}else{
		alert("请选择你要操作的记录!");
		}
...
function toSet(){
	popWin("../users/selectUserVisitOrganIframeAction.do?uid="+${uid},800,500);
}
function toSetWH(){
							...
							<td>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr class="title-func-back">
										...
										<%--
										<td width="70" align="center">
											<a href="javascript:toSetWH();"><img
													src="../images/CN/addnew.gif" width="16" height="16"
													border="0" align="absmiddle">&nbsp;设置仓库</a>
										</td>
										<td width="1">
											<img src="../images/CN/hline.gif" width="2" height="14">
										</td>
										...
										<td class="SeparatePage">
											<pages:pager action="../users/listUserVisitAction.do" />
										</td>
