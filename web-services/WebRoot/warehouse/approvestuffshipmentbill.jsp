...
<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="26%">${ssbf.warehouseidname}</td>
          <td width="8%" align="right">出库类别：</td>
          <td width="24%">${ssbf.shipmentsortname}</td>
	      <td width="8%" align="right">出库部门：</td>
	      <td width="25%">${ssbf.shipmentsortname}</td>
	  </tr>
	  <tr>
	    <td  align="right">需求日期：</td>
	    <td>${ssbf.requiredate}</td>
	    <td align="right">备注：</td>
	    <td colspan="3">${ssbf.remark}</td>
	    </tr>
	  </table>
	</fieldset>
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="26%">${ssbf.makeidname}</td>
...
<form name="addform" method="post" action="../warehouse/approveStuffShipmentBillAction.do">
      <table width="100%" height="208"  border="0" cellpadding="0" cellspacing="1">
        
          <tr class="table-back"> 
            <td  align="right"><input name="ssid" type="hidden" id="ssid" value="${ssid}">
            审阅状态：</td>
            <td>${approvestatus}</td>
          </tr>
          <tr class="table-back">
