  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      <tr>
        ...
        <td width="772">选择拥有角色</td>
      </tr>
    </table>
    <form name="search" method="post" action="../users/listOrganRoleByOrganForSelectAction.do">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
	        ...
	        <td class="SeparatePage"><pages:pager action="../users/listOrganRoleByOrganForSelectAction.do"/></td>
												
							</tr>
						</table>
						<FORM METHOD="POST" name="listform" ACTION="../users/setOrganRoleForOrganAction.do">
            ...
            <tr align="center" class="title-top">
              ...
              <logic:iterate id="d" name="opls" >
                <tr align="center" class="table-back-colorbar" onClick="CheckedObj(this,'${d.id}');">
                  ...
                  <td align="left">${d.rolename}</td>
                  <td align="left">${d.describes}</td>
                </tr>
              </logic:iterate>
