...
function excput(){
	searchform.action="../report/excPutHarmShipmentBillTotalAction.do";
	searchform.submit();
	searchform.action="../report/harmShipmentBillTotalAction.do";
}
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>出库>>报损汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="harmShipmentBillTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table-back">
            ...
            <td width="27%"><select name="MakeID" id="MakeID">
            ...
            <td width="31%"><input name="BeginDate" type="text" id="BeginDate" onFocus="selectDate(this);" value="${BeginDate}" size="10">
-
...
<c:forEach items="${str}" var="d">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/report/harmShipmentBillTotalAction.do"/>	
            </td>
          </tr>
