...
<html>
	...
	<body>
		<form name="refer" method="post" enctype="multipart/form-data"
			action="../report/uploadSalesConsumHistoryAction.do"
					...
					<td align="left" width="30%">
						...
						<td   width="60%">
							...
							<input name="idcodefile" type="file" id="idcodefile" size="40"
								dataType="Filter" accept="xls" msg="只能上传xls格式的文件!">
						</td>
						<td width="23%">
							<a
								href="../common/downloadfile.jsp?filename=/templates/<windrp:encode key='销售消耗历史数据上传.xls' />"
								title="模板下载">模板下载</a>
						</td>
						<td></td>
					</tr>
