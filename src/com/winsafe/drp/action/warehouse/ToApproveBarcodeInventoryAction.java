 ...
 * 
 */
public class ToApproveBarcodeInventoryAction extends BaseAction {
	private Logger logger = Logger
			.getLogger(ToApproveBarcodeInventoryAction.class);
	private AppBarcodeInventory api = new AppBarcodeInventory();
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			BarcodeInventory ai = api.getBarcodeInventoryByID(id);
