...
function excput(){
	searchform.action="../report/excPutWebIndentDetailAction.do";
	searchform.submit();
	searchform.action="../report/webIndentDetailAction.do";
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">网站订单明细表</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="webIndentDetailAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
       
          <tr class="table-back">
            <td width="8%"  align="right">配送机构：</td>
            <td width="29%"><select name="EquipOrganID" id="MakeOrganID">
            ...
            <td width="21%"><input name="BeginDate" type="text" id="BeginDate" onFocus="selectDate(this);" value="${begindate}" size="10">
-
	...
	<c:forEach items="${alsod}" var="d">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/report/webIndentDetailAction.do"/>	
            </td>
          </tr>
