  ...
  function SelectOrgan2(){
	...
	<body style="overflow: auto;">
		<form id="referForm" name="referForm" method="post"
			action="updUnitInfoAction.do" onSubmit="return checkSubmit();">
						...
						<fieldset align="center">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1">
								<tr>
									...
									<td>
										<input name="organid" type="hidden" id="organid"  value="${UnitInfoForm.organId}">
										<input name="orgname" type="text" id="orgname" size="30"
											dataType="Require" msg="必须录入工厂!"  value="${UnitInfoForm.organName}" readonly>
					            ...
					            <td>
					              <input type="hidden" name="id" id="id" value="${UnitInfoForm.id}" />
						            <input name="ProductID" type="hidden" id="ProductID"  value="${UnitInfoForm.productId}">
						             <input id="ProductName" type="text"  name="ProductName" value="${UnitInfoForm.productName}" readonly 
								...
								<tr>
								   ...
								   <td align="right">
				   					...
				   					<td>
				   					   <input type="text" name="unitCount" id="unitCount" value="${UnitInfoForm.unitCount}"
								...
								<tr>
								   <td align="right">
				   					...
				   					<td>
										<windrp:select key="labelType" name="labelType" p="y|f" value="${UnitInfoForm.labelType}"/>
										<span class="STYLE1">*</span>	
									</td>
									<td align="right">
										是否需要分装：
									</td>
									<td><windrp:select key="YesOrNo" name="needRepackage" p="n|f" value="${UnitInfoForm.needRepackage}"/></td>
								</tr>
								<tr>
								   <td align="right">
								   		是否生成暗码：
				   					...
				   					<td>
				   						<c:choose>
											<c:when test="${UnitInfoForm.needCovertCode != null}">
												<windrp:select key="YesOrNo" name="needCovertCode" p="n|f" value="${UnitInfoForm.needCovertCode}"/>
											</c:when>
											<c:otherwise>
									...
									<td id="codeSeqInput">
										<input id="codeSeq" name="codeSeq" type="text" dataType="Require" msg="请设置暗码前缀!" maxlength="3" onkeyup="checknum(this)" value="${UnitInfoForm.codeSeq}">
										<span class="STYLE1">*</span>	
									</td>
								</tr> 
