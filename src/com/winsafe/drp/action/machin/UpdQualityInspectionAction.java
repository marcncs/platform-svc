 ...
 */
public class UpdQualityInspectionAction extends BaseAction {

	private Logger logger = Logger.getLogger(UpdQualityInspectionAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if(appQI.isQualityInspectionExists(mCode, batch, id)) {
