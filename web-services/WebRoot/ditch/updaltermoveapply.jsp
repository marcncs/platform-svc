...
<html>
  ...
  function addRow(p){
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
		...
		d.innerHTML="<input name='specmode' type='text' id='specmode' readonly value='"+p.specmode+"'>";
        e.innerHTML="<input name='unitid' type='hidden' id='unitid' value='"+p.unitid+"'><input name='unit' type='text' id='unit' size='8' readonly value='"+p.unitidname+"'>";
        ...
        g.innerHTML="<input name='quantity' type='text' id='quantity'  dataType='Currency' msg='必须录入数值类型!' onKeyPress='KeyPress(this)' value='0' size='8' maxlength='8' onchange='SubTotal("+dbtable.rows.length+");TotalSum();' onFocus='SubTotal("+dbtable.rows.length+");TotalSum();'>";
          var subsum = formatCurrency(p.unitprice*p.quantity);
        h.innerHTML="<input name='subsum' type='text' id='subsum' value='"+subsum+"' size='8' maxlength='10'>";
...
function SupperSelect(rowx){
	var oid=document.referForm.outorganid.value;
	if(oid==null||oid=="")
	{
		alert("请选择调出机构！");
		return;
...
function TotalSum(){
	...
	<body style="overflow: auto;">
		<form name="referForm" method="post"
			action="updAlterMoveApplyAction.do"
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1">
							...
							<tr>
								<td>
											...
											<tr>
												...
												<td width="23%">
													...
													<input name="oname" type="text" id="oname" size="30"
													 dataType="Require" msg="必须录入调出机构!" value='<windrp:getname key="organ" p="d" value="${ama.outorganid}"/>'
									...
									<input type="text" name="wname" id="wname" onClick="selectDUW(this,'inwarehouseid','${ama.makeorganid}','w','transportaddr')" 
									value="<windrp:getname key='warehouse' p='d' value='${ama.inwarehouseid }'/>" readonly>	<span class="STYLE1">*</span>
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td><input name="tickettitle" type="text" id="tickettitle" value="${ama.tickettitle }"
													size="35" ></td>
												<td align="right">
													开票信息：
												</td>
											...
											<tr>
												...
												<td>
													<windrp:select key="TransportMode" name="transportmode" value="${ama.transportmode}"
													p="n|d" />
												</td>
												<td align="right">
													收货地址：
												...
												<td colspan="3">
													<input type="text" name="transportaddr" id="transportaddr" value="${ama.transportaddr}"size="80" maxlength="100" dataType="Require" msg="必须收货地址!"><span class="style1">*</span>
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td colspan="5">
												<textarea name="movecause" cols="100" style="width: 100%" rows="4"
								...
								<fieldset align="center">
									...
									<table width="100%" id="dbtable" border="0" cellpadding="0"
										...
										<c:set var="count" value="2"/>
											...
											<td>
												<input name="specmode" type="text" value="${p.specmode}" readonly>
											</td>
											<td>
											...
											<td>
												<input name="unitprice" type="text"
													...
													id="unitprice" size="10" maxlength="10" readonly>
											</td>
											<td>
											...
											<td>
												<input name="subsum" type="text" value="${p.subsum}"
													id="subsum" size="8" maxlength="8" readonly>
											</td>
										</tr>
										...
										<tr align="center" class="table-back">
											...
											<td width="15%">
												<input name="totalsum" type="text" id="totalsum" size="10"
													maxlength="10" value="${ama.totalsum}" readonly>
											</td>
										</tr>
									</table>
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
