...
function print(){
	...
	excputform.action="../report/printOrganWithdrawDetailAction.do";
	excputform.submit();
	excputform.target="";
	excputform.action="../report/excPutOrganWithdrawDetailAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td >报表分析>>渠道>>渠道退货明细</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="organWithdrawDetailAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr class="title-func-back"> 
			...
			<pages:pager action="../report/organWithdrawDetailAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutOrganWithdrawDetailAction.do">
