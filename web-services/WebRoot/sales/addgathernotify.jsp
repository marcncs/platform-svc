  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增打款通知</td>
        </tr>
      </table>
       <form name="validateProvide" method="post" action="../sales/addGatherNotifyAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
	  	<td width="9%"  align="right"><input name="cid" type="hidden" id="cid" >
	  	  客户名称：</td>
          <td width="21%"><input name="cname" type="text" id="cname" >
          ...
          <td width="23%"><input name="clinkman" type="text" id="clinkman">
	   ...
	   <tr>
	    ...
	    <td><input name="bankaccount" type="text" id="bankaccount"></td>
	    </tr>
	  <tr>
	    ...
	    <td><select name="saledept">
            <logic:iterate id="w" name="aldept">
              <option value="${w.id}">${w.deptname}</option>
            </logic:iterate>
          </select></td>
		<td  align="right">相关单据号：</td>
	    <td><input name="billno" type="text" id="billno" size="30"></td>
	    <td align="right">金额：</td>
	    <td><input name="totalsum" type="text" id="totalsum" size="20"></td>
	    </tr>
	  </table>
</fieldset>
       ...
       <tr>
            <td  align="center" ><table width="100%"  border="0" cellpadding="0" cellspacing="1">
              <tr >
                ...
                <td width="94%"><textarea name="memo" cols="180" rows="4" id="memo"></textarea></td>
              </tr>
            </table></td>
          </tr>-
          <tr>
