...
<script language="javascript">
	...
	function Affirm(){
	if(checkid!=""){
		location.href("../warehouse/purchaseOrderProductListAction.do?PIID="+checkid);
		}else{
			alert("请选择你要操作的记录!");
		}
	}
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="../warehouse/selectPurchaseOrderAction.do">
        ...
        <tr> 
          <td width="30%">
			<table width="166"  border="0" cellpadding="0" cellspacing="0">
              <tr align="center"> 
                <td width="107"><a href="javascript:Affirm();">转为采购入库单</a></td>
                <td width="59"><a href="javascript:Hidden();">隐藏</a></td>
              </tr>
            </table></td>
          <td width="70%" align="right"> <presentation:pagination target="/warehouse/selectPurchaseOrderAction.do"/> 
          </td>
        </tr>
      </table>
