...
public class IdcodeUpload implements Serializable {
    ...
    /** full constructor */
    public IdcodeUpload(Integer id, String filename, Integer billsort, Integer isdeal, Integer valinum, Integer failnum, String failfilepath, String makeorganid, Integer makedeptid, Integer makeid, Date makedate) {
        this.id = id;
    ...
    /** minimal constructor */
    public IdcodeUpload(Integer id) {
        this.id = id;
    }
