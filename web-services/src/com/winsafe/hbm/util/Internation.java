...
public class Internation {
    ...
    //
    public static String getSelectTagByKeyAllDB(String key,String tagName, boolean all) throws Exception{
    	AppBaseResource abr = new AppBaseResource();
    	List<BaseResource> ls = abr.getIsUseBaseResource(key);
    	String select = null;
    	if (all) {
            select = "<select name=\"" + tagName
                    + "\" ><option value=\"all\">选择</option>";
    	...
    	String option = "";
    	for(BaseResource br : ls ){
    		 option += "<option value=\"" + br.getTagsubkey() + "\">"
             + br.getTagsubvalue() + "</option></br>";
    	}
    	select = select + option + "</select>";
    ...
    public static String getSelectTagByKeyAllDBDef(String key,String tagName, Integer def) throws Exception{
    	AppBaseResource abr = new AppBaseResource();
    	List<BaseResource> ls = abr.getIsUseBaseResource(key);
    	String select = null;
        select = "<select name=\"" + tagName + "\" >";
    	...
    	for( BaseResource br : ls ){
    		if (def >-1) {
                if (br.getTagsubkey().equals(def)) {
                    option += "<option value=\"" + br.getTagsubkey()
                            + "\" selected >" + br.getTagsubvalue()
                            + "</option></br>";
                } else {
                    option += "<option value=\"" + br.getTagsubkey() + "\">"
                            + br.getTagsubvalue() + "</option></br>";
    ...
    public static String getSelectPayByAllDB(String tagName, boolean all) throws Exception{
    	AppPaymentMode apm = new AppPaymentMode();
    	List ls = apm.getAllPaymentMode();
    	String select = null;
    	if (all) {
            select = "<select name=\"" + tagName
                    + "\" ><option value=\"all\">选择</option>";
    	...
    	for(int i=0;i<ls.size();i++){
    		PaymentMode ob = (PaymentMode) ls.get(i);
    		 option += "<option value=\"" + ob.getId() + "\">"
             + ob.getPaymentname() + "</option></br>";
    	}
    	select = select + option + "</select>";
    	return select;
    }
    
    public static String getSelectPayAllDBDef(String tagName, Integer def) throws Exception{
    	AppPaymentMode apm = new AppPaymentMode();
    	List ls = apm.getAllPaymentMode();
    	String select = null;
        select = "<select name=\"" + tagName + "\" >";
    	...
    	for(int i=0;i<ls.size();i++){
    		PaymentMode ob = (PaymentMode) ls.get(i);
    		if (def >-1) {
                if (ob.getId().intValue()==def) {
                    option += "<option value=\"" + ob.getId()
                            + "\" selected >" + ob.getPaymentname()
                            + "</option></br>";
                } else {
                    option += "<option value=\"" + ob.getId() + "\">"
                            + ob.getPaymentname() + "</option></br>";
    ...
    public static String getStringByPayPositionDB(Integer id) throws Exception {
    	AppPaymentMode apm = new AppPaymentMode();
    	PaymentMode br = apm.getPaymentModeByID(id);
    	String value = null;
    	value= br.getPaymentname();
    	
    	return value;
    }
    
    public static String getStringByKeyPositionDB(String tagName, int key) throws Exception {
    	AppBaseResource abr = new AppBaseResource();
    	BaseResource br= new BaseResource();
    	br = abr.getBaseResourceValue(tagName, key);
    	String value = null;
