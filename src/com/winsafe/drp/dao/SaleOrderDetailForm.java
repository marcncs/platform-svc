...
public class SaleOrderDetailForm {
	/** identifier field */
    private Long id;
    ...
    private String makeorgan;
    
    private String equiporgan;
	...
	/**
	 * @return the makeorgan
	 */
	public String getMakeorgan() {
		return makeorgan;
	}

	/**
	 * @param makeorgan the makeorgan to set
	 */
	public void setMakeorgan(String makeorgan) {
		this.makeorgan = makeorgan;
	}

	/**
	 * @return the equiporgan
	 */
	public String getEquiporgan() {
		return equiporgan;
	}

	/**
	 * @param equiporgan the equiporgan to set
	 */
	public void setEquiporgan(String equiporgan) {
		this.equiporgan = equiporgan;
	}
