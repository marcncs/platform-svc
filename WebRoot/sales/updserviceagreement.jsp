...
function SelectLinkman(){
	...
	//document.referform.cid.value=getCookie("lid");
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      <tr>
        <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
            <tr>
              ...
              <td width="772"> 修改服务预约</td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td>
		<form name="referform" method="post" action="updServiceAgreementAction.do" onSubmit="return ChkValue();">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
        <tr >
          <td  align="right"><input name="id" type="hidden" id="id" value="${saf.id}">
          <input name="cid" type="hidden" id="cid" value="${saf.cid}">
            客户名称：</td>
          <td><input name="cname" type="text" id="cname" value="${saf.cidname}">
            <a href="javascript:SelectCustomer();"><img src="../images/CN/find.gif" width="18" height="18" border="0"></a></td>
          <td align="right" >联系人：</td>
          <td width="17%" ><input name="linkman" type="text" id="linkman" value="${saf.linkman}">
          ...
          <td width="25%" ><input name="tel" type="text" id="tel" value="${saf.tel}"></td>
        </tr>
        <tr >
          <td  align="right">服务种类：</td>
          <td>${saf.scontentname}</td>
          <td align="right" >服务状态：</td>
          <td >${saf.sstatusname}</td>
          <td align="right" >等级：</td>
          <td >${saf.rankname}</td>
        </tr>
        <tr >
          <td width="10%"  align="right">约定服务时间：</td>
          <td width="27%"><input name="sdate" type="text" id="sdate" onFocus="javascript:selectDate(this)" value="${saf.sdate}"></td>
          <td width="10%" align="right" >问题描述：</td>
          <td colspan="3" ><input name="question" type="text" id="question" value="${saf.question}" size="80"></td>
        </tr>
      </table>
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
        <tr >
		...
		<table width="100%"   border="0" cellpadding="0" cellspacing="0">
          <tr align="center" class="table-back">
            <td width="38" ><a href="javascript:deleteR();"><img src="../images/CN/del.gif"   border="0"></a></td>
            <td width="137">&nbsp;</td>
            <td width="86">&nbsp;</td>
            <td width="794" align="right"><input type="button" name="button" value="金额小计" onClick="TotalSum();">
              ：</td>
            <td width="186"><input name="totalsum" type="text" id="totalsum" value="${saf.sfee}" size="10" readonly maxlength="10"></td>
          </tr>
        </table>
		<table width="100%"  border="0" cellpadding="0" cellspacing="1">
          <tr >
            <td width="6%" height="77" align="right"> 备注： </td>
            <td width="94%"><textarea name="memo" cols="180" rows="4" id="memo">${saf.memo}</textarea></td>
          </tr>
        </table>
		</fieldset>
