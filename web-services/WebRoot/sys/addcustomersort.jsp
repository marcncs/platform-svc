  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增客户分类</td>
        </tr>
      </table>
	  <form name="validateWarehouse" method="post" action="../sys/addCustomerSortAction.do" onSubmit="return CheckInput();">
	  ...
	  <tr>
	  	<td width="7%" height="20" align="left">分类名称：</td>
          <td width="93%" align="left"><input name="sortname" type="text" id="sortname">
