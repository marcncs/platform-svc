...
function SelectProvide(){
	...
	document.searchform.ProvideID.value=p.ProvideID;
	document.searchform.ProvideName.value=p.ProvideName;
}
...
function excput(){
	searchform.target="";
	searchform.action="../report/excPutPurchaseIncomeProviderTotalAction.do";
	searchform.submit();
}
function oncheck(){
	searchform.target="";
	searchform.action="../report/purchaseIncomeProviderTotalAction.do";
	searchform.submit();
}

function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseIncomeProviderTotalAction.do";
	searchform.submit();
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>入库>>采购入库按供应商汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="purchaseIncomeProviderTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            ...
            <td><input name="ProvideID" type="hidden" id="ProvideID" value="${ProvideID}" >
              <input id="ProvideName" name="ProvideName" type="text" value="${ProvideName}" ><a href="javascript:SelectProvide();"><img src="../images/CN/find.gif" align="absmiddle" width="18" height="18" border="0">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseIncomeProviderTotalAction.do"/></td>
          </tr>
      </table>
      </div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
        ...
        <c:set var="totalc" value="${totalc+p.totalsum }"/>
		</c:forEach> 
		</table>
		<table width="100%" cellspacing="1" class="totalsumTable">
        <tr class="back-gray-light">
          <td  align="right" width="12%">本页合计：</td>
          <td align="right">￥<windrp:format p="###,##0.00" value="${totalc}" /></td>
        </tr>
		<tr class="back-gray-light">
