...
<script language="javascript">
	...
	function checkquantity(oiid){
		var unitprice = document.all("checkquantity");	
		...
		if ( iszero ){
		//当前盘点数量为零，可能未进行盘点，是否继续复核
			if(window.confirm("当前盘点数量为零，可能未进行盘点，是否继续复核?")){	
				Audit(oiid);
			}
		}else{
			Audit(oiid);
          ...
          <td width="364" align="right"><table width="220"  border="0" cellpadding="0" cellspacing="0">
			...
			<td width="60" align="center"><a href="javascript:StockCheckEmpty('${scf.id}');">打印</a></td>
              <td width="60" align="center"><c:choose>
                  <c:when test="${scf.isaudit==0}"><a href="javascript:checkquantity('${scf.id}');">复核</a></c:when>
	...
	<fieldset align="center"> <legend>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr class="title-func-back">		
		  <td class="SeparatePage"><pages:pager action="../warehouse/listStockCheckDetailAction.do"/></td>						
		</tr>
	</table>		
	<FORM METHOD="POST" name="listform" ACTION=""  >      
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1">  
		  ...
		  <tr align="center" class="table-back-colorbar" > 			
            ...
            <td><input type="hidden" name="checkquantity" value="${p.checkquantity}">${p.checkquantity}</td>     
            </tr>
