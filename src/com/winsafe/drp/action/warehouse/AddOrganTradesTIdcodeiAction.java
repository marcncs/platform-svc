...
public class AddOrganTradesTIdcodeiAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		super.initdata(request);try{
			...
			OrganTradesTIdcode pi = null;
			app.delOrganTradesTIdcodeByPid(productid, billid, pbatch);
			for ( int i=0; i<warehousebit.length; i++ ){
				pi = new OrganTradesTIdcode();
			 ...
			 DBUserLog.addUserLog(users.getUserid(),7, "入库>>渠道换货换方签收>>分配仓位,产品编号:"+productid);
