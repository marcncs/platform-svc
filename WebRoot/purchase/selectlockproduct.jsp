		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
				  ...
				  <table width="100%" height="40" border="0" cellpadding="0"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
					    ...
					    <tr class="table-back">
					      ...
					      <td width="15%" height="25"><input type="text" name="KeyWord"></td>
		  ...
		  <tr class="title-func-back">
							...
							<td style="text-align: right;">
								<pages:pager action="selectLockProductAction.do" />
							</td>
						</tr>
					</table>
                  </div>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable" id="ptable">
						...
						<logic:iterate id="p" name="sls">
							<tr class="table-back-colorbar">
								<td><input type="checkbox" name="che" value="${p.id}" onClick="changeValue(this)"></td>
								<td>${p.id}</td>
								<td>${p.productname}</td>
								<td>${p.specmode}</td>
								<td><input type="text" name="unitidname" size="6" value="${p.countunitname}" onFocus="selectUnit(this,'${p.id}','','','')">
									
                                <input type="hidden" name="pobj" id="pobj${count}" value="{productid:'${p.id}',productname:'${p.productname}',specmode:'${p.specmode}',unitid:'${p.countunit}',unitidname:'${p.countunitname}'}">
								</td>
							</tr>
