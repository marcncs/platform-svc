...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="validateProvide" method="post" action="../warehouse/addAssembleAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
	  <tr>
	  	<td width="11%"  align="right"><input name="aproductid" type="hidden" id="aproductid" >
	  	  组装产品名：</td>
          <td width="23%"><input name="aproductname" type="text" id="aproductname" >
          ...
          <td width="22%"><input name="abatch" type="text" id="abatch"></td>
	      <td width="9%" align="right">数量：</td>
	      <td width="25%"><input name="aquantity" type="text" id="aquantity"></td>
	  </tr>
	  <tr>
	    <td  align="right">完工入货仓库：</td>
	    <td><select name="warehouseinid">
          <logic:iterate id="d" name="alw">
            <option value="${d.id}">${d.warehousename}</option>
          </logic:iterate>
        </select></td>
	    ...
	    <td><input name="completeintenddate" type="text" id="completeintenddate" readonly onFocus="javascript:selectDate(this)" value="<%=com.winsafe.hbm.util.DateUtil.getCurrentDateString()%>"><span class="STYLE1">*</span></td>
	  </tr>
          ...
          <tr>
			...
			<table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
              <tr align="center" class="title-top">
				<td width="7%"><input type="checkbox" name="checkall" value="on" onClick="Check();"></td>
                <td width="11%">产品编号</td>
                <td width="17%" > 产品名称</td>
                <td width="18%">规格型号</td>
                <td width="7%"> 单位</td>
