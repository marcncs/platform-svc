  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增收款记录</td>
        </tr>
      </table>
	  <form name="validateProvide" method="post" action="../finance/addIncomeLogAction.do"  onSubmit="return ChkValue();">
	  ...
	  <tr>
	  	...
	  	<input name="roid" type="hidden" id="roid" value="${roid}">
应收款对象：</td>
          <td width="29%"><input name="draweeid" type="text" value="${payer}" size="35" readonly>
            <a href="javascript:SelectReceivableObject();"></a></td>
          <td width="9%" align="right">付款人：</td>
          <td width="22%"><input name="drawee" type="text" id="drawee" value="${payer}" size="35" maxlength="32"></td>
	  ...
	  <tr>
	    ...
	    <td><input type="text" name="incomesum" dataType="Double" msg="金额只能是数字!" require="false"></td>
	    </tr>
	  </table>
	</fieldset>
