...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    <td>
	<div id="bodydiv">
	<form name="search" method="post" action="../warehouse/listReceiveIncomeIdcode.do">
...
<%--			  	<a href="javascript:Del();"><img src="../images/CN/delete.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;删除</a>--%>
		  ...
		  <td class="SeparatePage"><pages:pager action="../warehouse/listReceiveIncomeIdcode.do"/></td>						
		</tr>
	</table>	
	 </div>
	</td>
