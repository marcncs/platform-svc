...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="addform" method="post" action="addPaymentLogAction.do" >
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
        
          <tr class="table-back"> 
            <td width="13%" align="right"><input name="pbid" type="hidden" id="pbid" value="${plf.pbid}">
            收款方 ： </td>
            <td width="33%"><input name="pid" type="hidden" id="pid" value="${plf.pid}">
              <input name="pname" type="text" id="pname" value="${plf.pname}" readonly> 
            </td>
          ...
          <tr class="table-back"> 
            ...
            <td><input name="paysum" type="text" id="paysum" value="0" onChange="CountBalance();"></td>
          </tr>
          <tr class="table-back"> 
            <td align="right">付款后余额：</td>
            <td><input name="owebalance" type="text" id="owebalance" value="0" readonly></td>
            <td align="right">票据号： </td>
            <td><input name="billnum" type="text" id="billnum3"></td>
          </tr>
          <tr class="table-back"> 
            <td align="right"> 备注

 ：</td>
            <td colspan="3"><textarea name="remark" cols="120" rows="5" id="remark"></textarea> </td>
          </tr>
          <tr class="table-back"> 
            <td align="right">&nbsp;</td>
