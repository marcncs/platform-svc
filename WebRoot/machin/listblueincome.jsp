...
<html>
	...
	function addNew(){
	window.open("../machin/toAddBlueIncomeAction.do","","height=650,width=1000,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
	}

	function Update(){
		if(checkid!=""){
		window.open("../machin/toUpdBlueIncomeAction.do?ID="+checkid,"","height=650,width=1000,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	...
	function OtherIncomeDetail(){
		if(checkid!=""){
			document.all.submsg.src="../machin/blueIncomeDetailAction.do?ID="+checkid;
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	...
	function Del(){
		...
		if(window.confirm("您确认要删除编号为:"+checkid+"的记录吗？如果删除将永远不能恢复!")){
			window.open("../machin/delBlueIncomeAction.do?ID="+checkid,"newwindow","height=250,width=500,top=250,left=250,toolbar=no,menubar=no,scrollbars=auto,resizable=no,location=no,status=no");
			}
		}else{
		alert("请选择你要操作的记录!");
		}
...
function excput(){
		search.target="";
		search.action="../machin/excPutBlueIncomeAction.do";
		search.submit();
		search.target="";
		search.action="../machin/listBlueIncomeAction.do";
	}
	function print(){
	...
	function DownTxt(){
	excputform.action="../machin/txtPutBlueIncomeAction.do";
	excputform.submit();
	}
    ...
    function Import() {
		window.open("../machin/toImportBlueIncomeAction.do?incomeSort=4","","height=300,width=500,top=190,left=190,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
	...
	<body>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post"
							action="../machin/listBlueIncomeAction.do">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								<ws:hasAuth operationName="/machin/toAddBlueIncomeAction.do">
									<td width="50">
								...
								<ws:hasAuth operationName="/machin/toUpdBlueIncomeAction.do">
									<td width="50">
								...
								<ws:hasAuth operationName="/machin/delBlueIncomeAction.do">
									<td width="50">
			...
			<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>	
			-->
								<ws:hasAuth operationName="/machin/toImportBlueIncomeAction.do">
									<td width="50">
										<a href="javascript:Import();"><img src="../images/CN/import.gif"
												width="16" height="16" border="0" align="absmiddle">&nbsp;导入</a>
									</td>
								</ws:hasAuth>
								<ws:hasAuth operationName="/machin/excPutBlueIncomeAction.do">
									<td width="50">
					...
					<div id="listdiv" style="overflow-y: auto; height: 600px;">
						...
						<div style="width: 100%">
							<div id="tabs1">
								<ul>
									<li>
										<a href="javascript:OtherIncomeDetail();"><span>蓝冲入库详情</span> </a>
									</li>
								</ul>
							</div>
							<div>
