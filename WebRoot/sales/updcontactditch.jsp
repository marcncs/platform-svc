  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      ...
      <tr>
		...
		<form name="validateContactLog" method="post" action="updContactDitchAction.do" onSubmit="return ChkValue();">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
	    ...
	    <tr >
          <td  align="right"><input name="id" type="hidden" id="id" value="${clf.id}">
          <input name="did" type="hidden" id="did" value="${clf.did}">
            渠道名称：</td>
	      <td><input name="dname" type="text" id="dname" value="${clf.didname}">
            <a href="javascript:SelectCustomer();"><img src="../images/CN/find.gif" width="18" height="18" border="0"></a></td>
	      <td align="right" >&nbsp;</td>
	      <td >&nbsp;</td>
	      </tr>
	    <tr >
          <td width="11%"  align="right">            联系日期：</td>
	      <td width="38%"><input name="contactdate" type="text" value="${clf.contactdate}" onFocus="javascript:selectDate(this)"></td>
	      <td width="10%" align="right" >联系方式：</td>
	      <td width="41%" >${clf.contactmodename}</td>
	      </tr>
	    <tr >
          <td  align="right">联系性质：</td>
	      <td>${clf.contactpropertyname}</td>
	      <td align="right">联系人：</td>
	      <td><input name="linkman" type="text" id="linkman" value="${clf.linkman}">
	    ...
	    <tr >
	      ...
	      <textarea name="contactcontent" cols="60" rows="5">${clf.contactcontent}</textarea></td>
	      <td align="right" valign="top">客户反馈：</td>
	      <td><textarea name="feedback" cols="60" rows="5" id="feedback">${clf.feedback}</textarea></td>
	      </tr>
	    <tr >
          <td  align="right">下次联系时间：</td>
	      <td><input name="nextcontact" type="text" id="nextcontact" onFocus="javascript:selectDate(this)" value="${clf.nextcontact}"></td>
	      <td align="right">下次联系目标：</td>
	      <td><input name="nextgoal" type="text" id="nextgoal" value="${clf.nextgoal}" size="60"></td>
	      </tr>
	  </table>
</fieldset>
