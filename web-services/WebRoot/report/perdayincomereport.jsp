...
var e=$F("EndDate");
if(obj=="c"){
document.all.chartmsg.src="perDayIncomeCountBarAction.do?b="+b+"&e="+e;
}else if(obj=="s"){
document.all.chartmsg.src="perDayIncomeSumBarAction.do?b="+b+"&e="+e;
}
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 产成品入库排名</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="perDayIncomeReportAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
       
          <tr class="table-back"> 
            <td width="10%"  align="right">日期：</td>
            <td width="43%"><input name="BeginDate" type="text" id="BeginDate" onFocus="selectDate(this);" value="${begindate}">
-
  ...
  <input type="submit" name="Submit" value="查询"></td>
	  ...
	  <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="38%">&nbsp;</td>
          <td width="62%" align="right"><presentation:pagination target="/report/perDayIncomeReportAction.do"/></td>
        </tr>
      </table>
