...
function SupperSelect(){
	...
	var p=showModalDialog("toSelectCheckProductAction.do?wid="+wid+"&wbit="+wbit+"&IsIDCode=${isbar}",null,"dialogWidth:20cm;dialogHeight:17cm;center:yes;status:no;scrolling:no;");
...
<form name="validateProvide" method="post" action="addStockCheckAction.do" onSubmit="return ChkValue();">
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
	  ...
	  <tr>
          ...
          <td width="24%"><windrp:warehouse name="warehouseid"/></td>
          <td width="10%" align="right">仓位：</td>
          <td width="23%"><input type="hidden" name="warehousebit" id="warehousebit">
          ...
          <tr> 
            <td width="100%" ><table  border="0" cellpadding="0" cellspacing="1">
              <tr align="center" class="back-blue-light2">
                <td id="elect"><img src="../images/CN/selectp.gif" border="0" style="cursor:pointer" onClick="SupperSelect()" ></td>
              </tr>
            </table></td>
          </tr>
        </table> 
