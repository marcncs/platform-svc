...
function Audit(pbid){
			window.open("../purchase/auditQualityPassAction.do?QPID="+pbid,"newwindow","height=250,width=500,top=250,left=250,toolbar=no,menubar=no,scrollbars=auto,resizable=no,location=no,status=no");
	}
	
	function CancelAudit(pbid){
			window.open("../purchase/cancelAuditQualityPassAction.do?QPID="+pbid,"newwindow","height=250,width=500,top=250,left=250,toolbar=no,menubar=no,scrollbars=auto,resizable=no,location=no,status=no");
	}
...
<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="25%">${pbf.pidname}</td>
          <td width="11%" align="right">联系人：</td>
          <td width="21%">${pbf.plinkman}</td>
	      <td width="11%" align="right">采购类型：</td>
	      <td width="23%">${pbf.purchasesortname}</td>
	  </tr>
	  <tr>
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="25%">${pbf.makeidname}</td>
          <td width="11%" align="right">制单日期：</td>
          <td width="21%">${pbf.makedate}</td>
	      <td width="11%" align="right">是否复核：</td>
	      <td width="23%">${pbf.isauditname}</td>
	  </tr>
	  <tr>
