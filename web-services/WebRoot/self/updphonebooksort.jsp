...
function Update(){
	...
	location.href("../self/listPhoneBookSortDetailAction.do?ID="+value);
}
...
function CheckboxOnlyOne(){
	...
	if(confirm("你确定要删除组信息！删除组时相映的电话信息也将删除！")){
		var checks = document.getElementsByName("PbsID");
			...
			popWin2("../self/delPhoneBokSortAction.do?value="+value);
	}
	...
	<body style="overflow: auto;">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			bordercolor="#BFC0C1" class="table-back">
			<tr>
				<td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1">
						...
						<logic:iterate id="p" name="pbs">
							<tr class="table-back-colorbar">
								<td>
									<input type="checkbox" id="PbsID" name="PbsID" value="${p.id}">
								</td>
								<td>
									${p.id}
								</td>
