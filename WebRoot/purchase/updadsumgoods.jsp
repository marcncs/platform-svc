...
function SupperSelect(rowx){
	...
	var p=showModalDialog("toSelectProviderProductAction.do",null,"dialogWidth:20cm;dialogHeight:16cm;center:yes;status:no;scrolling:no;");
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 修改到货通知</td>
        </tr>
      </table>
      <form name="referForm" method="post" action="updAdsumGoodsAction.do" onSubmit="return ChkValue();">
...
供应商：</td>
          <td width="24%"><input name="pid" type="hidden" id="pid" value="${pbf.pid}">
            <input name="providename" type="text" id="providename" value="${pbf.pidname}" size="35" readonly>
          ...
          <td width="26%"><input name="plinkman" type="text" id="plinkman" value="${pbf.plinkman}">
            <a href="javascript:SelectLinkman();"><img src="../images/CN/find.gif" width="18" height="18" border="0"></a></td>
	      <td width="10%" align="right">供应商送货单号：</td>
	      <td width="21%"><input name="obtaincode" type="text" id="obtaincode" value="${pbf.obtaincode}"></td>
	  </tr>
	  <tr>
	    ...
	    <td><select name="purchaseid" id="purchaseid">
          ...
          <tr>
            ...
            <tr class="table-back">
                ...
                <td><input name="specmode" type="text" value="${p.specmode}" size="40" readonly></td>
                <td><input name="unitid" type="hidden" value="${p.unitid}"><input name="unit" type="text" value="${p.unitname}" id="unit" size="8" readonly></td>
                <td><input name="unitprice" type="text" value="${p.unitprice}" id="unitprice" size="10" maxlength="10"></td>
