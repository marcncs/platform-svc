				...
				<td>
					<div id="div1">
						...
						<form name="search" method="post"
								action="../sales/listNoMemberAction.do">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<logic:iterate id="c" name="usList">
								<tr class="table-back-colorbar"
									...
									<td>
										<fmt:formatNumber value="${c.totalintegral}" pattern="0.00" />
									</td>
									<td>
...
frameBorder="0" scrolling="no" onload="setIframeHeight(this);"></IFRAME></div>
		...
		<form name="xlsform" method="post" action="excPutMemberAction.do">
			<input type="hidden" name="Province" value="${province}">
			<input type="hidden" name="Areas" value="${areas}">
			<input type="hidden" name="City" value="${city}">
			<input type="hidden" name="IsActivate" value="${IsActivate}">
			<input type="hidden" name="Source" value="${Source}">
			<input type="hidden" name="MemberSex" value="${MemberSex}">
