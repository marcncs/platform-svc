 ...
 var chebox=null;
  function addRow(){
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
		...
		e.innerHTML="<input name=\"unitprice\" type=\"text\" id=\"unitprice\" value=\"0\" size=\"10\" maxlength=\"10\" dataType=\"Double\" msg=\"单价只能是数字!\" require=\"false\" onchange=\"SubTotal("+dbtable.rows.length+");TotalSum();\" onFocus=\"SubTotal("+dbtable.rows.length+");TotalSum();\">";
		f.innerHTML="<input name=\"unitid\" type=\"hidden\" id=\"unitid\" size=\"6\"><input name=\"unit\" type=\"text\" id=\"unit\" size=\"8\" readonly>";
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 组装单生成采购计划</td>
        </tr>
      </table>
       <form name="validateProvide" method="post" action="../machin/assembleTransPurchasePlanAction.do">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
	    ...
	    <td width="20%"><input name="requiredate" type="text" id="requiredate" onFocus="javascript:selectDate(this)" value="<%=com.winsafe.hbm.util.DateUtil.getCurrentDateString()%>" size="12"></td>
	  </tr>
	  <tr>
	    <td height="19" align="right">建议采购日期：</td>
	    <td><input name="advicedate" type="text" id="advicedate" onFocus="javascript:selectDate(this)" value="<%=com.winsafe.hbm.util.DateUtil.getCurrentDateString()%>" size="12"></td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
          ...
          <tr>
			...
			<table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
              ...
              <tr align="center" class="table-back">
                ...
                <td align="left"><input name="unitprice" type="text" id="unitprice" onChange="SubTotal(${count});TotalSum();" value="0.00" size="10" maxlength="10"></td>
                <td align="left"><input name="quantity" type="text" value="${p.quantity}" onChange="SubTotal(${count});TotalSum();" id="quantity" size="8" maxlength="8"></td>
                ...
                <td align="left"><input name="advicequantity" type="text" id="advicequantity" value="${p.advicequantity}" size="10" maxlength="10"></td>
              </tr>
