...
<form id="referForm" name="referForm" method="post" action="updBillImportConfigAction.do" onSubmit="return checkSubmit();">
<input type="hidden" name="bicid" value="${bicid}"> 
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
	  ...
	  <tr>
		  ...
		  <input name="orgname" type="text" id="orgname" size="30" dataType="Require" msg="必须录入调出机构!" value="${oname}" readonly>
		<span class="style1">*</span>
	    </td>
   	      <td width="10%" align="right">模板：</td>
	      <td width="30%">
			<input type="text" name="templateno" id="templateno" value="${templateno}" readonly>	
...
<%--                <img src="../images/CN/selectp.gif" border="0" style="cursor:pointer" onClick="SupperSelect(dbtable.rows.length)" ></td>--%>
      ...
      <logic:iterate id="c" name="bics">
	      <tr align="center" class="table-back-colorbar">
			 <td align="left">
				${c.fieldDisplayName}<input name='fieldName' type='hidden' id='fieldName' value='${c.fieldName}'>
			 </td>
			<td align="left">
				<input name='${c.fieldName}_columnName' type='text' id='${c.fieldName}_columnName' value='${c.columnName}' size='30'>
			</td>
			<td align="left">
				<input name='${c.fieldName}_defaultValue' type='text' id='${c.fieldName}_defaultValue' value='${c.defaultValue}' size='20'>
			</td>
		</tr>
	</logic:iterate>
      </table>
