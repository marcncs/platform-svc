...
function SelectOrgan(){
		...
		if ( p==undefined){return;}
			...
			clearUser("OutWarehouseID","mname");
	}
...
function print(){
	...
	excputform.action="../report/printStockMoveBillTotalAction.do";
	excputform.submit();
	excputform.target="";
	excputform.action="../report/excPutStockMoveBillTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>渠道>>转仓按单据汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="stockMoveBillTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        
          <tr class="table-back">
            <td width="10%"  align="right">转出机构：</td>
            <td width="25%">
          ...
          <tr class="table-back">
            <td width="10%" align="right">转入机构：</td>
            <td width="20%"><input name="InOrganID" type="hidden" id="InOrganID" value="${InOrganID}">
              <input name="InOrganIDName" type="text" id="InOrganIDName" size="30"  value="${InOrganIDName}"
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/stockMoveBillTotalAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutStockMoveBillTotalAction.do" >
