...
function addIdcode(){
	...
	var batch=$F('batch');	
   var url = "../warehouse/addOtherIncomeIdcodeiiAction.do?idcode="+idcode+"&billid="+billid+"&prid="+prid+"&warehousebit="+warehousebit+"&batch="+batch;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1" >
  <tr>
	...
	<tr>
      ...
      name="submsg" src="../warehouse/listOtherIncomeIdcode.do?billid=${billid}&prid=${bbd.productid}&isaudit=${isaudit}&batch=${bbd.batch}" frameBorder="0" scrolling="no" onload="setIframeHeight(this)"></IFRAME>  
