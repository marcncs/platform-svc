...
function excput(){
	...
	searchform.action="../report/excPutOtherIncomeTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/otherIncomeTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printOtherIncomeTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/otherIncomeTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>盘点>>盘盈汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="otherIncomeTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            ...
            <td><input name="ProductID" type="hidden" id="ProductID" value="${ProductID}">
              <input id="ProductName" name="ProductName" value="${ProductName}" readonly><a href="javascript:SelectSingleProduct();"><img src="../images/CN/find.gif" align="absmiddle" width="18" height="18" border="0"></a>
              </td>
              <td></td>
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/otherIncomeTotalAction.do"/></td>
          </tr>
      </table>
      </div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
        ...
        <tr class="back-gray-light">
          <td  align="right" width="20%">本页合计：</td>
...
<form  name="excputform" method="post" action="excPutOtherIncomeTotalAction.do" >
