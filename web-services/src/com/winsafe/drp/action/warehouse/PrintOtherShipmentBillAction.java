...
public class PrintOtherShipmentBillAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		super.initdata(request);try{
			...
			AppOtherShipmentBill aps = new AppOtherShipmentBill();
			AppUsers au = new AppUsers();
			OtherShipmentBill sb = aps.getOtherShipmentBillByID(id);				
			...
			AppOtherShipmentBillDetail apbd = new AppOtherShipmentBillDetail();
			List<OtherShipmentBillDetail> pbls = apbd.getOtherShipmentBillDetailBySbID(id);
			ArrayList als = new ArrayList();		
			long orders = 1l;
			for (OtherShipmentBillDetail ttd :  pbls) {
