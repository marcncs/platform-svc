...
<script language="javascript">
	...
	function CheckedObj(obj,objname,objregcertcode,objspeccode, objid,objspecmode,objmcode,objpacksize){
	...
	function Affirm(){
	if(checkname!=""){
		var p={productname:checkname,regcertcode:checkcertcode,standardname:checkspeccode, id:checkid,specmode:checkspecmode,mcode:checkmcode,packsize:checkpacksize};
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="search" method="post" action="../common/selectYunProductAction.do">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr class="title-func-back">
          ...
          <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
          <td style="text-align: right;"><pages:pager action="../common/selectYunProductAction.do"/></td>
        </tr>
      </table>
       </div>
	</td>
	...
	<tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
          ...
          <tr class="table-back-colorbar" onClick="CheckedObj(this,'${p.productname}','${p.regCertCode}','${p.standardName}','${p.id}','${p.specmode}','${p.mCode}','${p.packSizeName}');" onDblClick="Affirm();"> 
            <td>${p.id}</td>
            <td>${p.productname}</td>
            <td>${p.mCode}</td>
            <td>${p.specmode}</td>
