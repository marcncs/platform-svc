...
<form name="validateProvide" method="post" action="ratifyOrganTradesAction.do" onSubmit="return formChk()">
	  ...
	  <fieldset align="center">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1">
				<tr>
					...
					<td width="24%">
						<windrp:getname key='warehouse' value='${ot.outwarehouseid}' p='d'/>
					</td>
					<td width="10%" align="right">
						换出仓库：
					</td>
					<td width="23%">
						<windrp:warehouse name="inwarehouseid" value="${ot.inwarehouseid}"/>
					</td>
				</tr>
				<tr>
					<td align="right">
      ...
      <table width="100%" id="dbtable" border="0" cellpadding="0" cellspacing="1">
        ...
        <logic:iterate id="p" name="list" >
          <tr class="table-back">     
            ...
            <td><input name="canquantity" type="text" value="${p.quantity}" id="canquantity" onKeyPress='KeyPress(this)' dataType="Double" msg="数量只能是数字!" require="true" size="8" maxlength="8"></td>
          </tr>
