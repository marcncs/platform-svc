...
function excput(){
	searchform.action="../assistant/excPutCIntegralTotalAction.do";
	searchform.submit();
	searchform.action="../assistant/cIntegralTotalAction.do";
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">会员积分汇总表</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="../assistant/cIntegralTotalAction.do">
         
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr class="table-back">
            <td width="8%"  align="right">所在机构：</td>
            <td width="27%"><select name="makeorganid" id="makeorganid">
     ...
     <!--   <tr class="back-gray-light">
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr> 
			...
			<presentation:pagination target="/assistant/cIntegralTotalAction.do"/>	
            </td>
          </tr>
