      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body form-horizontal">
        	<div class="form-group">
                ...
                <div id="img_add_news_container" style="padding-top: 15px;">
                	<img id="img_add_news" width="200px" src="${picUrl}">
                </div>
  ...
  <script src="<%=path%>/res/custom/wz-media.js"></script>
	...
	<script type="text/javascript">
      ...
      $("#btn_submit_add_news").click(function(e) {
      	...
      	var data = {pic_url : picUrl, videoId : '${MVID}'};
      	$.ajax({url: "<%=path%>/qr/api/product/videos/changecover", type: "POST", dataType:"json", data: data,
					success: function(d) {
						window.location.href="<%=path%>/sys/operatorclose4.jsp";
					},
