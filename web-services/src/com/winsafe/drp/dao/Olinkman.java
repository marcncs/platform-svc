...
public class Olinkman implements Serializable {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof Olinkman) ) return false;
        Olinkman castOther = (Olinkman) other;
