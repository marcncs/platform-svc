...
function excput(){
	searchform.target="";
	searchform.action="../report/excPutProductInterconvertDetailAction.do";
	searchform.submit();
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printProductInterconvertDetailAction.do";
	searchform.submit();
	
}
function oncheck(){
	searchform.target="";
	searchform.action="../report/productInterconvertDetailAction.do";
	searchform.submit();
}
  ...
  <tr>
    <td>  <div id="div1"><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>出库>>产品互转明细</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="productInterconvertDetailAction.do" onSubmit="return oncheck();">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/productInterconvertDetailAction.do"/></td>
          </tr>
      </table>
      </div>
