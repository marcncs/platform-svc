...
function OutPut() {
	excputform.action = "../report/excPutConsumeDetailReportAction.do?type=${type}";
	excputform.submit();
}
</script>
	</head>
	<body>
				...
				<td>
					<div id="div1">
						...
						<form name="searchform" method="post"
							action="../report/consumeDetailReportAction.do" onSubmit="return formChk();">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr class="table-back">
									...
									<td>
										<input style="display:none;" type="radio" name="countByUnit" value="" <c:if test="${countByUnit eq '' or countByUnit eq null}">checked</c:if>></input>
										<input style="display:none;" type="radio" name="countByUnit" value="true" <c:if test="${countByUnit eq 'true'}">checked</c:if>></input>
									</td>
									<td colspan="4">
									</td>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<ws:hasAuth operationName="/report/excPutConsumeDetailReportAction.do">
									<td width="50">
								...
								<td class="SeparatePage">
									<pages:pager action="../report/consumeDetailReportAction.do" onsubmit="formChk()"/>
								</td>
							</tr>
						</table>
					</div>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<c:forEach items="${list}" var="d">
								<tr class="table-back-colorbar" onClick="CheckedObj(this);">
									...
									<td>
										<windrp:getname key="DealerType" value='${d.organModel}' p='f'/>
									</td>
									<td>
										${d.regionName }
									</td>
									...
									<td>
										<fmt:formatNumber value="${d.consumeQuantity }" pattern="#0.###"></fmt:formatNumber>
									</td>
									<td>
										<fmt:formatNumber value="${d.consumeCount }" pattern="#0.###"></fmt:formatNumber>
									</td>
									<td>
										<fmt:formatNumber value="${d.scanedQuantity }" pattern="#0.###"></fmt:formatNumber>
									</td>
									<td>
										<fmt:formatNumber value="${d.scanedCount }" pattern="#0.###"></fmt:formatNumber>
									</td>
									<td>
										${d.billNo }
									</td>
		...
		<form  name="excputform" method="post" action="excPutConsumeDetailReportAction.do">
