						...
						<tr>
							<td>
								<form name="validateContactLog" method="post"
									action="updContactLogAction.do" onSubmit="return ChkValue();">
									<fieldset align="center">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1">
											<tr>
												...
												<td width="10%">
													<input type="hidden" id="objsort" name="objsort" value="${clf.objsort}">
													<windrp:getname key='ObjSort' value='${clf.objsort}' p='f'/>
												</td>
												<td align="right" width="10%">
													<input name="id" type="hidden" id="id" value="${clf.id}">
													<input name="cid" type="hidden" id="cid" value="${clf.cid}">
													对象名称：
												</td>
												<td width="23%">
													<input name="cname" type="text" id="cname"
														value="${clf.cname}" readonly="readonly"><a href="javascript:SelectName();"><img
												...
												<td>
													<input name="linkman" type="text" id="linkman"
														value="${clf.linkman}"><a href="javascript:SelectLinkman();"><img
											...
											<tr>
												...
												<td>
													<windrp:select key="ContactProperty" name="contactproperty" p="n|f"
														value="${clf.contactproperty}" />
												</td>
												<td align="right">
													联系方式：
												</td>
												...
												<td>
													<input name="contactdate" type="text" size="12"
														value="<windrp:dateformat value="${clf.contactdate}" p="yyyy-MM-dd"/>"
											...
											<tr>
												...
												<td colspan="5">
													...
													<br>
													<textarea name="contactcontent" cols="60" style="width: 100%;" rows="5">${clf.contactcontent}</textarea><br>
												...
												<td colspan="5">
													<textarea name="feedback" cols="60" style="width: 100%;" rows="5" id="feedback">${clf.feedback}</textarea><br>
											...
											<tr>
												...
												<td colspan="3">
													<input name="nextcontact" type="text" id="nextcontact"
														...
														value="<windrp:dateformat value="${clf.nextcontact}" p="yyyy-MM-dd"/>" readonly="readonly">
												</td>
												</tr>
												<tr>
												<td align="right">
												...
												<td colspan="5">
													<input name="nextgoal" type="text" id="nextgoal"
														value="${clf.nextgoal}" size="60">
												</td>
											</tr>
										</table>
									</fieldset>
