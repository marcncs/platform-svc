...
<script language="JavaScript">
	...
	function addNew(){
	window.open("../warehouse/toAddOtherIncomeAction.do","","height=650,width=1000,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
	}

	function Update(){
		if(checkid!=""){
		window.open("../warehouse/toUpdOtherIncomeAction.do?ID="+checkid,"","height=650,width=1000,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	...
	function OtherIncomeDetail(){
		if(checkid!=""){
			document.all.submsg.src="otherIncomeDetailAction.do?ID="+checkid;
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	...
	function Del(){
		...
		if(window.confirm("您确认要删除编号为:"+checkid+"的记录吗？如果删除将永远不能恢复!")){
			window.open("../warehouse/delOtherIncomeAction.do?ID="+checkid,"newwindow","height=250,width=500,top=250,left=250,toolbar=no,menubar=no,scrollbars=auto,resizable=no,location=no,status=no");
			}
		}else{
		alert("请选择你要操作的记录!");
		}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">仓库管理>>库存盘点>>盘盈</td>
        </tr>
      </table>
      <form name="search" method="post" action="listOtherIncomeAction.do">
...
<input type="text" name="uname" id="uname" onClick="selectDUW(this,'MakeID',$F('MakeDeptID'),'du')" value="${uname}" readonly></td>
		<td></td>
          ...
          <tr class="table-back"> 
            ...
            <td width="21%"><input name="BeginDate" type="text" id="BeginDate" value="${BeginDate}" readonly size="10" onFocus="javascript:selectDate(this)">
-
  <input name="EndDate" type="text" id="EndDate" value="${EndDate}" readonly size="10" onFocus="javascript:selectDate(this)"></td>
		  ...
		  <tr class="table-back">
		   <td align="right">是否记账：</td>
            ...
            <td width="24%"  ><input type="text" name="KeyWord" value="${KeyWord}"></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr class="title-func-back">			
          ...
          <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"> </td>    	    						
		  <td class="SeparatePage"><pages:pager action="../warehouse/listOtherIncomeAction.do"/></td>				
		</tr>
	 </table>
      </div>
	</td>
	...
	<tr>
      ...
      <div style="width:100%">
        <div id="tabs1">
          <ul>
            <li><a href="javascript:OtherIncomeDetail();"><span>盘盈详情</span></a></li>
          </ul>
        </div>
