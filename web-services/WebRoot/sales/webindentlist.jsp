...
function addNew(){
	window.open("toAddSaleOrderAction.do","","height=650,width=1024,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=yes");
	}

	function Update(){
		if(checkid!=""){
		window.open("../sales/toAuditWebIndentAction.do?ID="+checkid,"newwindow","height=650,width=1024,top=250,left=250,toolbar=no,menubar=no,scrollbars=auto,resizable=no,location=no,status=no");
		}else{
		alert("请选择你要操作的记录!");
		}
	}
	...
	function OrderDetail(){
		if(checkid!=""){
		document.all.submsg.src="../sales/webIndentDetailAction.do?ID="+checkid;
		}else{
		alert("请选择你要操作的记录!");
		}
	}
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  ...
  <tr> 
    <td width="10"><img src="../images/CN/spc.gif" width="10" height="1"></td>
          <td width="772"> 网站订单</td>
          
  </tr>
</table>
<form name="search" method="post" action="listWebIndentAction.do">
...
<input name="EndDate" type="text" onFocus="javascript:selectDate(this)" size="12"></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table-back" onClick="CheckedObj(this,'${s.id}');"> 
            ...
            <td class="${s.isblankout==1?'text2-red':''}">${s.equiporganidname}</td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="48%"><table  border="0" cellpadding="0" cellspacing="0">
              <tr align="center"> 
			   <td width="80"><a href="javascript:Update();">修改</a></td>
          ...
          <tr> 
			...
			<presentation:pagination target="/sales/listWebIndentAction.do"/>	
            </td>
          </tr>
