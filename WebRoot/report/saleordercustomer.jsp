...
function SelectCustomer(){
	...
	function saleOrderDetail(id){
	showModalDialog("../sales/saleOrderDetailAction.do?ID="+id,null,"dialogWidth:20cm;dialogHeight:17cm;center:yes;status:no;scrolling:no;");	
	}
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
		...
		<tr class="table-back">
          ...
          <tr class="table-back"> 
            ...
            <td width="19%"><!--<input name="CID" type="hidden" id="CID" value="${CID}">-->
  ...
  <input name="EndDate" type="text" id="EndDate" value="${EndDate}" onFocus="selectDate(this);"  size="10"></td></tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" id="result">
        <tr class="title-top-lock">
          ...
          <td width="13%" align="center" >省份</td>
          <td width="9%" align="center" >城市</td>
          <td width="12%" align="center" >地区</td>
          <td width="16%"  align="center" >会员名称</td>
          <td width="7%" align="center" >零售单号</td>
          <td width="10%" align="center" >制单机构</td>
          <td width="8%" align="center" >制单人</td>        
		  <td width="11%" align="center" >制单日期</td>        
          <td width="7%" align="center">金额</td>
        </tr>
		...
		<tr class="table-back">
			...
			<td >${s.areasname}</td>
			<td >${s.cname}</td>
          <td align="center" ><a href="#" onClick="saleOrderDetail('${s.id}')">${s.id}</a></td>
          <td >${s.makeorganidname}</td>
          <td >${s.makeidname}</td>       
		   <td >${s.makedate}</td>       
          <td align="right">${s.totalsum}</td>
		</tr>
		</c:forEach>		
      </table>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  <td width="24%" align="center"></td>      
		   <td width="22%" align="right" class="text-orange-heavy">合计: ${allsum}</td>
        </tr>
      </table>
    </td>
  </tr>
...
for (i=1; i<document.getElementById("result").getElementsByTagName("tr").length; i++){
	i%2==0?document.getElementById("result").getElementsByTagName("tr")[i].style.backgroundColor="#f0f0f0":document.getElementById("result").getElementsByTagName("tr")[i].style.backgroundColor="#fff";
}
</script>
</body>
</html>
