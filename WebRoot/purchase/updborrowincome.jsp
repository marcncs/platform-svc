...
function SupperSelect(rowx){
	...
	var p=showModalDialog("toSelectProviderProductAction.do?pid="+pid,null,"dialogWidth:20cm;dialogHeight:16cm;center:yes;status:no;scrolling:no;");
...
function SelectCustomer(){
	showModalDialog("toSelectCustomerAction.do",null,"dialogWidth:16cm;dialogHeight:8.5cm;center:yes;status:no;scrolling:no;");
	document.validateProvide.receiveid.value=getCookie("cid");
	document.validateProvide.receivename.value=getCookie("cname");
}
</script>
</head>
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 修改借入单</td>
        </tr>
      </table>
       <form name="validateProvide" method="post" action="../purchase/updBorrowIncomeAction.do">
	...
	<fieldset align="center"> <legend>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
	  <tr>
	  	<td width="9%"  align="right"><input name="ID" type="hidden" id="ID" value="${pif.id}">
入货仓库：</td>
          <td width="23%"><select name="warehouseid">
            <logic:iterate id="w" name="alw">
              <option value="${w.id}" <c:if test="${w.id==pif.warehouseid}"> selected </c:if>
          ...
          <td width="25%"><select name="warehouseout">
            <logic:iterate id="w" name="alw">
              <option value="${w.id}" <c:if test="${w.id==pif.warehouseout}"> selected </c:if>
                >${w.warehousename}</option>
            </logic:iterate>
          </select></td>
	      <td width="8%" align="right">采购订单号：</td>
	      <td width="25%"><input name="poid" type="text" id="poid" value="${pif.poid}"></td>
	  </tr>
	  <tr>
	    <td  align="right">客户：</td>
	    <td><input name="cid" type="hidden" id="cid" value="${pif.cid}">
          <input name="cname" type="text" id="cname" value="${pif.cname}" size="35">
          <a href="javascript:SelectProvide();"><img src="../images/CN/find.gif" width="18" height="18" border="0"></a></td>
	    <td align="right">客户联系人：</td>
	    <td><input name="plinkman" type="text" id="plinkman" value="${pif.plinkman}"><a href="javascript:SelectLinkman();"><img src="../images/CN/find.gif" width="18" height="18" border="0"></a></td>
	    <td align="right">联系电话：</td>
	    <td><input name="tel" type="text" id="tel" value="${pif.tel}"></td>
	    </tr>
	  <tr>
	    <td  align="right">批次：</td>
	    <td><input name="batch" type="text" id="batch" value="${pif.batch}"></td>
	    <td align="right">预计入库日期：</td>
	    <td><input name="incomedate" type="text" id="incomedate" onFocus="javascript:selectDate(this)" value="${pif.incomedate}"></td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
	    </tr>
	  </table>
