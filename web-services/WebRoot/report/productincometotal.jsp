...
function excput(){
	searchform.target="";
	searchform.action="../report/excPutProductIncomeTotalAction.do";
	searchform.submit();
}
function oncheck(){
	searchform.target="";
	searchform.action="../report/productIncomeTotalAction.do";
	searchform.submit();
}

function print(){
	searchform.target="_blank";
	searchform.action="../report/printProductIncomeTotalAction.do";
	searchform.submit();
  ...
  <tr>
    <td>  <div id="div1"><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>入库>>产成品入库汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="productIncomeTotalAction.do" onSubmit="return oncheck();">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/productIncomeTotalAction.do"/></td>
          </tr>
      </table>
      </div>
