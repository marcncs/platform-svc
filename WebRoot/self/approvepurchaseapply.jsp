...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  ...
  <tr>
    ...
    <td width="772"> 采购申请单详情 </td>
  </tr>
</table>
<table width="100%"  border="0" cellpadding="0" cellspacing="1">
  <tr class="table-back">
    <td width="17%"  align="right">申请日期：</td>
          <td width="33%">${paf.applydate}</td>
  <td width="16%" align="right">预计收货日期：</td>
          <td width="34%">${paf.receivedate}</td>
  </tr>
  <tr class="table-back">
    <td  align="right">是否提交：</td>
          <td>${paf.isrefer}</td>
  <td align="right">审阅状况：</td>
          <td>${paf.approvestatus}</td>
  </tr>
  <tr class="table-back">
  ...
  <tr class="table-back">
    <td  align="right">备注：</td>
          <td colspan="3">${paf.remark}</td>
    </tr>
</table>
<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
  <tr>
    <td width="10"><img src="../images/CN/spc.gif" width="10" height="8"></td>
    <td width="772"> 采购申请单产品列表</td>
  </tr>
</table>
<table width="100%"  border="0" cellpadding="0" cellspacing="1">
...
<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
 ...
 <form name="addform" method="post" action="approvePurchaseApplyAction.do">
<table width="100%"  border="0" cellpadding="0" cellspacing="1">
 
    <tr class="table-back">
      <td  align="right"><input name="applyid" type="hidden" id="applyid" value="${applyid}">
        审阅状态：</td>
      <td>${approvestatus}</td>
    </tr>
    <tr class="table-back">
