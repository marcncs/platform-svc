  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td >报表分析>>出库>>扫描率按产品汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="idcodeScanRateByProductAction.do">
  ...
  <input name="EndDate" type="text" id="EndDate" value="${EndDate}"  
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr class="title-func-back"> 
			...
			<pages:pager action="../report/idcodeScanRateByProductAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="exportIdcodeScanRateByProductAction.do">
