...
<img src="images/print.gif" onClick="javascript:window.print();"></img>
      ...
      <div id="abc">
      <div align="center" class="print_title_style">应收款结算单汇总</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
          <tr align="center" class="title-top-lock">
            ...
            <td width="12%">所属机构</td>
            <td width="16%">制单日期</td>
            <td width="24%">应收款描述</td>
            <td width="10%">应收款金额</td>
            <td width="10%">已收款金额</td>
          </tr>
          <logic:iterate id="s" name="str" >
            <tr class="table-back-colorbar">
              ...
              <td align="right">￥
                <windrp:format p="###,##0.00" value='${s.receivablesum}'/></td>
              <td align="right">￥
                <windrp:format p="###,##0.00" value='${s.alreadysum}'/></td>
            </tr>
          </logic:iterate>
		  </table>
		<table width="100%" cellspacing="1" class="totalsumTable">
          <tr class="back-gray-light">
            ...
            <td align="right" width="10%">${allalreadysum}</td>
          </tr>
      </table>
      </div>
</body>
