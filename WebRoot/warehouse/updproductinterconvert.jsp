...
<form name="validateProvide" method="post" action="updProductInterconvertAction.do">
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          <td width="10"><img src="../images/CN/spc.gif" width="10" height="1"></td>
          <td width="772"> 修改产品互转单</td>
        </tr>
      </table>
	  ...
	  <tr>
	  	<td width="9%"  align="right"><input name="ID" type="hidden" id="ID" value="${smf.id}">
转换日期：</td>
          <td width="25%"><input name="movedate" type="text" id="movedate" onFocus="javascript:selectDate(this)" value="${smf.movedatename}"></td>
          <td width="9%" align="right">转出仓库：</td>
          <td width="24%"><windrp:warehouse name="outwarehouseid" value="${smf.outwarehouseid}"/></td>
	      <td width="10%" align="right">转入仓库：</td>
	      <td width="23%"><select name="inwarehouseid" id="inwarehouseid">
            <option value="">请选择仓库</option>
            <logic:iterate id="iw" name="aliw" >
              <option value="${iw.id}" <c:if test='${iw.id==smf.inwarehouseid}'> selected</c:if>
                >${iw.warehousename}</option>
            </logic:iterate>
          </select></td>
	  </tr>
	  <tr>
	    <td  align="right">原因：</td>
	    <td><input name="movecause" type="text" id="movecause" value="${smf.movecause}" size="40"></td>
	    <td align="right">备注：</td>
	    <td><input name="remark" type="text" id="remark" value="${smf.remark}" size="40"></td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
	    </tr>
	  </table>
        ...
        <logic:iterate id="p" name="als" >
          <tr class="table-back">
            ...
            <td ><input name="productname" type="text" value="${p.productname}" id="productname" size="35" readonly>
              <a href="javascript:SupperSelect('${p.productid}');"></td>
            ...
            <td><input name="batch" type="text" id="batch" value="${p.batch}" size="10"></td>
            <td><a href="#" onMouseOver="ShowSQ(this,'${p.productid}');" onMouseOut="HiddenSQ();"><img src="../images/CN/stock.gif" width="16"  border="0"></a></td>
            <td><input name="quantity" type="text" value="${p.quantity}" id="quantity" size="8" maxlength="8"></td>
            </tr>
