...
var wname="";
var waddr="";
var organ={id:"",oecode:"",organname:"",otel:"",ofax:"",oemail:"",omobile:"",oaddr:"",wid:"",wname:"",waddr:"",pid:"",pidname:""};
function CheckedObj(obj,objid,objoecode,objorganname,objotel,objofax,objoemail,objomobile,objoaddr,objpid,objpidname){
				...
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post"
							action="../keyretailer/selectOrganAction.do?type=${type }">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								...
								<td class="SeparatePage">
									<pages:pager action="../keyretailer/selectOrganAction.do" />
								</td>
							</tr>
						</table>
					</div>
							...
							<table class="sortable" width="100%" border="0" cellpadding="0"
								...
								<logic:iterate id="d" name="dpt">
									<tr align="center" class="table-back-colorbar"
										onClick="CheckedObj(this,'${d.id}','${d.oecode}','${d.organname}','${d.otel}','${d.ofax}','${d.oemail}','${d.omobile}','${d.oaddr}','${d.parentid}','${d.parentidname}');"
										onDblClick="Affirm();">
										<td>
											${d.id}
										</td>
