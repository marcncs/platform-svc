...
function excput(){
		search.target="";
		search.action="../sales/excPutIntegralIByObjAction.do";
		search.submit();
		search.action="listIntegralIByObjAction.do";
	}
	function print(){
		search.target="_blank";
		search.action="../sales/printIntegralIByObjAction.do";
		search.submit();
		search.target="";
		search.action="listIntegralIByObjAction.do";
	}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">收入列表</td>
        </tr>
      </table>
       <form name="search" method="post" action="listIntegralIByObjAction.do">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<td width="50">
          ...
          <td class="SeparatePage"><pages:pager action="../sales/listIntegralIByObjAction.do"/></td>
        </tr>
      </table>
      </div>
