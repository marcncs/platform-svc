  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 生成发货单</td>
        </tr>
      </table>
       <form name="affirmform" method="post" action="../warehouse/makeSaleShipmentBillAction.do">
      <table width="100%" height="57" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td width="32%"><input name="soid" type="hidden" id="soid" value="${soid}"></td>
        </tr>
        <tr>
          <td align="right">&nbsp;</td>
