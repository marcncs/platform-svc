...
this.onload =function onLoadDivHeight(){
	...
	function addNew(){
	popWin("../erp/toAddBillImportConfigAction.do",900,600);
	}
	
	function UpdBillImportConfig(){
		if(checkid>0){
		popWin("../erp/toUpdBillImportConfigAction.do?bicid="+checkid,900,600);
		}else{
		alert("请选择你要操作的记录!");
		}
	...
	function Del(){
		if(checkid>0){
			if ( confirm("你确认要删除编号为:"+checkid+"的用户吗?如果删除将不能恢复!") ){
				popWin2("../erp/delBillImportConfigAction.do?ID="+checkid);
			}
		}else{
			alert("请选择你要操作的记录!");
		}
			...
			<tr>
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post" action="listBillImportConfigAction.do">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								<ws:hasAuth operationName="/erp/toAddBillImportConfigAction.do">
									<td width="50" align="center">
										<a href="javascript:addNew();"><img src="../images/CN/addnew.gif"
												width="16" height="16" border="0" align="absmiddle">&nbsp;新增</a>
									</td>
								</ws:hasAuth>
								<ws:hasAuth operationName="/erp/toUpdBillImportConfigAction.do">
									<td width="1">
										<img src="../images/CN/hline.gif" width="2" height="14">
									</td>
									<td width="50" align="center">
										<a href="javascript:UpdBillImportConfig();"><img
												src="../images/CN/update.gif" width="16" height="16" border="0"
												align="absmiddle">&nbsp;修改</a>
									</td>
								</ws:hasAuth>
								<ws:hasAuth operationName="/erp/delBillImportConfigAction.do">
									<td width="1">
										<img src="../images/CN/hline.gif" width="2" height="14">
									</td>
									<td width="50" align="center">
								...
								<td class="SeparatePage">
									<pages:pager action="../erp/listBillImportConfigAction.do" />
								</td>
