...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
	...
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="../common/selectOrganProductPriceTwoAction.do?OID=${OID}">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr class="title-func-back">
          ...
          <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
          <td class="SeparatePage"><pages:pager action="../common/selectOrganProductPriceTwoAction.do"/></td>
        </tr>
      </table>
	  </div>
	</td>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1" id="ptable">
         ...
         <logic:iterate id="p" name="list" > 
		  <tr align="center" class="table-back-colorbar" > 
            ...
            <td>${p.productname}</td>
            <td>${p.specmode}</td>
            <td><input type="text" name="unitidname" size="6" value="${p.unitidname}" onFocus="selectUnit(this,'${p.productid}','','${OID}','4')"/></td>
            <td align="right"><span id="spanpeddleprice${count}"><windrp:format value="${p.price}"/></span></td>
            <td align="right"><span id="spanprice${count}"><windrp:format value="${p.sprice}"/></span></td>
            <input type="hidden" name="pobj" id="pobj${count}" value="{productid:'${p.productid}',productname:'${p.productname}',specmode:'${p.specmode}',unitid:'${p.unitid }',unitidname:'${p.unitidname}',unitprice:'${p.price}',sunitprice:'${p.sprice }'}">
		  </tr>
