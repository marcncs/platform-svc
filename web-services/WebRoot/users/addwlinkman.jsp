  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      ...
      <tr>
		...
		<form name="validateLinkman" method="post" action="../users/addWLinkManAction.do" onsubmit="return Validator.Validate(this,2)" >
	  ...
	  <tr>
	  	<td width="12%"  align="right"><input name="warehouseid" type="hidden" id="warehouseid" value="${warehouseid}" >
	  	  仓库编号：</td>
