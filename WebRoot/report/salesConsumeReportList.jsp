...
function OutPut() {
	excputform.action = "../report/excPutSalesConsumeReportAction.do?type=${type}";
	excputform.submit();
}
</script>
	</head>
				...
				<td>
					<div id="div1">
						...
						<form name="searchform" method="post"
							action="../report/salesConsumeReportAction.do"
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<c:if test="${prompt=='view'}">
								<ws:hasAuth operationName="/report/excPutSalesConsumeReportAction.do">
									<td width="50">
								...
								<td class="SeparatePage">
									<pages:pager action="../report/salesConsumeReportAction.do"
										onsubmit="formChk()" />
								</td>
							</tr>
						</table>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="1"
							...
							<c:forEach items="${list}" var="d">
								<tr class="table-back-colorbar" onClick="CheckedObj(this);">
									...
									<td>
										<fmt:formatNumber value="${d.pwQuantity }" pattern="#0.###"></fmt:formatNumber>
									</td>
									<td>
										<fmt:formatNumber value="${d.consumeQuantity }" pattern="#0.###"></fmt:formatNumber>
									</td>
									<td>
										<fmt:formatNumber value="${d.owQuantity }" pattern="#0.###"></fmt:formatNumber>
									</td>
								</tr>
							</c:forEach>
