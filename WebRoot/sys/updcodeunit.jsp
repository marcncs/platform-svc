  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 修改标识位规则</td>
        </tr>
      </table>
	  <form name="referform" method="post" action="../sys/updCodeUnitAction.do" onSubmit="return CheckInput();">
	  ...
	  <tr>
          ...
          <td width="21%"><input name="ucode" type="text" id="ucode" size="8" value="${cu.ucode}" readonly><span class="text-red3">*</span></td>
          <td width="13%" align="right">名称：</td>
          <td width="23%"><input name="uname" type="text" id="uname" value="${cu.uname}"></td>
	      <td width="13%" align="right">相应计量单位：</td>
	      <td width="21%"><windrp:select key="CountUnit" name="unitid" value="${cu.unitid}" p="n|d"/></td>
	  </tr>
	  <tr>
	  	<td width="9%" height="20" align="right">备注：</td>
          <td colspan="5"><input name="remark" type="text" id="remark" size="30" value="${cu.remark}"></td>
          </tr>
	  </table>
	</fieldset>
