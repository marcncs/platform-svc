...
this.onload =function onLoadDivHeight(){
	...
	function excput(){
		...
		search.action="../warehouse/excPutStockPileDaysReportAction.do";
		search.submit();
		search.action="../warehouse/listStockPileDaysReportAction.do";
	}
	function print(){
		excputform.target="_blank";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
	...
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="listStockPileDaysReportAction.do" >
    ...
    <td   align="right">产品类别：</td>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<%--<td width="50"><a href="javascript:print();"><img src="../images/CN/print.gif" width="16" height="16"border="0" align="absmiddle">&nbsp;打印</a></td>
			<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>			
		  --%><td class="SeparatePage"><pages:pager action="../warehouse/listStockPileDaysReportAction.do"/></td>							
		</tr>
	   </table>
      </div>
	</td>
	...
	<tr>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table-back-colorbar"  onclick="CheckedObj(this);">
            ...
            <td >${s.stockpile}</td>
            <td>${s.prepareout}</td>
            <td>${s.allstockpile}</td>
            <td>${s.salesAvg}</td>
            <td>${s.stockPileDays}</td>
		    </tr>
