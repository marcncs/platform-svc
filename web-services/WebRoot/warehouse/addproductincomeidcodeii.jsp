  ...
  <tr>
	...
	<tr>
	  ...
	  <tr>
	      ...
	      <td width="9%">&nbsp;</td>
	      <td width="7%" ><!-- <input type="button" value="新增" onClick="formcheck()" ${isaudit==1?"disabled":""}>&nbsp; --><input type="button" name="cancel" value="取消" onClick="window.close();"></td>          
	  </tr>
      ...
      name="submsg" src="../warehouse/listProductIncomeIdcode.do?billid=${billid}&prid=${bbd.productid}&isaudit=${isaudit}&batch=${batch}" frameBorder="0" scrolling="no" onload="setIframeHeight(this)"></IFRAME>  
