  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
	  ...
	  <tr>
	      ...
	      <td width="25%"><input name="tagsubvalue" type="text"  size="50" id="tagsubvalue" value="${br.tagsubvalue}"><span class="style1">*</span></td>
	  </tr>
	   <tr>
	  	<td width="9%" height="20" align="right">状态：</td>
