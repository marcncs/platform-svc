...
<html>
	...
	function OrganWithdrawDetail(){
		if(checkid!=""){
			document.all.submsg.src="../warehouse/detailPlantWithdrawReceiveAction.do?ID="+checkid;
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	function print(){
		if(checkid!=""){
			popWin("../ditch/printPlantWithdrawAction.do?ID="+checkid,900,600);
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	...
	function excput(){
		search.target="";
		search.action="../warehouse/excPutPlantWithdrawReceiveAction.do";
		search.submit();
		search.target="";
		search.action="../warehouse/listPlantWithdrawReceiveAction.do";
	}
	function print(){
		search.target="_blank";
		search.action="../warehouse/printListPlantWithdrawReceiveAction.do";
		search.submit();
		search.target="";
		search.action="../warehouse/listPlantWithdrawReceiveAction.do";
	}
				...
				<td>
					<div id="div1">
						...
						<form name="search" method="post"
							action="../warehouse/listPlantWithdrawReceiveAction.do">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								<ws:hasAuth
									operationName="/warehouse/excPutPlantWithdrawReceiveAction.do">
									<td width="50">
								...
								<ws:hasAuth
									operationName="/warehouse/printListPlantWithdrawReceiveAction.do">
									<td width="50">
								...
								<td class="SeparatePage">
									<pages:pager action="../warehouse/listPlantWithdrawReceiveAction.do" />
								</td>
							</tr>
						</table>
					</div>
					<div id="abc" style="overflow-y: auto; height: 600px;">
						...
						<div style="width: 100%">
							<div id="tabs1">
								<ul>
									<li>
										<a href="javascript:OrganWithdrawDetail();"><span>${menu
												}详情</span> </a>
									</li>
								</ul>
							</div>
