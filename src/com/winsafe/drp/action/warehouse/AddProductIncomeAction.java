...
public class AddProductIncomeAction extends BaseAction {
...
//				wbds.add(pi.getId(), pid.getProductid(), pid.getUnitid(), pid.getQuantity());
			...
			DBUserLog.addUserLog(userid, 7,"产成品入库>>新增产成品入库,编号："+piid);
