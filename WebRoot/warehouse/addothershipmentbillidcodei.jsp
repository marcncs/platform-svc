...
var chebox=null;
  function addRow(bit){ 
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
		...
		d.innerHTML="<input name=\"batch\" type=\"text\" id=\"batch\" maxlength=\"32\" size=\"20\" value='"+bit.batch+"' readonly>";
		e.innerHTML="<input name=\"producedate\" type=\"text\" id=\"producedate\" maxlength=\"32\" value='"+bit.producedate+"' size=\"15\" readonly>";
  ...
  <tr>
	...
	<tr>
	  ...
	  <tr>
	      ...
	      <td width="19%"><input name="addbatch" type="text" id="addbatch" value="${bbd.batch}"  maxlength="32" readonly></td>
		  <td width="9%"  align="right">生产日期：</td>
          <td width="17%"><input name="addproducedate" type="text" id="addproducedate" maxlength="32" readonly></td>
	...
	<form name="validateProvide" method="post" action="addOtherShipmentBillIdcodeiAction.do">
	...
	<input type="hidden" name="pbatch" value="${bbd.batch}">
	...
	<input type="hidden" name="totalquantity" value="${bbd.quantity}">
              ...
              <logic:iterate id="p" name="idcodelist" >
                <tr class="table-back">
                  ...
                  <td><input name="batch" type="text" id="batch" value="${p.batch}" maxlength="32" size="20" readonly></td>
                  <td><input name="producedate" type="text" value="${p.producedate}" maxlength="32" id="producedate" size="15" readonly></td>
