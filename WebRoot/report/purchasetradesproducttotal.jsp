...
function excput(){
	...
	searchform.action="../report/excPutPurchaseTradesProductTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseTradesProductTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseTradesProductTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseTradesProductTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>采购>>采购换货按产品汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="purchaseTradesProductTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            ...
            <td><input name="ProductID" type="hidden" id="ProductID" value="${ProductID}">
              ...
              value="${ProductName}" readonly><a href="javascript:SelectSingleProduct();"><img src="../images/CN/find.gif" align="absmiddle" width="18" height="18" border="0">
              </a></td>
            <td align="right">&nbsp;</td>
            <td>&nbsp;</td>
            <td align="right">&nbsp;</td>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseTradesProductTotalAction.do"/></td>
          </tr>
      </table>
      </div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
        ...
        <tr class="back-gray-light">
          ...
          <td align="right" ><windrp:format p="###,##0.00" value='${sumobj}'/></td>
        </tr>
      </table>
	 </div>
    </td>
...
<form  name="excputform" method="post" action="excPutPurchaseTradesProductTotalAction.do" >
