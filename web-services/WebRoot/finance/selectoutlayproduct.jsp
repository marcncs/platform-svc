...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="search" method="post" action="../finance/selectOutlayProductAction.do">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="table-back" onClick="CheckedObj(this,'${c.id}','${c.productname}');" onDblClick="Affirm();"> 
            <td >${c.id}</td>
            <td>${c.productname}</td>
			 <td>${c.specmode}</td>
          </tr>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%"> <presentation:pagination target="/finance/selectOutlayProductAction.do"/> 
          </td>
        </tr>
      </table>
