...
<html>
	...
	<body>
		<form name="refer" method="post" enctype="multipart/form-data"
			action="../users/importOrganRegionAction.do" 
					...
					<table class="table-detail">
						<tr>
							...
							<td title="点击下载" width="20%" >
								<a href="../common/downloadfile.jsp?filename=templates/机构区域信息维护模板.xls"><img src="../images/CN/beizheng.gif" border="0">模板下载</a>
							</td>
