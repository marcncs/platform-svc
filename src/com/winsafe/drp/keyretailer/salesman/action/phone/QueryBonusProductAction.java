...
public class QueryBonusProductAction extends BaseAction {
	private Logger logger = Logger.getLogger(QueryBonusProductAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			List<Map<String, String>> sBonusAppraise = appSBonusAppraise.getBonusProductList(year, organId, condition,fromOrganId);
