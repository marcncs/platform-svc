...
var pbaid=0;
	...
	function Approve(){
		if(checkid!=""){
			window.open("../purchase/toApprovePurchaseOrderAction.do?ID="+checkid+"&actid="+actid+"&pbaid="+pbaid,"","height=650,width=1000,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
		}else{
			alert("请选择你要操作的记录!");
		}
	}
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 审批采购订单</td>
        </tr>
      </table>
       <form name="search" method="post" action="waitPurchaseOrderAction.do">
...
<input type="text" name="EndDate" onFocus="javascript:selectDate(this)">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table-back" onClick="CheckedObj(this,'${pb.id}','${pb.actid}', ${pb.pbaid});"> 
            <td ><a href="../purchase/purchaseOrderDetailAction.do?ID=${pb.id}">${pb.id}</a></td>
...
<table  border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="58%" align="right"> <presentation:pagination target="/purchase/waitPurchaseOrderAction.do"/>          </td>
        </tr>
      </table></td>
  </tr>
</table>
