...
this.onload =function onLoadDivHeight(){
	...
	function excput(){
		...
		search.action="../warehouse/excPutWaitProductStockAction.do";
		search.submit();
		search.action="../warehouse/listWaitProductStockAction.do";
	}
	function print(){
		excputform.target="_blank";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
	...
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="listWaitProductStockAction.do" >
...
<input type="text" name="wname" id="wname" onClick="selectDUW(this,'WarehouseID',$F('MakeOrganID'),'vw')" value="${wname}" readonly>	
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<%--<td width="50"><a href="javascript:print();"><img src="../images/CN/print.gif" width="16" height="16"border="0" align="absmiddle">&nbsp;打印</a></td>
			<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>			
		  --%><td class="SeparatePage"><pages:pager action="../warehouse/listWaitProductStockAction.do"/></td>							
		</tr>
	   </table>
      </div>
	</td>
...
<%--            <td >${s.productid}</td>--%>
            ...
            <c:if test="${isShowAssistQuantity!=null}">
            <td ><windrp:format value='${s.xnum}'/></td>
              <td ><windrp:format value='${s.scatterNum}'/></td>
              </c:if>
			 <td >${s.date}</td>
			 <td ><a href="javascript:Detail('${s.billno}');"><span>${s.billno}</span></a></td>
		    </tr>
		    <c:set var="incount" value="${incount+s.prepareout}"/>
		    <c:if test="${isShowAssistQuantity!=null}">
			<c:set var="outcount" value="${outcount+s.xnum}"/>
			<c:set var="outcountS" value="${outcountS+s.scatterNum}"/>
			</c:if>
