...
function addNew(){
	...
	popWin("../keyretailer/toAddSCustomerAreaAction.do?pid=${pid}",1000,650);
}

function Del(){
		if(checkid!=""){
			if ( confirm("你确认要删除编号为:"+checkid+"的设置吗?") ){
				popWin2("../keyretailer/delSCustomerAreaAction.do?id="+checkid);
			}
		}else{
			alert("请选择你要操作的记录!");
		}
...
function Import(){ 
  	popWin("../keyretailer/toImportSCustomerAreaAction.do",500,300);
}
function OutPut(){
	search.target="";
	search.action="../keyretailer/exportSCustomerAreaAction.do";
	search.submit();
	search.action="../keyretailer/listSCustomerAreaAction.do";
}
</script>
  </head>
			...
			<tr>
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post" action="listSCustomerAreaAction.do">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody><tr class="title-func-back">
								<ws:hasAuth operationName="/keyretailer/toAddSCustomerAreaAction.do">
									<td width="50">
								...
								<ws:hasAuth operationName="/keyretailer/delSCustomerAreaAction.do">
								<td width="50">
								...
								<ws:hasAuth operationName="/keyretailer/exportSCustomerAreaAction.do">
								<td width="50">
								...
								<ws:hasAuth operationName="/keyretailer/toImportSCustomerAreaAction.do">
								<td width="50">
				...
				<td>
					...
					<FORM METHOD="POST" name="listform" ACTION="">
						<table class="sortable" width="100%" border="0" cellpadding="0"
							...
							<logic:iterate id="pj" name="sCustomerAreas">
