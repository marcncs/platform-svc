  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="table-back" onClick="CheckedObj(this,${p.userid},'${p.realname}');" onDblClick="Affirm();"> 
            <td height="20">${p.userid}</td>
            <td>${p.realname}</td>
            <td>${p.sexname}</td>
          </tr>
          </logic:iterate> 
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%"> <presentation:pagination target="/sys/selectUsersAction.do"/> 
          </td>
        </tr>
      </table>
