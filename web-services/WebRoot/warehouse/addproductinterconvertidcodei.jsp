  ...
  <tr>
	...
	<tr>
	  ...
	  <tr>
	      ...
	      <td width="19%"><input name="addbatch" type="text" id="addbatch" value="${bbd.batch}" ${isbatch==1?"":"readonly"} maxlength="32"></td>
	...
	<form name="validateProvide" method="post" action="addProductInterconvertIdcodeiAction.do">
