...
<html>
	<head>
		...
		function OutPut() {
			excputform.action = "../report/excputInventoryDetailReportAction.do?type=${type}";
			excputform.submit();
		}
				...
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post"
							action="inventoryDetailReportAction.do" onsubmit="return formChk();">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								...
								<ws:hasAuth operationName="/report/excputInventoryDetailReportAction.do">
									...
									<td class="SeparatePage">
										<pages:pager action="../report/inventoryDetailReportAction.do" onsubmit="formChk()"/>
									</td>
								</tr>
							</tbody>
						</table>
...
<form  name="excputform" method="post" action="excputInventoryDetailReportAction.do">
