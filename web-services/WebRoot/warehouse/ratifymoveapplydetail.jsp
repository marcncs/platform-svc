...
<html>
	...
	function Ratify(smid) {
		popWin("../warehouse/toRatifyMoveApplyAction.do?AAID=" + smid, 1000,
				650);
	}

	/**function CancelRatify(smid) {
		popWin2("../warehouse/cancelRatifyMoveApplyAction.do?AAID=" + smid);
	}**/
				...
				<td>
							...
							<td width="364" align="right">
								<table width="180" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="60" align="center">
											<c:if test="${smf.canAudit==true}">
												<input type="button" name="ratify" id="ratify" value="审核"
														onclick="javascript:Ratify('${smf.id}');" />
											</c:if>
										</td>
			 	 ...
			 	 <c:otherwise>
			 	 	审批不通过 
									...
									<windrp:getname key='YesOrNo' value='${smf.isratify}' p='f' />
								--></td>
							</tr>
							<tr>
								<td align="right">
