    ...
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
          ...
          <tr class="table-back"> 		  	
		   <td width="10%" align="right">产品类别：</td>
            <td width="15%"><select name="KeyWordLeft" id="KeyWordLeft">
			 ...
			 <td width="12%"  align="right">品牌：</td>
            <td width="9%" >${brand}</td>
            <td width="11%"  align="right">关键字：</td>
            <td width="43%" ><input type="text" name="KeyWord">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%" align="right"> <presentation:pagination target="/sales/selectProductStockpileAction.do?pid=${pid}"/>          </td>
        </tr>
      </table>
