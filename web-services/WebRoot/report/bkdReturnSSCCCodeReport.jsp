...
<html>
	<head>
		...
		function OutPut() {
			excputform.action = "../report/exportBkdReturnSSCCCodeReportAction.do";
			excputform.submit();
		}
				...
				<td>
					<div id="bodydiv">
						...
						<form name="search" method="post"
							action="bkdReturnSSCCCodeReportAction.do" onsubmit="return formChk();">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody>
								...
								<ws:hasAuth operationName="/report/bkdReturnSSCCCodeReportAction.do">
									<td width="50">
									...
									<td class="SeparatePage">
										<pages:pager action="../report/bkdReturnSSCCCodeReportAction.do" onsubmit="formChk()"/>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<FORM METHOD="POST" name="listform" ACTION="">
							<table class="sortable" width="200%" border="0" cellpadding="0"
								...
								<tr align="center" class="title-top">
										...
										<td>
										  	退货单号<br>Sales Return Order
										</td>
										<td>
										  	退货时间<br>Sales Return Date
										</td>
										<td>
...
<form  name="excputform" method="post" action="exportBkdReturnSSCCCodeReportAction.do">
