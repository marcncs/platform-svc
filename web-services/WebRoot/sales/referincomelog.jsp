...
<script language="JavaScript">
	...
	function savespeed(){
		...
		f1.action = "referIncomeLogAction.do"; 
			//alert(str);
		f1.submit();
	}
...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
	...
	<form name="f1" method="post" action="../sales/referIncomeLogAction.do">
    ...
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          <td width="10"><img src="../images/CN/spc.gif" width="10" height="1"></td>
                  <td width="772"> 提交收款单 
                    <input name="ilid" type="hidden" id="ilid" value="${ilid}">
  ...
  <tr>
          <td align="center"><input type="submit" value="确定" onClick="savespeed();">&nbsp;&nbsp;
