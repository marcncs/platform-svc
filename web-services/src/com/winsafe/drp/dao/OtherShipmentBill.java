...
public class OtherShipmentBill implements Serializable {
    ...
    /** default constructor */
    public OtherShipmentBill() {
    }

    /** minimal constructor */
    public OtherShipmentBill(String id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof OtherShipmentBill) ) return false;
        OtherShipmentBill castOther = (OtherShipmentBill) other;
