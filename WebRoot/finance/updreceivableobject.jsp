...
<script language="javascript">
	function SelectCustomer(){
		...
		if(os==0){
		showModalDialog("toSelectUsersAction.do",null,"dialogWidth:16cm;dialogHeight:8.5cm;center:yes;status:no;scrolling:no;");
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      <tr>
        ...
        <td width="772"> 修改应收款对象</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td>
	<form name="validateCustomer" method="post" action="updReceivableObjectAction.do" onSubmit="return Check();">
	<fieldset align="center"> <legend>
	  ...
	  <tr>
	  	<td width="18%"  align="right"><input name="id" type="hidden" id="id" value="${rof.id}">
付款对象类型：</td>
          <td width="26%"><select name="objectsort" onChange="Clear();">
          ...
          <td width="15%" align="right">付款方：</td>
          <td width="41%"><input name="cid" type="hidden" id="cid" value="${rof.payerid}">
            <input name="cname" type="text" id="cname" value="${rof.payeridname}" size="50">
