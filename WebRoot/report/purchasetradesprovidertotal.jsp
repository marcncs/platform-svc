...
function excput(){
	...
	searchform.action="../report/excPutPurchaseTradesProviderTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseTradesProviderTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseTradesProviderTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseTradesProviderTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>采购>>采购换货按供应商汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="purchaseTradesProviderTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            ...
            <td><input name="ProvideID" type="hidden" id="ProvideID" value="${ProvideID}" >
              <input id="ProvideName" name="ProvideName" type="text" value="${ProvideName}" readonly><a href="javascript:SelectProvide();"><img src="../images/CN/find.gif" align="absmiddle" width="18" height="18" border="0">
              </a></td>
            <td align="right">&nbsp;</td>
            <td>&nbsp;</td>
            <td align="right">&nbsp;</td>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseTradesProviderTotalAction.do"/></td>
          </tr>
      </table>
      </div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
        ...
        <c:set var="totalsum" value="${totalsum+p.quantity }"/>
		</c:forEach> 
		</table>
...
<form  name="excputform" method="post" action="excPutPurchaseTradesProviderTotalAction.do" >
<input type="hidden" name="MakeOrganID" id ="MakeOrganID" value="${MakeOrganID}">
<input type="hidden" name="MakeDeptID" id ="MakeDeptID" value="${MakeDeptID}">
<input type="hidden" name="ProvideName" id ="ProvideName" value="${ProvideName}">
