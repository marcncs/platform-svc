...
function SelectLinkman(){
		var inorganid=document.searchform.POrganID.value;
		if(inorganid==null||inorganid=="")
		{
			...
			document.searchform.PLinkman.value=lk.lname;
			var tel = lk.ltel;
			if(tel==""){
				tel=lk.mobile;
			}
...
function SelectOrgan2(){
		...
		if ( p==undefined){return;}
			...
			document.searchform.POrganIDName.value=p.organname;
	}
function excput(){
	excputform.submit();
}
function print(){
	...
	excputform.action="../report/printOrganWithdrawOrganTotalAction.do";
	excputform.submit();
	excputform.target="";
	excputform.action="../report/excPutOrganWithdrawOrganTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td >报表分析>>渠道>>渠道退货按机构汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="organWithdrawOrganTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="10%" align="right">供货机构：</td>
            ...
            <input name="POrganIDName" type="text" id="POrganIDName" size="30" value="${POrganIDName}"
            ...
            <td width="20%"><input name="BeginDate2" type="text" id="BeginDate2" value="${BeginDate}"  onFocus="selectDate(this);" 
             size="10" readonly="readonly">
-
  <input name="EndDate2" type="text" id="EndDate2" value="${EndDate}"  onFocus="selectDate(this);" 
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/organWithdrawOrganTotalAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutOrganWithdrawOrganTotalAction.do" >
