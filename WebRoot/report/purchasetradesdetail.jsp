...
function excput(){
	...
	searchform.action="../report/excPutPurchaseTradesDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseTradesDetailAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseTradesDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseTradesDetailAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>采购>>采购换货明细</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="purchaseTradesDetailAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseTradesDetailAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutPurchaseTradesDetailAction.do" >
