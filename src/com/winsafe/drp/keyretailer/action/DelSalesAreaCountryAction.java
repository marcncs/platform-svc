...
public class DelSalesAreaCountryAction extends BaseAction {
	private static Logger logger = Logger.getLogger(DelSalesAreaCountryAction.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			appSalesAreaCountry.delSalesAreaCountryById(id);
