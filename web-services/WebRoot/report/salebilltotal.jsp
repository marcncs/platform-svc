...
function excput(){
	...
	searchform.action="../report/excPutSaleBillTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/saleBillTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printSaleBillTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/saleBillTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>零售>>零售按单据汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="saleBillTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/saleBillTotalAction.do"/></td>
          </tr>
      </table>
      </div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
        ...
        <tr class="table-back-colorbar">
          ...
          <td ss><windrp:getname key="organ" p="d" value="${p.equiporganid}"/></td>
...
<form  name="excputform" method="post" action="excPutSaleBillTotalAction.do" >
