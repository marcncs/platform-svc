...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="validateProvide" method="post" action="addRetailAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
	  <tr>
	  	<td width="11%"  align="right"><input name="cid" type="hidden" id="cid" >
	  	  客户名称：</td>
          <td width="23%"><input name="cname" type="text" id="cname">
          ...
          <td width="22%"><input name="receiveman" type="text" id="receiveman">
	  ...
	  <tr>
	    ...
	    <td  colspan="3"><input name="transportaddr" type="text" id="transportaddr" size="50"></td>
	    </tr>
	  </table>
</fieldset>
