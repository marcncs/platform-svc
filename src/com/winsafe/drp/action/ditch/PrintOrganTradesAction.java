...
public class PrintOrganTradesAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			String showstr = request.getParameter("isshow");
			boolean isshow = showstr.equals("1") ? true : false;
			parameters.put("isshow", isshow);

			Organ porgan = os.getOrganByID(ar.getPorganid());
			parameters.put("billtype", "Channel/Distributors’ SWAP 渠道换货单");
