...
<script language="JavaScript">
	...
	function ReceiveIncomeDetail(){
		if(checkid!=""){
			document.all.submsg.src="receiveIncomeDetailAction.do?ID="+checkid;
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	...
	function UploadIdcode(){
		popWin("../scanner/toUploadReceiveIncomeIdcodeAction.do?billsort=20", 500, 250);
	}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 仓库管理&gt;&gt;入库&gt;&gt;经销商签收入库</td>
        </tr>
      </table>
      <form name="search" method="post" action="listReceiveIncomeAction.do">
        ...
        <tr class="title-func-back">
         <%--
          ...
          <td width="50"><a href="javascript:excput();"><img src="../images/CN/outputExcel.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;导出</a></td>
			...
			<td width="50" ><a href="javascript:UploadIdcode();"><img src="../images/CN/upload.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;上传</a></td>
          <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
          <td class="SeparatePage"><pages:pager action="../warehouse/listReceiveIncomeAction.do"/></td>
        </tr>
      </table>
      </div>
	</td>
    ...
    <!--    <td  align="center" >制单部门</td>--> 
      ...
      <br>
       <div style="width:100%">
        <div id="tabs1">
          <ul>
            <li><a href="javascript:ReceiveIncomeDetail();"><span>经销商签收入库详情</span></a></li>
          </ul>
        </div>
