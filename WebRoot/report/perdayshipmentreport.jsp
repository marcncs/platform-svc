...
var e=$F("EndDate");
if(obj=="c"){
document.all.chartmsg.src="perDayShipmentCountBarAction.do?b="+b+"&e="+e;
}else if(obj=="s"){
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 零售出库排名</td>
        </tr>
      </table>
        <form name="searchform" method="post" action="perDayShipmentReportAction.do">
...
-
  ...
  <input type="submit" name="Submit" value="查询"></td>
	  ...
	  <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="38%">&nbsp;</td>
          <td width="62%" align="right"><presentation:pagination target="/report/perDayShipmentReportAction.do"/></td>
        </tr>
      </table>
