			...
			<tr>
				<td>
					...
					<form name="referForm" method="post"
							action="../aftersale/updPurchaseWithdrawAction.do"
									...
									<table width="100%" border="0" cellpadding="0" cellspacing="1">
										<tr>
											<td width="9%" align="right">
												<input name="pid" type="hidden" id="pid" value="${sof.pid}">
												供应商：
											</td>
											<td width="21%">
												<input name="pname" type="text" id="pname" dataType="Require" msg="必须录入供应商!"
													value="${sof.pname}" readonly="readonly"><a href="#"><img
											...
											<td width="23%">
												<input name="plinkman" type="text" id="plinkman" dataType="Require" msg="必须录入联系人!"
													value="${sof.plinkman}" readonly><a href="javascript:SelectLinkman();"><img
														src="../images/CN/find.gif" width="18" height="18"
														 align="absmiddle" border="0"> </a>
														 <span class="STYLE1">*</span>
											</td>
										...
										<tr>
											...
											<td>
												<select name="warehouseid">
													<logic:iterate id="w" name="alw">
														<option value="${w.id}" ${w.id==sof.warehouseid?"selected":""}>
															${w.warehousename}
														</option>
													</logic:iterate>
												</select>
											...
											<td>
												<input name="withdrawcause" type="text" id="withdrawcause"
													size="50" value="${sof.withdrawcause}" maxlength="80">
											</td>
											<td align="right">&nbsp;
								...
								<table width="100%" id="dbtable" border="0" cellpadding="0"
									...
									<logic:iterate id="p" name="als">
										<tr class="table-back">
											...
											<td>
												<input name="unitprice" type="text" value="${p.unitprice}"
											...
											<td>
												<input name="subsum" type="text" value="${p.subsum}"
													id="subsum" size="10" maxlength="10">
											</td>
										</tr>
									...
									<tr align="center" class="table-back">
										...
										<td width="15%">
											<input name="totalsum" type="text" id="totalsum" size="10"
												maxlength="10" value="${sof.totalsum}">
										</td>
									</tr>
								</table>
							</td>
