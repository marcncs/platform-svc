...
function OutPut() {
	excputform.action = "../report/excputStockShortageAlertReportAction.do";
	excputform.submit();
}
...
this.onload =function onLoadDivHeight(){
	...
	<body>
				...
				<td>
					<div id="div1">
						...
						<form name="searchform" method="post"
							action="stockShortageAlertReportAction.do" onSubmit="showloading();">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr class="table-back">
									...
									<td>
										<input name="stockpile" type="text" id="stockpile" value="${stockpile}"
											maxlength="60">
									</td>
									<td colspan="3">
										&nbsp;
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
								...
								<ws:hasAuth operationName="/report/excputStockShortageAlertReportAction.do">
									<td width="50">
								...
								<td class="SeparatePage">
									<c:if test="${prompt=='view'}">
										<pages:pager action="../report/stockShortageAlertReportAction.do"
		...
		<form name="excputform" method="post"
			action="excputStockShortageAlertReportAction.do">
			...
			<input type="hidden" name="stockpile" id="stockpile" value="${stockpile}">
