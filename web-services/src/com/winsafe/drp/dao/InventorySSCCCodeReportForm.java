...
public class InventorySSCCCodeReportForm {
	...
	private Double sUnitQuantity;
	private Integer countUnit;
	private Double countUnitQuantity;
	...
	public void setInRegionName(String inRegionName) {
	...
	public String getBillNccode() {
		return billNccode;
	}
	public void setBillNccode(String billNccode) {
		this.billNccode = billNccode;
	}
	...
	public Double getsUnitQuantity() {
		return sUnitQuantity;
	}
	public void setsUnitQuantity(Double sUnitQuantity) {
	...
	public Double getCountUnitQuantity() {
		return countUnitQuantity;
	}
	public void setCountUnitQuantity(Double countUnitQuantity) {
		this.countUnitQuantity = countUnitQuantity;
	}
