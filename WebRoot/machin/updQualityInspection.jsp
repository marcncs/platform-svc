...
<html>
	...
	<body>
		<form name="refer" method="post" enctype="multipart/form-data"
			action="../machin/updQualityInspectionAction.do"
			...
			<fieldset style="text-align: center;">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1">
					<tr>
						...
						<td>
							<input type="text" name="mCode" id="mCode" value="${qi.mCode}"
								dataType="Require" msg="物料号不能为空!" readonly size="30">
					...
					<tr>
						...
						<td>
							<input type="text" name="specmode" id="specmode"
						...
						<td>
							<input type="text" name="batch" id="batch" value="${qi.batch}"
								dataType="Require" msg="批次不能为空!">
							<span class="STYLE1">*</span>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" name="inspector" id="inspector"
								value="${qi.inspector}" dataType="Require" msg="检验人不能为空!">
							<span class="STYLE1">*</span>
						</td>
						<td align="right">
							检验日期：
						...
						<td>
							<input name="inspectDate" type="text" id="inspectDate"
								onFocus="javascript:selectDate(this)" value="${idate}"
								readonly="readonly">
							<span class="STYLE1">*</span>
						</td>
					</tr>
					<tr>
						...
						<td>
							<windrp:select key="YesOrNo" name="isQualified"
								value="${qi.isQualified}" p="y|f" />
						</td>
						<td align="right">
							检验报告：
						</td>
