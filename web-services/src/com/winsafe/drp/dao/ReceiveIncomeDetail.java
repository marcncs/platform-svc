...
public class ReceiveIncomeDetail extends ActionForm implements Serializable {
	...
	/** full constructor */
    public ReceiveIncomeDetail(Integer id, String piid, String productid, String productname, String specmode, Integer unitid, Double quantity,String nccode) {
        this.id = id;
        this.piid = piid;
    ...
    /** default constructor */
    public ReceiveIncomeDetail() {
    }

    /** minimal constructor */
    public ReceiveIncomeDetail(Integer id, String piid, String productid, Integer unitid) {
        this.id = id;
        this.piid = piid;
        this.productid = productid;
        this.unitid = unitid;
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ReceiveIncomeDetail) ) return false;
        ReceiveIncomeDetail castOther = (ReceiveIncomeDetail) other;
