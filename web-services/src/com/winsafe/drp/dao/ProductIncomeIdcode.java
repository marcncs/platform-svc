...
public class ProductIncomeIdcode implements Serializable {
    ...
    /** full constructor */
    public ProductIncomeIdcode(Long id, String piid, String productid, Integer isidcode, String warehousebit, String batch, String producedate, String validate, Integer unitid, Double quantity, String startno, String endno, String idcode,String nccode) {
        this.id = id;
        this.piid = piid;
    ...
    /** default constructor */
    public ProductIncomeIdcode() {
    }

    /** minimal constructor */
    public ProductIncomeIdcode(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ProductIncomeIdcode) ) return false;
        ProductIncomeIdcode castOther = (ProductIncomeIdcode) other;
