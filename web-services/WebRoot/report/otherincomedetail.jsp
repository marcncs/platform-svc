...
function excput(){
	...
	searchform.action="../report/excPutOtherIncomeDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/otherIncomeDetailAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printOtherIncomeDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/otherIncomeDetailAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>盘点>>盘盈明细</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="otherIncomeDetailAction.do">
     ...
     <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/otherIncomeDetailAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutOtherIncomeDetailAction.do" >
