...
public class DrawShipmentBill extends ActionForm implements Serializable {
    ...
    /** default constructor */
    public DrawShipmentBill() {
    }

    /** minimal constructor */
    public DrawShipmentBill(String id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof DrawShipmentBill) ) return false;
        DrawShipmentBill castOther = (DrawShipmentBill) other;
