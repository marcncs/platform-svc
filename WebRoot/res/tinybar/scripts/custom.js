...
$(document).ready(function() {
	...
	$("#preloader").delay(100).fadeOut("medium"); // will fade out the white DIV that covers the website.
});

$(document).ready(function() {
    
    //Remove 300ms lag set by -webkit-browsers     
	//TODO 该处影响点击按钮选择图片的功能，所以暂时去掉
	...
	window.onload = function(){
		//modify by wangjian
		if (document.getElementById("generate-pie-chart")) {
		...
		if (document.getElementById("generate-bar-chart")) {
