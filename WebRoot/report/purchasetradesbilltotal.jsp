...
function SelectOrgan(){
	...
	if ( p==undefined){return;}
		...
		document.searchform.MakeDeptID.value="";
		document.searchform.deptname.value="";
}
function excput(){
	searchform.target="_blank";
	searchform.action="../report/excPutPurchaseTradesBillTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseTradesBillTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseTradesBillTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseTradesBillTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>采购>>采购换货按单据汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="purchaseTradesBillTotalAction.do">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseTradesBillTotalAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutPurchaseTradesBillTotalAction.do" >
