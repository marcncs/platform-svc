...
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#BFC0C1">
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        <td>
		<form name="referForm" method="post" action="addPaymentApplyAction.do" >
	  ...
	  <tr>
          ...
          <td width="26%"><input name="pid" type="hidden" id="pid">
            <input name="pname" type="text" id="pname" size="35" readonly>
	  ...
	  <tr>
	    ...
	    <td><input name="totalsum" type="text" id="totalsum"></td>
	    </tr>
	  </table>
	</fieldset>
