  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      <tr>
        ...
        <td width="772"> 修改序号重置</td>
      </tr>
    </table>
        <form action="updIdcodeResetAction.do" method="post"  name="repositoryForm" onSubmit="return formChk();">
		<input type="hidden" name="id" value="${r.id}">
         <fieldset align="center">  <legend> 
            ...
            <tr>
              ...
              <td width="93%"><textarea name="memo" cols="150" rows="4" id="memo">${r.memo}</textarea></td>
              </tr>
			  </table>
		  </fieldset>
            ...
            <tr class="table-back">
                ...
                <td><input name="productid" type="text" id="productid" value="${p.productid}" size="12" readonly></td>
				...
				<td><input name="quantity" type="text" value="${p.quantity}" id="quantity" size="10"></td>    
			</tr>
