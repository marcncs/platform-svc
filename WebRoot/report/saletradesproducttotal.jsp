...
function print(){
	...
	excputform.action="../report/printSaleTradesProductTotalAction.do";
	excputform.submit();
	excputform.target="";
	excputform.action="../report/excPutSaleTradesProductTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>零售>>零售换货按产品汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="saleTradesProductTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/saleTradesProductTotalAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutSaleTradesProductTotalAction.do">
