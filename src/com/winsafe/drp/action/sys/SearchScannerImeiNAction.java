...
public class SearchScannerImeiNAction extends BaseAction{
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if(null != appVersion && !"".equals(appVersion)){
				...
				where += " and f.appVersion like '%"+appVersion+"%' ";
			}
			...
			if(null != scannerImeiN && !"".equals(scannerImeiN)){
				...
				where += " and f.scannerImeiN like '%"+scannerImeiN+"%' ";
			}
			//获取采集器信息
