...
function getOrganLinkmanBycid(objcid){
	...
	function SelectOrgan(){
		...
		if ( p==undefined){return;}
			var oldOrgan = document.referForm.inorganid.value;
	...
	function ChkValue(){
		...
		if(boxnums.length>=1){
			for(var i = 0; i<boxnums.length ; i++){
				if(boxnums[i].value==0&&scatternums[i].value==0){
					alert("产品数量不能为0");
					return false;
	...
	<div id="sq">
		<table width="100%" height="80" border="0" cellpadding="0"
			...
			<tr>
				<td width="45%" height="32" class="title-back">
					仓库
				</td>
	...
	<body style="overflow: auto;">
		<form name="referForm" id="referForm" method="post" action="addStockMoveAction.do"
						...
						<fieldset align="center">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1">
								<tr>
									...
									<td>
										<input name="inorganid" type="hidden" id="inorganid" value="${MakeOrganID}">
										<input name="oname" type="text" id="oname" size="30" value="${oname}"
											dataType="Require" msg="必须录入转入机构!" readonly>
								...
								<tr>
									...
									<td width="24%">
										...
										<input type="text" name="owname" id="owname"
											onClick="selectDUW(this,'outwarehouseid',$F('inorganid'),'rw','')"
								...
								<tr>
									...
									<td>
										<input type="text" id="olinkman" name="olinkman" value="${olinkman}"
									...
									<td>
										<input type="text" id="otel" name="otel" value="${otel}"
								...
								<tr>
									...
									<td colspan="3">
										<input type="text" name="transportaddr" id="transportaddr" 
											maxlength="100" size="60" dataType="Require" msg="必须录入收货地址!">
										<span class="STYLE1">*</span>
									</td>
								</tr>
								<tr>
									...
									<td colspan="5">
										<textarea name="movecause" cols="100" style="width: 100%"
											...
											msg="调拨原因必须在256个字之内" require="false"></textarea>
										<br>
										<span class="td-blankout">(调拨不能超过256个字符!)</span>
									</td>
								</tr>
