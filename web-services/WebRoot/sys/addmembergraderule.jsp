  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增会员级别晋级规则</td>
        </tr>
      </table>
	  <form name="mgrform" method="post" action="../sys/addMemberGradeRuleAction.do" onSubmit="return ChkValue();">
...
首次订单金额：</td>
          <td width="25%"><input name="startprice" type="text" id="startprice" size="8" onKeyPress="KeyPress(this)" maxlength="10">~<input name="endprice" type="text" id="endprice" size="8" onKeyPress="KeyPress(this)" maxlength="10">元
            <font color="#FF0000">*</font></td> 
			<td width="7%" height="20" align="right">积分：</td>
          <td width="25%"><input name="startintegral" type="text" id="startintegral" size="8" onKeyPress="KeyPress(this)" maxlength="10">~<input name="endintegral" type="text" id="endintegral" size="8" onKeyPress="KeyPress(this)" maxlength="10">
            /年
            <font color="#FF0000">*</font></td>       
...
会员级别：</td>
          <td width="20%"><select name="mgid">
                      <c:forEach var="mg" items="${mglist}">
                        <option value="${mg.id}">${mg.gradename}</option>
                      </c:forEach>
                    </select>
            <font color="#FF0000">*</font></td>         
	  </tr>
