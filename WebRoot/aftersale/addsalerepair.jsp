  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增零售返修</td>
        </tr>
      </table>
      <form name="validateProvide" method="post" action="../aftersale/addSaleRepairAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
	  	<td width="9%"  align="right"><input name="cid" type="hidden" id="cid" value="${cid}">
	  	  客户名称：</td>
          <td width="21%"><input name="cname" type="text" id="cname" value="${cname}">
