...
function excput(){
	...
	searchform.action="../report/excPutOrganTradesProductTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/organTradesProductTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printOrganTradesProductTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/organTradesProductTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">报表分析>>渠道>>渠道换货按产品汇总</td>
        </tr>
      </table>
        <form name="searchform" method="post" action="organTradesProductTotalAction.do">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr class="title-func-back"> 
			...
			<pages:pager action="../report/organTradesProductTotalAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutOrganTradesProductTotalAction.do">
