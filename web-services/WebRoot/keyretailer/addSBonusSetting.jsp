			...
			<tr>
				<td>
					...
					<form name="validateProvide" method="post" id="validateProvide"
						action="../keyretailer/addSBonusSettingAction.do"
									...
									<fieldset align="center">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1">
											<tr>
												...
												<td>
													<input id="productName" name="productName"
														value="${productName}" readonly dataType="Require" msg="请选择产品名称!">
											...
											<tr>
												...
												<td width="23%">
													<input type="text" name="bonusPoint" id="bonusPoint"
														value="${bonusPoint}" onkeyup="checkNumber(this)" dataType="Require" msg="请输入积分数量!"><span class="style1">*</span>
												</td>
												<td align="right">
													计量单位数量：
												</td>
												<td>
													<input type="text" name="amount" id="amount"
														value="${amount}" onkeyup="checkNumber(this)" dataType="Require" msg="请输入计量单位数量!">
													<span id="unitName"></span><span class="style1">*</span>
												</td>
												<td align="right">
													账户类型：
												</td>
												<td>
													<windrp:select key="AccountType" name="accountType" p="n|f" />
												</td>
											...
											<tr>
												...
												<td width="23%">
													<windrp:select key="YesOrNo" name="activeFlag" value="1" p="n|f" />
												</td>
												<td align="right">
												</td>
												<td>
