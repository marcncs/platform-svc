			...
			<tr>
				<td>
					...
					<form name="validateProvide" method="post" id="validateProvide"
						action="../keyretailer/addSBonusTargetAction.do"
								...
								<td width="9%" align="right">
												...
												<td width="23%">
													<input id="year" name="year"
														value="${year}"  dataType="Require" msg="请填写年度"><span class="style1">*</span>
												</td>
											</tr>
											<tr>
												<td align="right">
												...
												<td>
													...
													<input type="text"  name="specshow" id="specshow"
														value="${spec}" readonly dataType="Require" msg="请选择产品规格!"><span class="style1">*</span>
												</td>
												<td align="right">目标数量：</td>
												<td><input id="targetAmount" name="targetAmount"
														value="${targetAmount}"  dataType="Require" msg="请填写目标数量"><span class="style1">*</span>
												</td>
											</tr>
										</table>
									</fieldset>
