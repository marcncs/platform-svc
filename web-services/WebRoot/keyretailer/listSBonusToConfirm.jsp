					...
					<div id="bodydiv">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody><tr class="title-func-back">
								<ws:hasAuth operationName="/keyretailer/toConfirmSBonusAction.do">
								<td width="50" align="center">
									<a href="javascript:comSBonus();"><img
								...
								<ws:hasAuth operationName="/keyretailer/exputAddSBonusAppraiseSettingAction.do">
								<td width="50">
						...
						<table class="sortable" width="100%" border="0" cellpadding="0"
							...
							<logic:iterate id="pj" name="sBonusAppraises">
								<tr align="left" class="table-back-colorbar"
									...
									<td>
										<fmt:formatNumber value="${pj.curbonus}" pattern="###,##0.0"></fmt:formatNumber>
									</td>
									<td>
										${pj.completerate}%
									</td>
									...
									<td>
										<windrp:getname key='YesOrNo' value='${pj.iscomplete}' p='f' />
									</td>
								</tr>
							</logic:iterate>
						</table>
