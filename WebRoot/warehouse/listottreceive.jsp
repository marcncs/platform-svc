...
<html>
	...
	function OrganTradesDetail(){
		if(checkid!=""){
			document.all.submsg.src="../warehouse/detailOrganTradesTReceiveAction.do?ID="+checkid+"&IsAudit=${IsAudit}";
		}else{
			alert("请选择你要操作的记录!");
		}
	}
	...
	function UploadIdcode(){
		popWin("../common/toUploadIdcodeAction.do?billsort=10", 500, 250);
	}
	
	function DownTxt(){
		excputform.action="txtPurOrganTradesTAction.do";
		excputform.submit();
	}
		function excput(){
		search.target="";
		search.action="../warehouse/excPutOrganTradesTReceiveAction.do";
		search.submit();
		search.target="";
		search.action="../warehouse/listOrganTradesTReceiveAction.do";
	}
	function print(){
		search.target="_blank";
		search.action="../warehouse/printListOrganTradesTReceiveAction.do";
		search.submit();
		search.target="";
		search.action="../warehouse/listOrganTradesTReceiveAction.do";
	}
				...
				<td>
					<div id="div1">
						...
						<form name="search" method="post"
								action="../warehouse/listOrganTradesTReceiveAction.do" >
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <input name="EndDate" type="text" id="EndDate" onFocus="javascript:selectDate(this)" value="${EndDate}" size="10" readonly>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr class="title-func-back">
							  ...
							  <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>		
								<td class="SeparatePage">
									<pages:pager action="../warehouse/listOrganTradesTReceiveAction.do" />
								</td>
							</tr>
						</table>
					</div>
...
<input type="hidden" name="IsReceive" id ="IsReceive" value="${IsReceive}">
