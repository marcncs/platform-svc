...
function ToAdd(){
	document.all.submsg.src="../sales/toAddMemberAction.do";
	}

	function ToList(){
	document.all.submsg.src="../sales/listMemberAction.do";
	}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  ...
  <tr> 
    ...
    <td width="292" align="right" valign="bottom"><table width="120"  border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      name="submsg" src="../sales/toAddMemberAction.do" frameBorder="0" scrolling="no"></IFRAME>
</body>
</html>
