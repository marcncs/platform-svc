...
setday=selectDate;	//保留老的调用方式
function selectDate() //主调函数
{
	var obj;
...
var theme=new Object();
	...
	theme["NewAge"].borderColor			= "#448FEB";	//边框颜色
	theme["NewAge"].borderColorDark		= "#FFFFFF";	//边框暗部颜色
	theme["NewAge"].bgColorMain			= "#448FEB";	//日历主背景色
	theme["NewAge"].bgColorLight		= "#fff8ec";	//日历的浅背景色
	...
	theme["NewAge"].buttonBorderColor	= "#FFFFFF";	//按钮边框颜色
	theme["NewAge"].buttonColor			= "#fff8ec";	//按钮的主色调
	theme["NewAge"].buttonFontColor		= "#000000";	//按钮文字颜色
	theme["NewAge"].dragBarFontColor	= "#FFFFFF";	//拖动条的文字颜色
	theme["NewAge"].dragBarColor		= "#FFFFFF";	//拖动条的边框颜色
	theme["NewAge"].dragBarColorDark	= "#336699";	//拖动条的边框暗部颜色
	theme["NewAge"].normalDayColor		= "#c5dfff";	//日期的背景颜色
	theme["NewAge"].normalDayFontColor	= "#000000";	//日期的字体颜色
	theme["NewAge"].grayDayColor		= "#C5DFFF";	//非本月日期的背景颜色
	theme["NewAge"].grayDayFontColor	= "#808080";	//非本月日期的字体颜色
	theme["NewAge"].todayColor			= "#FFD700";	//当前日期的背景颜色
	theme["NewAge"].todayFontColor		= "#000000";	//当前日期的字体颜色
	theme["NewAge"].selectedDayColor	= "#FFD700";	//选中日期的背景颜色
