...
function addIdcode(){
   ...
   var url = "../aftersale/addWithdrawIdcodeiiAction.do?idcode="+idcode+"&billid="+billid+"&prid="+prid+"&warehousebit="+warehousebit;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1" >
  <tr>
	...
	<tr>
      ...
      name="submsg" src="../aftersale/listWithdrawIdcode.do?billid=${billid}&prid=${bbd.productid}&isaudit=${isaudit}" frameBorder="0" scrolling="no" onload="setIframeHeight(this)"></IFRAME>  
