...
function print(){
	...
	excputform.action="../report/printSaleTradesCustomerTotalAction.do";
	excputform.submit();
	excputform.target="";
	excputform.action="../report/excPutSaleTradesCustomerTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>零售>>零售换货按会员汇总</td>
        </tr>
      </table>
      <form name="searchform" method="post" action="saleTradesCustomerTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
           ...
           <td width="10%" align="right">换货时间：</td>
            <td width="25%">
            <input name="BeginDate2" type="text" id="BeginDate2" onFocus="selectDate(this);"  value="${BeginDate2}"
             size="10" readonly="readonly">
				-
  			<input name="EndDate2" type="text" id="EndDate2" onFocus="selectDate(this);" value="${EndDate2}"
  			 size="10" readonly="readonly">
            </td>
          </tr>
          <tr class="table-back">
            ...
            <td width="20%"><input name="CMobile" type="text" id="CMobile" value="${CMobile}"  maxlength="11" /> </td>
            <td align="right">&nbsp;</td>
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/saleTradesCustomerTotalAction.do"/></td>
          </tr>
      </table>
      </div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
        ...
        <tr class="table-back-colorbar">
          ...
          <td width="25%">${d.tel}</td>
          <td width="25%"><windrp:format p="###,##0.00" value='${d.count}' /></td>                
        </tr>
        ...
        <tr class="back-gray-light">
          ...
          <td align="center" ><windrp:format p="###,##0.00" value='${totalcount}' />
         </td>
        </tr>
		<tr class="back-gray-light">
          <td  align="right">总合计：</td>      
          <td ><windrp:format p="###,##0.00" value='${allsum}' /></td>
        </tr>
      </table>
      </div>
    </td>
...
<form  name="excputform" method="post" action="excPutSaleTradesCustomerTotalAction.do" >
