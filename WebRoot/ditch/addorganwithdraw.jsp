...
function SupperSelect(rowx){
	...
	for(var x=0;x<p.length;x++){	
		if ( isready('productid', p[x].productid) ){
			continue;
		}
		addRow(p[x]);	
	}
...
function clearProductList() {
	...
	<body style="overflow: auto;">
		<form name="referForm" id="referForm" method="post"
			action="addOrganWithdrawAction.do" onsubmit="return ChkValue();">
									...
									<fieldset align="center">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1">
											<tr>
												...
												<td width="20%">
													...
													<input type="text" name="owname" id="owname" 
														onClick="selectDUW(this,'outwarehouseid',$F('porganid'),'w','')"
														value="" readonly dataType="Require" msg="必须录入退货仓库!">
													<span class="STYLE1">*</span>
												</td>
											...
											<tr>
												...
												<td>
													<input name="receiveorganid" type="hidden" value="${MakeOrganID}"
														id="receiveorganid">
												...
												<td>
													<input type="hidden" name="inwarehouseid" value="${WarehouseID}"
														id="inwarehouseid">
													<input type="text" name="wname" id="wname"
														onClick="selectDUW(this,'inwarehouseid',$F('receiveorganid'),'rw','')"
														value="${wname}" readonly dataType="Require" msg="必须录入调入仓库!">
													<span class="style1">*</span>
												</td>
											...
											<td align="right">
												...
												<td>
													<input type="text" id="plinkman" name="plinkman" size="30" value="${plinkman}" 
