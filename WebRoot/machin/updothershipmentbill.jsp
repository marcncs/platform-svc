...
function Check(){
	...
	<body style="overflow: auto">
			...
			<tr>
				<td>
					...
					<form name="validateProvide" method="post" id="validateProvide"
						action="updOtherShipmentBillAction.do" onSubmit="return ChkValue();">
									...
									<fieldset align="center">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1">
											<tr>
												...
												<td width="23%">
													<windrp:select key="OtherShipment" name="shipmentsort"
														value="${osbf.shipmentsort}" p="n|f" />
												</td>
											</tr>
											<tr>
	    ...
	    --%>
												<td align="right">
													<input type="checkbox" name="isaccount" ${osbf.isaccount==1? "checked":""} />
													&nbsp;
												</td>
												<td>
													是否记账
												...
												<td>
													<input name="requiredate" type="hidden" id="requiredate"
														value="<windrp:dateformat value='${osbf.requiredate}' p='yyyy-MM-dd'/>"
										...
										<tr>
											...
											<td width="94%">
												<textarea name="remark" cols="180" rows="4" id="remark"
													dataType="Limit" max="256" msg="备注必须在256个字之内" require="false">${osbf.remark}</textarea>
											</td>
										</tr>
									</table>
								</td>
