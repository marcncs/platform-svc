...
function submitCheckAll(){
	...
	validateProvide.action="../sys/addRuleUserWHAction.do?WID=${WID}&type=checkAll";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1" >
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      name="submsg" src="../sys/selectRuleUserWHAction.do?WID=${WID}" frameBorder="0" scrolling="no" onload="setIframeHeight(this)"></IFRAME>  
         <form action="../sys/addRuleUserWHAction.do?WID=${WID}" method="post"  name="validateProvide" onSubmit="return formcheck();">
