...
function excput(){
	...
	searchform.action="../report/excPutPurchaseWithdrawProductTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseWithdrawProductTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseWithdrawProductTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseWithdrawProductTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>采购>>采购退货按产品汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="purchaseWithdrawProductTotalAction.do" onSubmit="reurn oncheck();">
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="1" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseWithdrawProductTotalAction.do"/></td>
          </tr>
      </table>
      </div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
        ...
        <tr class="back-gray-light">
          ...
          <td align="right" width="10%">￥<windrp:format p="###,##0.00" value="${s.subsum}" /></td>
        </tr>
        </c:forEach>
      </table>
	 </div>
