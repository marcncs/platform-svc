  ...
  <tr>
    <td width="10"><img src="../images/CN/spc.gif" width="10" height="8"></td>
	  ...
	  <tr>
	      ...
	      <td width="9%" align="right">总金额：</td>
	      <td width="25%">${pbf.totalsum}</td>
	  </tr>
	  <tr>
	    <td  align="right">退货原因：</td>
	    <td colspan="5">${pbf.withdrawcause}</td>
	    </tr>
	  </table>
	</fieldset>
...
<form name="addform" method="post" action="approvePurchaseWithdrawAction.do">
      <table width="100%" height="200"  border="0" cellpadding="0" cellspacing="1">
        
          <tr class="table-back"> 
            <td  align="right"><input name="pwid" type="hidden" id="pwid" value="${pwid}">
            审阅状态：</td>
            <td>${approvestatus}</td>
          </tr>
          <tr class="table-back">
