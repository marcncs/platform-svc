 ...
 var chebox=null;
  function addRow(){
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
		...
		j.innerHTML="<input name=\"discount\" type=\"text\" id=\"discount\"  size=\"8\" maxlength=\"8\" onchange=\"SubTotal("+dbtable.rows.length+");TotalSum();\" onFocus=\"SubTotal("+dbtable.rows.length+");TotalSum();\">";
		k.innerHTML="<input name=\"taxrate\" type=\"text\" id=\"taxrate\"  size=\"8\" maxlength=\"8\" onchange=\"SubTotal("+dbtable.rows.length+");TotalSum();\" onFocus=\"SubTotal("+dbtable.rows.length+");TotalSum();\">";
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 新增零售报价</td>
        </tr>
      </table> 
      <form name="validateProvide" method="post" action="addDemandPriceAction.do" onSubmit="return ChkValue();">
	...
	<fieldset align="center"> <legend>
	  ...
	  <tr>
          ...
          <td width="23%"><input name="linkman" type="text" id="linkman">
	  ...
	  <tr>
	    ...
	    <td><input name="demandname" type="text" id="demandname"></td>
	    <td align="right">&nbsp;</td>
	    <td></td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
