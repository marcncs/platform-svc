...
function excput(){
	...
	searchform.action="../report/excPutPurchaseBillDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseBillDetailAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printPurchaseBillDetailAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/purchaseBillDetailAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td >报表分析>>采购>>采购订单明细</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="purchaseBillDetailAction.do">
          ...
          <tr class="table-back">
            ...
            <td><input name="ProductID" type="hidden" id="ProductID" value="${ProductID}">
              <input id="ProductName" name="ProductName"
               value="${ProductName}"><a href="javascript:SelectSingleProduct();"><img 
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/purchaseBillDetailAction.do"/></td>
          </tr>
      </table>
      </div>
	...
	<c:forEach items="${alsod}" var="d">
        <tr class="table-back-colorbar">    
          <td >${d.pid}</td>      
		  <td >${d.pname}</td>
		  <td><a href="javascript:ToBill('${d.pbid}');">${d.pbid}</a></td>
...
<form  name="excputform" method="post" action="excPutPurchaseBillDetailAction.do" >
