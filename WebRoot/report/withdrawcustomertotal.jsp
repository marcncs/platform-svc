...
function excput(){
	...
	searchform.action="../report/excPutWithdrawCustomerTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/withdrawCustomerTotalAction.do";
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printWithdrawCustomerTotalAction.do";
	searchform.submit();
	searchform.target="";
	searchform.action="../report/withdrawCustomerTotalAction.do";
}
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td>报表分析>>零售>>零售退货按会员汇总</td>
        </tr>
      </table>
       <form name="searchform" method="post" action="withdrawCustomerTotalAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/withdrawCustomerTotalAction.do"/></td>
          </tr>
      </table>
      </div>
...
<form  name="excputform" method="post" action="excPutWithdrawCustomerTotalAction.do" >
