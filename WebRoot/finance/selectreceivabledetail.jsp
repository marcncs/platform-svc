...
<script language="javascript">
	...
	function Affirm(){
		...
		if(flag){
			...
			var p={rid:arrrid.slice(0),productid:arrid.slice(0),productname:arrpordocutname.slice(0),specmode:arrspecmode.slice(0),unitid:unitid.slice(0),countunit:arrcountunit.slice(0),batch:arrbatch.slice(0),billno:arrbillno.slice(0),paymentmode:arrpaymentmode.slice(0),paymentmodename:arrpaymentmodename.slice(0),quantity:arrquantity.slice(0),goodsfund:arrgoodsfund.slice(0),scot:arrscot.slice(0)};
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 选择应收款详情</td>
	    
        </tr>
      </table>
       <form name="search" method="post" action="../finance/selectReceivableDetailAction.do">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
		  ...
		  <tr class="table-back" > 
            ...
            <td >${p.productid}</td>
            <td><input type="hidden" name="rid" value="${p.rid}" ><input type="hidden" name="productname" value="${p.productname}">${p.productname}</td>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <td width="70%"> <presentation:pagination target="/finance/selectReceivableDetailAction.do"/> 
          </td>
        </tr>
      </table>
