...
var checkid=0;
	...
	function addNew(){
	window.open("../finance/toAddReceivableAction.do","","height=550,width=800,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=no");
	}

	function Update(){
		if(checkid!=""){
		window.open("toUpdReceivableAction.do?ID="+checkid,"","height=550,width=800,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,status=no");
		}else{
		alert("请选择你要操作的记录!");
		}
	}
...
function excput(){
		search.target="";
		search.action="../finance/excPutListReceivableAllAction.do";
		search.submit();
		search.action="listReceivableAllAction.do";
	}
	function print(){
		search.target="_blank";
		search.action="../finance/printListReceivableAllAction.do";
		search.submit();
		search.target="";
		search.action="listReceivableAllAction.do";
	}
  ...
  <tr>
	...
	<table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772">账务管理>>应收款结算</td>
        </tr>
      </table>
       <form name="search" method="post" action="listReceivableAllAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back"> 
            ...
            <td width="19%"><windrp:select key="ObjectSort" name="ObjectSort" p="y|f" value="${ObjectSort}"/></td>
          ...
          <tr class="table-back">
            ...
            <td width="16%"><input name="KeyWord" type="text" id="KeyWord" value="${KeyWord}"></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<td width="1">
          ...
          <td class="SeparatePage"><pages:pager action="../finance/listReceivableAllAction.do"/></td>
        </tr>
      </table>
	  </div>
	  ...
	  <div style="width:100%">
      	<div id="tabs1">
            <ul>
              <li><a href="javascript:Detail();"><span>应收款结算详情</span></a></li>
            </ul>
          </div>
          <div>
