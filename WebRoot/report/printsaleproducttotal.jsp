...
<img src="images/print.gif" onClick="javascript:window.print();"></img>
      ...
      <div id="abc">
      <div align="center" class="print_title_style">零售产品汇总</div>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<windrp:getname key='organ' value='${MakeOrganID}' p='d'/>
            </td>
            <td width="10%" align="right">配送机构：</td>
            <td width="25%"><windrp:getname key='organ' value='${EquipOrganID}' p='d'/>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
        ...
        <tr class="back-gray-light">
		  ...
		  <td width="15%" align="right">￥<windrp:format p="###,##0.00" value='${totalsum}' /></td>
        </tr>
      </table>
      </div>
</body>
