...
<script language="javascript">
	...
	var checkcomname="";
	var checkmobile="";
	function CheckedObj(obj,objaccountid,objname,objcomname,objmobile){
	 ...
	 checkname = objname;
	 checkcomname = objcomname;
	 checkmobile = objmobile;
	}

	function Affirm(){
	if(checkname!=""){
		var p={accountId:checkaccountid,name:checkname,companyName:checkcomname,mobile:checkmobile};
  ...
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 选择积分账号</td>
        </tr>
      </table>
       <form name="search" method="post" action="../keyretailer/selectSBonusAccountAction.do">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr class="title-func-back">
          ...
          <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
          <td style="text-align: right;"><pages:pager action="../keyretailer/selectSBonusAccountAction.do"/></td>
        </tr>
      </table>
       </div>
	</td>
	...
	<tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
          ...
          <logic:iterate id="p" name="sBonusAccounts" > 
          <tr class="table-back-colorbar" onClick="CheckedObj(this,'${p.accountId}','${p.name}','${p.companyName}','${p.mobile}');" onDblClick="Affirm();"> 
            <td>${p.accountId}</td>
            <td>${p.organId}</td>
            <td>${p.name}</td>
            <td>${p.companyName}</td>
