...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
       ...
       <form name="searchform" method="post" action="idcodeScanRateAction.do">
  ...
  <input name="EndDate" type="text" id="EndDate" value="${EndDate}"  
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
          <tr class="title-func-back"> 
		    ...
		    <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		  	<td width="80">
			<a href="javascript:doRemark();"><img src="../images/CN/update.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;修改备注</a>
		    </td>
		    <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
            <td class="SeparatePage">
			<pages:pager action="../report/idcodeScanRateAction.do"/>	
            </td>
          </tr>
      </table>
      </div>
	...
	<c:forEach items="${ttlist}" var="d">
        <tr class="table-back-colorbar" onClick="CheckedObj(this,'${d.ttdid}');">           
          ...
          <td >${d.rate}</td>
          <td title="${d.remark}"><ws:subString value="${d.remark}" length="20"/></td>
          </tr>
...
<form  name="excputform" method="post" action="exportIdcodeScanRateAction.do">
