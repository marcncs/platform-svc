...
<html>
  ...
  function addRow(p){
    var x = document.all("dbtable").insertRow(dbtable.rows.length);
        ...
        f.innerHTML="<input name='punitprice' type='text' id='punitprice' value='"+p.unitprice+"' size='10' maxlength='10' readonly='readonly'>";
        g.innerHTML="<input name='sunitprice' type='text' id='sunitprice' value='"+p.sunitprice+"' size='10' maxlength='10' readonly='readonly'>";
        ...
        i.innerHTML="<input name='psubsum' type='text' id='psubsum' value='"+psubsum+"' size='10' maxlength='10' readonly>";
        var ssubsum = formatCurrency(p.sunitprice*1);
		j.innerHTML="<input name='ssubsum' type='text' id='ssubsum' value='"+ssubsum+"' size='10' maxlength='10' readonly>";
...
function SupperSelect(rowx){
	...
	var p=showModalDialog("../common/toSelectOrganProductPriceTwoAction.do?OID="+oid,null,"dialogWidth:20cm;dialogHeight:17cm;center:yes;status:yes;scrolling:no;");
...
function TotalSum(){
	...
	<body style="overflow: auto;">
		<form name="referForm" method="post"
			action="addSupplySaleApplyAction.do"
									...
									<fieldset align="center">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1">
											...
											<td  align="right">
												...
												<input type="text" name="wname" id="wname" onClick="selectDUW(this,'inwarehouseid',$F('inorganid'),'w','transportaddr')" value="" readonly>
													<span class="STYLE1">*</span>
											  </td>
