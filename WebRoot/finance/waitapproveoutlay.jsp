...
var pbaid=0;
	...
	function Approve(){
		if(checkid!=""){
			window.open("../finance/toApproveOutlayAction.do?ID="+checkid+"&actid="+actid+"&logid="+pbaid,"","height=650,width=1000,top=50,left=20,toolbar=no,menubar=no,scrollbars=yes,resizable=no,location=no,status=no");
		}else{
			alert("请选择你要操作的记录!");
		}
	}
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
        <tr> 
          ...
          <td width="772"> 审批费用报销单</td>
        </tr>
      </table>
       <form name="search" method="post" action="../finance/waitOutlayAction.do">
      <table width="100%"  border="0" cellpadding="0" cellspacing="0">
       
          <tr class="table-back"> 
            <td width="10%"  align="right">费用报销单编号：</td>
            <td width="64%" > 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr class="table-back" onClick="CheckedObj(this,'${pb.billno}',${pb.actid},${pb.id});"> 
            <td ><a href="../finance/outlayDetailAction.do?ID=${pb.billno}">${pb.billno}</a></td>
...
<table  border="0" cellpadding="0" cellspacing="0">
          ...
          <td width="58%" align="right"> <presentation:pagination target="/finance/waitOutlayAction.do"/>          </td>
        </tr>
      </table></td>
  </tr>
</table>
