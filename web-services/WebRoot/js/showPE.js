...
strFrame+='<tr class="title-back"><td width="45%" height="30">&nbsp; 错误信息</td></tr>';
...
var outButton;  //点击的按钮
var billtype;
function ShowPE(v_tt,v_productid) //主调函数
{
...
function getStockByOid(v_productid){
	var url = '../sap/getPrimaryCodeErrorAjax.do?printJobId='+v_productid;
	var pars = '';
...
function showprice(errMsg){
		...
		var sst='<table width="100%" border="0" cellpadding="1" cellspacing="0" class="hprice">';	
			...
			sst+='<tr><td width="100%">'+errMsg+'</td></tr>'; 
