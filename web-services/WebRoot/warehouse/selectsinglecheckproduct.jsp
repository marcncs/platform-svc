...
<script language="javascript">
	...
	var checkunitid="";
	var checkspec="";
	function CheckedObj(obj,objid,objname,objunitidname,objunitid,objspecmode){
	...
	function Affirm(){
	if(checkid!=""){
		var p={id:checkid,productname:checkname,unitid:checkunitid,unitidname:checkunit,specmode:checkspec};
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="search" method="post" action="../warehouse/selectSingleCheckProductAction.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        
        <input type="hidden" name="wid" value="${wid}">
        <input type="hidden" name="IsIDCode" value="${IsIDCode}">
        <input type="hidden" name="wbit" value="${wbit}">
          <tr class="table-back">
            <td width="18%" height="22" align="right">产品类别：</td>
            <td width="20%"><input type="hidden" name="KeyWordLeft" value="${KeyWordLeft}"><windrp:pstree id="KeyWordLeft" name="productstruts" /></td> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr class="title-func-back">
          ...
          <td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
          <td style="text-align: right;"><pages:pager action="../warehouse/selectSingleCheckProductAction.do"/></td>
        </tr>
      </table>
       </div>
	</td>
	...
	<tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" class="sortable">
          ...
          <tr class="table-back-colorbar" onClick="CheckedObj(this,'${p.productid}','${p.psproductname}','${p.unitname}','${p.countunit}','${p.specmode}');" onDblClick="Affirm();"> 
            <td>${p.productid}</td>
