...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  ...
  <tr>
    <td width="10"><img src="../images/CN/spc.gif" width="10" height="8"></td>
          <td width="772"> 应收单详情 </td>
  </tr>
</table>
      <table width="100%"  border="0" cellpadding="0" cellspacing="1">
        <tr class="table-back">
          <td width="17%"  align="right">应收款金额：</td>
          <td width="33%">${rf.receivablesum}</td>
        ...
        <tr class="table-back">
          ...
          <td>${rf.isrefername}</td>
          <td align="right">是否审阅：</td>
          <td>${rf.approvestatusname}</td>
        </tr>
        <tr class="table-back">
          <td  align="right">审阅日期：</td>
          <td>${rf.approvedate}</td>
...
<form name="addform" method="post" action="approveReceivableAction.do">
      <table width="100%" height="200"  border="0" cellpadding="0" cellspacing="1">
        
          <tr class="table-back"> 
            <td  align="right"><input name="rid" type="hidden" id="rid" value="${rid}">
            审阅状态：</td>
            <td>${approvestatus}</td>
          </tr>
          <tr class="table-back">
