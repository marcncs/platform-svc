...
public class QueryCustomerDetailAction extends Action{
	...
	private OrganJson getChildOrgans(UsersBean loginUsers, String organId) throws NumberFormatException, Exception {
		...
		organJson.setDetails(details);
		List<Map<String,String>> strList  = appSTransferRelation.getTransferOrganByOrganId(organJson.getOrganId());
		for(Map<String,String> str : strList) {
			CustomerInfoDetail cid = new CustomerInfoDetail();
			MapUtil.mapToObject(str, cid);
			details.add(cid);
		}
		return organJson;
	}
