...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  ...
  <tr>
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
	  ...
	  <form name="validateProvide" method="post" action="../finance/updPaymentLogAction.do" onSubmit="return ChkValue();">
	   <table width="100%" border="0" cellpadding="0" cellspacing="1">
        
		<input type="hidden" name="id" value="${plf.id}">
          <tr> 
            <td >
	  ...
	  <table width="100%"  border="0" cellpadding="0" cellspacing="1">
	  <tr>
	  	<td width="10%"  align="right"><input name="poid" type="hidden" id="poid" value="${plf.poid}">
应付款对象：</td>
          <td width="26%"><input name="payeeid" type="text" id="payeeid" size="35" value="${plf.payee}" readonly></td>
          <td width="10%" align="right">领款人：</td>
          <td width="25%"><input name="payee" type="text" id="payee" size="35" value="${plf.payee}"></td>
	  ...
	  <tr>
	    ...
	    <td><select name="fundsrc" id="fundsrc">
          <logic:iterate id="u" name="cblist">
            <option value="${u.id}" ${u.id==plf.fundsrc?"selected":""}>${u.cbname}</option>
          </logic:iterate>
        </select></td>
	    <td align="right">票据号：</td>
	    <td><input name="billnum" type="text" id="billnum" value="${plf.billnum}"></td>
	    <td align="right">凭证号：</td>
	    <td><input name="voucher" type="text" id="voucher" value="${plf.voucher}" maxlength="32"></td>
	    </tr>
		 <tr>
	    <td  align="right">付款金额：</td>
	    <td><input type="text" name="paysum" value="${plf.paysum}"></td>
	    <td align="right">付款用途：</td>
	    <td><input name="paypurpose" type="text" id="paypurpose" value="${plf.paypurpose}"></td>
	    <td align="right">&nbsp;</td>
	    <td>&nbsp;</td>
	    </tr>
	  </table>
         ...
         <tr>
            <td  align="center" ><table width="100%"  border="0" cellpadding="0" cellspacing="1">
              <tr >
                ...
                <td width="94%"><textarea name="remark" cols="180" rows="4" id="remark">${plf.remark}</textarea></td>
              </tr>
            </table></td>
          </tr>
