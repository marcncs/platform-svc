...
public class SupplySaleMoveIdcode implements Serializable {
    ...
    /** full constructor */
    public SupplySaleMoveIdcode(Long id, String ssmid, String productid, Integer isidcode, String warehousebit, String batch, String producedate, String validate, Integer unitid, Double quantity, String startno, String endno, String idcode) {
        this.id = id;
        this.ssmid = ssmid;
    ...
    /** default constructor */
    public SupplySaleMoveIdcode() {
    }

    /** minimal constructor */
    public SupplySaleMoveIdcode(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof SupplySaleMoveIdcode) ) return false;
        SupplySaleMoveIdcode castOther = (SupplySaleMoveIdcode) other;
