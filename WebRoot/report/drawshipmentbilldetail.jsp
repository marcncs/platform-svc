...
function excput(){
searchform.target="";
	searchform.action="../report/excPutDrawShipmentBillDetailAction.do";
	searchform.submit();
}

function oncheck(){
searchform.target="";
	searchform.action="../report/drawShipmentBillDetailAction.do";
	searchform.submit();
}
function print(){
	searchform.target="_blank";
	searchform.action="../report/printDrawShipmentBillDetailAction.do";
	searchform.submit();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    ...
    <table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <form name="searchform" method="post" action="drawShipmentBillDetailAction.do" onSubmit="return oncheck();">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
       ...
       <table width="100%"  border="0" cellpadding="0" cellspacing="0" >
		...
		<td width="1"><img src="../images/CN/hline.gif" width="2" height="14"></td>
		<td class="SeparatePage"><pages:pager action="../report/drawShipmentBillDetailAction.do"/></td>
          </tr>
      </table>
      </div>
