	...
	function Affirm(){
		...
		for(var i=0;i<document.listform.pid.length;i++){
			if(document.listform.pid[i].checked){
				...
				arrunitprice[k]=document.listform.standardpurchase[i].value;
				k++;
				...
				arrunitprice[0]=document.listform.standardpurchase.value;
				flag=true;//只要选中一个就设为true
		}
    ...
    <td><table width="100%" height="40" border="0" cellpadding="0" cellspacing="0" class="title-back">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr class="table-back">
            ...
            <td><select name="KeyWordLeft" id="KeyWordLeft">
		  	...
		  	<td width="15%"  align="right">名称关键字：</td>
            <td width="50%" ><input type="text" name="KeyWord" value="${KeyWord}">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1">
          ...
          <tr align="center" class="title-top"> 
	  	    <td height="2"><input type="checkbox" name="checkall" onClick="Check();" ></td>
            <td >产品编号</td>
            <td>产品名称</td>
            <td>规格</td>
            <td>单位</td>
          ...
          <!--<tr align="center" class="table-back" onClick="CheckedObj(this,${p.id},'${p.productname}',${p.unitid},'${p.countunit}','${p.standardpurchase}');"> -->
		  <tr align="center" class="table-back" > 
            ...
            <td><input type="hidden" name="unitid" value="${p.unitid}">
              <input type="hidden" name="countunit" value="${p.countunit}">
              ${p.countunit}</td>
            <td><input type="hidden" name="standardpurchase" value="${p.standardpurchase}">
              ${p.standardpurchase}</td>
          </tr>
          </logic:iterate> 
