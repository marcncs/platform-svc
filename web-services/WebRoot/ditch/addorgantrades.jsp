...
function TotalSum(){
	...
	<body style="overflow: auto;">
		<form name="referForm" method="post"
			action="addOrganTradesAction.do"
								...
								<td>
									...
									<fieldset align="center">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1">
											<tr>
												...
												<td width="25%">
													<input name="porganid" type="hidden" id="porganid" value="${organid }">
													<input name="porganname" type="hidden" id="porganname" size="30" value="<windrp:getname key='organ' p='d' value='${organid }'/>">
													 <windrp:getname key="organ" p="d" value="${organid }"/>
												</td>
												...
												<td width="25%">
													...
													<input type="text" name="plinkman" id="plinkman"
									...
									value="" readonly>
												...
												<td>
													...
													<input type="text" name="rlinkman" id="rlinkman"
												...
												<td>
													<input name="rtel" type="text" id="rtel" size="10"
											...
											<td align="right">
												...
												<td colspan="5">
													<input style="text" id="transportaddr" name="transportaddr" size="60" maxlength="100" value="${oaddr }" dataType="Require" msg="必须录入供方收货地址!">
													<span class="STYLE1">*</span>
												</td>
											</tr>
											<tr>
												...
												<td colspan="5">
													<input style="text" id="rtransportaddr" name="rtransportaddr" size="60" maxlength="100" value="${roaddr }" dataType="Require" msg="必须录入换方收货地址!">
													<span class="STYLE1">*</span>
												</td>
											</tr>
										</table>
