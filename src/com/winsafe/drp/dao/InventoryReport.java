...
public class InventoryReport extends ActionForm implements Serializable {
    ...
    /** full constructor */
    public InventoryReport(Long id, String productid, String batch, String warehouseid, String billcode, Double cyclefirstquantity, Double cycleinquantity,Double cycleoutquantity, Double cyclebalancequantity, Date recorddate) {
        this.id = id;
    ...
    /** minimal constructor */
    public InventoryReport(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof InventoryReport) ) return false;
        InventoryReport castOther = (InventoryReport) other;
