...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BFC0C1">
  <tr>
    <td>
	<div id="bodydiv">
	 <form name="search" method="post" action="../users/selectRuleUserWHAction.do" onSubmit="return formcheck();">
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr class="title-func-back">
		  <td style="text-align:right"><pages:pager action="../users/selectRuleUserWHAction.do"/></td>						
		</tr>
	</table>	
	 </div>
	</td>
	...
	<tr>
      ...
      <table class="sortable" width="100%" border="0" cellpadding="0" cellspacing="1">  
		  ...
		  <tr align="center" class="table-back-colorbar" > 
		  	<td> <input type="checkbox" name="pid" value="${p.wid}" onClick="changeValue(this)"></td>
            <td height="20">${p.wid}</td>
            <td><input type="hidden" name="warehousename" value="${p.warehousename}">${p.warehousename}</td>      
            <td>${p.makeorganname}</td>
            <td>
				<windrp:getname key='OrganType' value='${p.organtype}' p='f'/>
			</td>
			<td>
				<windrp:getname key="${p.organtype==1?'PlantType':'DealerType' }" value='${p.organmodel}' p='f'/>
			</td>
            </tr>
